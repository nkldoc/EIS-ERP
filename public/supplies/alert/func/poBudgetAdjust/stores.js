Ext.store = new Ext.data.JsonStore({
  ...
  baseParams: { type: "po_budget_adjust_hdr", i_read: user_right_read }, // Permission i_read
  root: "data",
  idProperty: "id",
...
let storeDtlRecord = Ext.data.Record.create([{ name: "no" }, { name: "id" }, { name: "po_expense_id" }, { name: "f_increase" }, { name: "f_decrease" }, { name: "c_comment" }]);

Ext.storeDtl = new Ext.data.JsonStore({
  autoDestroy: false,
  autoLoad: false,
  url: "api/List_poBudgetAdjust.php",
  baseParams: { type: "po_budget_adjust_dtl" },
  root: "data",
  idProperty: "id",
  totalProperty: "totalCount",

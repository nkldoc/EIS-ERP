...
//AutoLoad
    ...
    Ext.storeDtl = new Ext.data.JsonStore({
        ...
        autoDestroy: false,
        autoLoad: false,
        url: "tor/api/List_returnWarrantyContract.php",
        baseParams: {type: "returnWarrantyContract"}, // LIST_SUB_PERIOD_HDR LIST_PERIOD_SUB_HDR
        root: "data",
        idProperty: "id",
    ...
    Ext.extend((gridMain = function () {
        var colmnn = [
            new Ext.grid.RowNumberer(
                ...
                header: "รายละเอียดในการแจ้งเตือน",
                sortable: true,
                align: "left",
                dataIndex: "c_detail",
                width: 250

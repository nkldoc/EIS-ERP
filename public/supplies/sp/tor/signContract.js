...
//                },
              ...
              new Ext.grid.EditorGridPanel({
                ...
                columns: [{
                     dataIndex: "c_code",   
                     header: "-", width:120 ,align: "center", editor: new Ext.form.TextField({
                     style: "text-align: center",
                      listeners: {
                        afterrender: function () {
            ...
            new Ext.FormPanel({
              ...
              listeners: {
                afterrender: function() {
                    ...
                    Ext.getCmp("f_type_amtID").setValue(Ext.selectRow.json.f_type_amt);
                  ...
                  items: [
                    {
                      ...
                      items: [
                        ...
                        // {
                        //     xtype: "button",
                        //     text: "บันทึกแหล่งเงิน/เช่า",
                        //     name: "i_ren_bgType",
                        //     hidden: true,
                        //     id: "i_ren_bgTypeID",
                        //     fieldLabel: "บันทึกแหล่งเงิน2",
                        //     listeners: {
                        //         beforerender: function () {
                        //             this.fn = function () {
                  ...
                  tbar: [
                    {
                      ...
                      handler: function () {
                        /*if (Ext.selectRow.data.contract_no == 1) {
                          ...
                          return false;
                        } else */if (Ext.selectRow.data.i_purchase != Ext.getCmp("i_purchaseID").getValue().inputValue) {
                        ...
                        var win = new Ext.Window({
                          ...
                          listeners: {
                            ...
                            afterrender: function () {
                              ...
                              if(Ext.selectRow.data.i_type_bg == 12){
                          ...
                          items: [
                            {
                              ...
                              items: [
                                                                ...
                                                                },*/
                                {
                                  ...
                                  // value : '2024-10-01'  ,// ล็อกวันที่สัญญา
                                  readOnly:   true , 
                                  validator: function (val) {
                                      if (Ext.isEmpty(val)) {
                                          return "กรุณากรอก วันที่เริ่มสัญญา ";
                                      } else {
                                          return true;
                                      }
                                  },
                          ...
                          buttons: [
                            {
                              ...
                              listeners: {
                                afterrender: function () {
                                  if (Ext.selectRow.get("bg_check_id") > 0 || [2,4,8,11].includes(Ext.selectRow.get("i_type_bg"))){ 
                                    this.show();
                                  } else { 
                                    this.hide();
                                  }
                                      ...
                                      callback: function (recordx, operation, success) {
                                        if (success) {
                                          ...
                                          if (statusx == "add") {
                                            ...
                                            if (!Ext.selectRow.get("i_yyyy")) Ext.selectRow.set("i_yyyy", null);
                                            ...
                                            && Ext.selectRow.get("i_type_bg") != 11 

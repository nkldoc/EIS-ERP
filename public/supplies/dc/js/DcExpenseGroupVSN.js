            ...
            buttons : [
                {
                    ...
                    handler : function() {
                        Ext.Ajax.request({
                            url : 'api/mnDcExpenseGroupVSN.php' , 
                            params : { 
                                    mode : 'DELETE', 
                                    id : record.get('id')
                            }, 
        ...
        items:[{
                ...
                validator: function(val) {
                    if (!Ext.isEmpty(val)){ return true; } else {
                        return "กรุณา กรอกหมวดรายจ่าย";
                    }
                }
            },new Ext.form.ComboBox({
            	hiddenName: "dc_bg_type_id",
				name: "dc_bg_type_id",
				fieldLabel: "ประเภทงบ",
				store: dc_bg_type,
				valueField: "id",
...
searchGrid = function() {
    var filters = {
        ...
        store: new Ext.data.SimpleStore({
            fields: ["id", "c_name"],  
            data:[['c_name', "ชื่อหมวดรายจ่าย"],['c_code', "รหัส"]],
        }),
        value: 'c_name',
        valueField: 'id',
        displayField: 'c_name',
...
Ext.store = new Ext.data.JsonStore({
    ...
    autoDestroy: true,
    autoLoad: true,
    url : 'api/ListDcExpenseGroupVSN.php',
    root: 'data',
...
dc_bg_type	= new Ext.data.JsonStore({
	autoDestroy: false,
	autoLoad: true,
	url: "api/All_DcExpenseGroupVSN.php",
...
Ext.onReady(function(){
    ...
    var gridMain = {
        ...
        columns:[
            ...
            { id: 'c_code_old', header: "รหัสเดิม", width:50, sortable: true, dataIndex: 'c_code_old' }, 
			{ id: 'c_name', header: "หมวดรายจ่าย  Vision Net", width:350, sortable: true, dataIndex: 'c_name' },
			{ header: "ประเภทงบ", width:350, sortable: true, dataIndex: 'dc_bg_type_name' },
            {
                header: "Status",  
                sortable:false,
                align: 'center',

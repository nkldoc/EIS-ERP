...
Ext.AppConfig = function () {
    ...
    Ext.title = "บันทึกตั้งค่าใช้จ่ายสัญญา(ไม่มี PR) ";
                    ...
                    buttons: [
                        {
                            text: "ค้นหา",
                            handler: function () {
                                Ext.storeDtl.setBaseParam("mode", "LIST_CONTRACT_NO_TOR2");
...
//                        width: 120,
                ...
                gridMain.superclass.constructor.call(this, {
                    region: "center",
                    title: "บันทึกตั้งค่าใช้จ่ายสัญญา(ไม่มี PR)",
                    xtype: "grid",
                    id: "tabpanel1",
                    border: true,
                    stripeRows: true,
...
//                                    },
//                                    {
                                        text: "จัดการข้อมูล ตั้งค่าใช้จ่ายสัญญา(ไม่มี PR)",
...
//                                        scope: this
//                                    }, {
//                                        text: "ตั้งหนี้ค่าใช้จ่ายและจับคู่บัญชี",

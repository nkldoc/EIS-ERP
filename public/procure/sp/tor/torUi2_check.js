...
Ext.AppConfig = function () {
    ...
    Ext.extend(
            (gridMain = function () {
                var colmnn = [
                    ...
                    // },
                    {
                        header: "สถานตั้งค่าใช้จ่าย",
                        sortable: false,
                        align: "center",
                        dataIndex: "i_not_do",
                        renderer: function (value, metaData, record, row, col, store, gridView) {
                            var i_not_do = record.get("i_not_do");
                            if (i_not_do == 1) {
                                return '<img src="../images/icons/yes.gif");/>';
                            } else if(i_not_do == 3 ) {
                                return '<img src="../images/icons/cross.png");/>';
                            } else {
                                return '<img src="../images/icons/bullet_error.png");/>';
                            } 
                        },
                    },
                    {
                        ...
                        { xtype: "tbfill" },
                        {
                            ...
                            items: [
                                ...
                                listeners: {
                                    ...
                                    var text_ToolTip = "<span style='white-space:nowrap;'><img  alt='icon'   width='15' height='15' src='../images/icons/yes.gif');/> ทำตามขั้นตอนถูกต้อง</span><br>";
                                    text_ToolTip += "<span style='white-space:nowrap;'><img alt='icon'   width='15' height='15' src='../images/icons/cross.png');/> รายการเป็นงวดเดียว ไม่ตั้งตั้งค่าใช้จ่ายรายเดือน</span><br>";
                                    text_ToolTip += "<span style='white-space:nowrap;'><img alt='icon'   width='15' height='15' src='../images/icons/bullet_error.png');/> ไม่มีข้อมูลการตั้งค่าใช้จ่าย</span>";
                                    new Ext.ToolTip({
                                        target: c.id,
                                        anchor: "top",
                                        html: text_ToolTip,
    ...
    Ext.storeDtl = new Ext.data.JsonStore({
        autoDestroy: false,
        autoLoad: true,
        url: "tor/api/List_TorStep2.php",
        baseParams: {
            type: "po_working_dtl_check",
            keyData: Ext.keyData,

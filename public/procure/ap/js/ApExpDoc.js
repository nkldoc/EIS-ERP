...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: 'ชื่อเอกสารประกอบค่าใช้จ่าย',
                    name : 'c_name',
                    width: 300,
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบุ ชื่อเอกสารประกอบค่าใช้จ่าย";
                        }
                    }
                },{ 
                    ...
                    columns: [200,100],
                    items: [
                            { boxLabel: 'เอกสารที่ใช้ประกอบค่าใช้จ่าย', checked: true, name: 'i_type', inputValue:Ext.FIXED_i_type} 
                    ] 		        	
                },{ 
                    ...
                    columns: [200,100],
                    items: [
                            { boxLabel: 'ใบรายจ่ายพิเศษ', name: 'i_exp_type', inputValue:Ext.FIXED_i_exp_type_doc_special }
                            ,{ boxLabel: 'อื่นๆ', checked: true, name: 'i_exp_type', inputValue:Ext.FIXED_i_exp_type_doc_other } 
                    ] 		        	
                },{ 
...
Ext.QuickTips.init();
        var gridMain = {
                region: 'center',
                title: 'แสดงข้อมูลเอกสารที่ใช้ประกอบค่าใช้จ่าย',
                xtype: 'grid',
                id:'tabpanel1',
                border: false,
                stripeRows: true,
                ...
                { id: 'c_code', header: "รหัส", width:50, sortable: true, dataIndex: 'c_code' },
                { id: 'c_name', header: "ชื่อเอกสารที่ใช้ประกอบค่าใช้จ่าย", width:300, sortable: true, dataIndex: 'c_name' }, 
                { id: 'c_exp_type_name', header: "สถานะเอกสาร", width:150, sortable: true, dataIndex: 'c_exp_type_name' },
                {
                        header: "Status",  
                        sortable:false,
                        align: 'center',

Ext.onReady(function() {
  ...
  /*===============================================*/
  if (Ext.ITYPE_JV) {
    Ext.title_panel = "นำเข้าค่าใช้จ่าย (e-PHIS)";
  } else {
    Ext.title_panel = "บันทึกบัญชีค่าใช้จ่าย (e-PHIS)";
  }
  /*===============================================*/
  // pagingBar
              ...
              { xtype: "tbspacer", width: 4 },
              {
                ...
                store: new Ext.data.SimpleStore({
                  ...
                  data: [
                    ...
                    ["c_expense_period_no", "เอกสารค่าใช้จ่ายอ้างอิง"]
                  ]
                }),
                value: "c_code",
                valueField: "value",
  ...
  let myComboStores = [
    Ext.dc_expense_budget_type,
    Ext.dc_expense_budget_type_all 
    // , Ext.vw_dc_bank_acc_company_full1, Ext.vw_dc_bank_acc_company_full2, Ext.dc_expense_group_vsn, Ext.dc_expense_acc_vsn_full
  ];

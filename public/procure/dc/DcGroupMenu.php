...
<script type="text/javascript" src="js/DcGroupMenu.js?_dc=<?php echo rand(0,100000); ?>"></script>
<script type="text/javascript" src="js/TreeGrid.js?_dc=<?php echo rand(0,100000); ?>"></script>

/* global Ext, user_right_add, user_right_edit, user_right_delete abc*/
Ext.AppUx = function (app, menu) {
    ...
    function cellClick(grid, rowIndex, columnIndex, e) {
        ...
        } else if (columnIndex === grid.getColumnModel().getIndexById("c_codeStatusID")) {
            ...
            new Ext.Window({
                ...
                listeners: {
                    beforerender: function () {
                        ...
                        this.fnGenHtml = function () {

                            return '<div class="addressbook-preview-panel">' +
                                    '<div><span>รหัส PR  :</span>' + record.get('c_code') + '</div>' +
                                    '<div><span>เรื่อง :</span>' + record.get('c_name') + '</div>' +
                                    '<div><span>รหัสสถานะ :</span>' + record.get('c_code_status') + '</div>' +
                                    '<div style="color:blue;cursor:pointer;" id="linkID"><span>ไปที่เมนู :</span><span>' + record.get('c_code_status') + '</span></div>' +
                                    '</div>';
                            ;
                        };
                    ...
                    afterrender: function () {
                        Ext.getCmp('winQueueID').update(this.fnGenHtml());
                        Ext.getBody().unmask();
                        Ext.get('linkID').on("click", (click = function () {
//                             alert(record.get('c_code_status')); //pageStatus.php?st=ST0005
                            window.parent.location.href = "./#sp/pageStatus";
                            window.location.href = "../sp/pageStatus.php?st=" + record.get('c_code_status');
                    ...
                    buttons: [
                        {
                            text: "ค้นหา",
                            handler: function () {
                                Ext.getCmp('winSearchFrm').fnSubmit();
                            },
                        },
                        {
                            text: "ปิด",
            ...
            listeners: {
                beforerender: function () {
                    this.fnSubmit = function () {
                        ...
                        Ext.storeDtl.setBaseParam("f_total", Ext.getCmp("f_total_searchID").getValue());
                ...
                afterRender: function (thisForm, options) {
                    ...
                    new Ext.KeyNav("winSearchFrm", {enter: function (e) {
                            this.fnSubmit();
                        }, scope: this});
                }
            }
            ...
            (gridMain = function () {
                var colmnn = [
                    ...
                    },
                    {
                        ...
                        width: 300,
                        renderer: function (value, metaData, record, row, col, store, gridView) {
                            return value + " <font color='blue'>" + record.get("c_name_status") + "</font>";
                        },
                                ...
                                items: [
                                    {
                                        ...
                                        handler: function (e) {
                                            ...
                                            window.open(linkDownload + Ext.selectRow.get("c_code") + ".pdf?T=Tap_"
                                                    + Math.floor(Math.random() * 100000), "Monitoring", 'fullscreen="yes"');
                                        },
                                        scope: this,
                                        //                                    },
                                        //                {

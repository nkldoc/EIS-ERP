...
$mode		= $_REQUEST["mode"];
$table 		= "gl_dc_book_doc";
$keyName 	= "gl_dc_book_doc_id";
...
switch ($mode) {
    case "ADD" : 
        $arrParam = array();
        $arrParam[] = $data["dc_doc_id"];
        $arrParam[] = $data["gl_dc_book_type_id"];
        $arrParam[] = $data["gl_dc_book_typeID"];
        ...
        $sql = "insert into {$table} (dc_doc_id,gl_dc_book_type_id,c_name, c_comment, i_enable,i_delete

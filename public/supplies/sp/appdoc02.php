...
1	บันทึกรายการลงนามอนุมัติขอดำเนินเรื่องเอกสารซื้อจ้าง	TORSTEP01	1
2	บันทึกรายการลงนามอนุมัติใบขอซื้อจ้าง	TORSTEP02	1
3	บันทึกรายการลงนามอนุมัติแต่งตั้งคณะกรรมการตรวจรับ	TORSTEP03	1
4	ลงนามขออนุมัติรายการคำสั่งซื้อ PO	APSTEP01	1
5	ลงนามขออนุมัติรายการตรวจรับ	APSTEP02	1
6	ลงนามขออนุมัติดำเนินการยกเลิก/ประกาศแผนใหม่	TORSTE01	0*/        
            Ext.status_sigature_document = 'TORSTEP02'; //APSTEPS[10-50]
            Ext.title = "บันทึกรายการลงนามอนุมัติแต่งตั้งคณะกรรมการตรวจรับ";
            //
            Ext.keyData = 1;
            Ext.menu_i_alarm = 1;
            Ext.menu_i_day = 1;

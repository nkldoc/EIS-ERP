...
function lineNotif($msg = null) {
 ...
 $dc_department_id = $_REQUEST["dc_department_id"]??null;
...
//                                echo $query; exit();
        ...
        $dc_department_id = mysqli_real_escape_string($con, $dc_department_id);
        $dc_cost_id = mysqli_real_escape_string($con, $dc_cost_id);
        ...
        $sql = "INSERT INTO "
                . "`lognotif` (`id`, `i_type`,`c_name`, `user_id`, `user_sent_id`, `user_sent_name`, `client_datetime`, `c_menu`, `i_status`,`dc_cost_id`,`dc_department_id`) "
                . " VALUES (NULL, '{$i_type}', '{$c_name}', {$user_id},{$user_sent_id}, '{$user_sent_name}','{$client_datetime}', '{$c_menu}', '{$i_status}', '{$dc_cost_id}', '{$dc_department_id}');";

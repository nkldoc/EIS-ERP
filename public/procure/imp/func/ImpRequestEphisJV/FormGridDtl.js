...
const saveDtl = function(mode) {
  ...
  //  console.log(v.data.c_request,"<<== JSON SAVE = วันที่ d_pay format Exp 03-03-2563 : ", d_paid," D CANCEL= ",d_waive);
    ...
    { //Validate เฉพาะเมนู บันทึกบัญชีตั้งหนี้
      ...
      { 
        mini_msg += "กรุณาบันทึก ผังบัญชี<br>"; 
      }
 
      if ( ((v.data.f_dr==null) || (v.data.f_dr=="") || (v.data.f_dr=="0.00") || (v.data.f_dr==".00"))
        && ((v.data.f_cr==null) || (v.data.f_cr=="") || (v.data.f_cr=="0.00") || (v.data.f_cr==".00")) )
      { 
        mini_msg += (mini_msg=="") ? "กรุณาบันทึก จำนวนเงินเดบิต (DR) หรือ เครดิต (CR)<br>" : c_spaces+"จำนวนเงินเดบิต (DR) หรือ เครดิต (CR)<br>"; 
      }        
    ...
    jsonArr.push({
      imp_request_ephis_item_id: v.data.id, 
  ...
  if (msg == "") 
  {
    ...
    Ext.Ajax.request({
      ...
      success: function(result, request) {
        ...
        Ext.storeItemEPHIS.load({ params: { hdr_id: Ext.HDR_ID } });
...
const impData = function() {
  ...
  Ext.storeItemEPHIS.loadData({ data: json });
  ...
  formPanelDtl.superclass.constructor.call(this, {
    ...
    items: [
      new Ext.grid.EditorGridPanel({
        ...
        loadMask: true,
        clicksToEdit: 1,
        store: Ext.storeItemEPHIS, //Ext.storeDtl
        viewConfig: {
        ...
        columns: [
          ...
          ,{
            header: "<font color=#005aff>**</font>จำนวนเงินเดบิต(DR)<br><font color=#005aff>(บันทึกบัญชี)</font>",
            sortable: false,
            align: "center",
            dataIndex: "f_dr",
            width: 150,
          ...
          ,{
            header: "<font color=#005aff>** </font>จำนวนเงินเครดิต(CR)<br><font color=#005aff>(บันทึกบัญชี)</font>",
            sortable: false,
            align: "center",
            dataIndex: "f_cr",
            width: 150,
          ...
          ,{
            header: "<font color=red>* </font>จำนวนขอเบิกทั้งสิ้น<br><font color=red>(รายงานใบเบิก/ตั้งหนี้)</font>",
            sortable: false,
            align: "center",
            dataIndex: "f_inv",
            width: 150,
          ...
          ,{
            header: "<font color=red>* </font>จำนวนเงินภาษีมูลค่าเพิ่ม<br><font color=red>(รายงานใบเบิก/ตั้งหนี้)</font>",
            sortable: false,
            align: "center",
            dataIndex: "f_vat",
            width: 150,
          ...
          ,{
            header: "<font color=red>* </font>ภาษีเงินได้บุคคลธรรมดา<br><font color=red>(รายงานใบเบิก/ตั้งหนี้)</font>",
            sortable: false,
            align: "center",
          ...
          ,{
            header: "<font color=red>* </font>ภาษีเงินได้นิติบุคคล<br><font color=red>(รายงานใบเบิก/ตั้งหนี้)</font>",
            sortable: false,
            align: "center",
          ...
          ,{
            header: "<font color=red>* </font>ค่าประกันสังคม<br><font color=red>(รายงานใบเบิก/ตั้งหนี้)</font>",
            sortable: false,
            align: "center",
          ...
          ,{
            header: "<font color=red>* </font>ค่าปรับ<br><font color=red>(รายงานใบเบิก/ตั้งหนี้)</font>",
            sortable: false,
            align: "center",
            dataIndex: "f_fine",
            width: 150,

<?php
include("../api/List_RepGlBalancePost.php");
...
{
	$caption		= "รายงานยอดคงเหลือบัญชีแยกประเภท (ภาพรวม)"; 
}
else
{
	$caption		= "งบทดลอง";
...
<?php 
	...
	if (! in_array ( "0", $dc_cost_id )) {
		...
		$c_cost_show = "หน่วยงาน : <font color='blue'>" . $name_cost . "</font>";
	} else {
		$c_cost_show = "หน่วยงาน : <font color='blue'> ทั้งหมด </font>";
	}
	...
	echo "<div align=\"left\"><strong>".$c_cost_show."</strong></div>";
?>

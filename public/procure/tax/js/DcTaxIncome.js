...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            title:'ข้อมูลแบบแสดงรายการภาษีเงินได้ (ภ.ง.ด.)',  
            items:[{
                    id : "frm-mode",
                    xtype : "hidden",
                    name : "mode",
                    ...
                    xtype: 'radiogroup',
                    id: 'frm-i_is_method',
                    fieldLabel: 'การสรุปข้อมูล',
                    columns: [135, 135],
                    items: [
                        { boxLabel: 'ไม่ต้องสรุปข้อมูลรายปี', name: 'i_is_method', inputValue: Ext.DC_TAX_INCOME_METHOD_NOSUM, checked: true },
                        { boxLabel: 'ต้องสรุปข้อมูลรายปี', name: 'i_is_method', inputValue: Ext.DC_TAX_INCOME_METHOD_ISSUM }
                    ]
                }, {
                    xtype: 'radiogroup',
                    id: 'frm-i_is_type',
                    fieldLabel: 'ประเภทแบบ',
                    columns: [170, 135],
                    items: [
                        { boxLabel: 'แบบแสดงรายการประจำเดือน', name: 'i_is_type', inputValue: Ext.DC_TAX_INCOME_TYPE_MONTH, checked: true },
                        { boxLabel: 'แบบสรุปรายการประจำปี', name: 'i_is_type', inputValue: Ext.DC_TAX_INCOME_TYPE_YEAR }
                        ],listeners: {
                            afterrender:function(){ 
                                this.fn = function(val){
                                    if(parseInt(val) === parseInt(Ext.DC_TAX_INCOME_TYPE_YEAR)){ 
                                        Ext.getCmp('frm-parent_id').enable();
                                    }else{  
                                        Ext.getCmp('frm-parent_id').disable(); 
                                    } 
                                };
                                this.fn(null);
                             },
                            change : function(obj, value){ 
                                this.fn(value.inputValue);  
                            }
                        }
                },{
                    xtype: 'combo',
                    fieldLabel: 'ชื่อย่อ แบบแสดงรายการประจำเดือน',
                    id: 'frm-parent_id',
                    disabled:true,
...
Ext.QuickTips.init();
    var gridMain = {
        region: 'center',
        title: 'แสดงข้อมูลแบบแสดงรายการภาษีเงินได้ (ภ.ง.ด.)',
        xtype: 'grid',
        id:'tabpanel1',
        border: false,
        stripeRows: true,
        ...
        { id: 'c_name', header: "ชื่อย่อ", width:210, sortable: true, dataIndex: 'c_name' }, 
        { header: "ชื่อเต็ม", width:210, sortable: true, dataIndex: 'c_name_full' }, 
        { header: "การสรุปข้อมูล", width:210, sortable: true, dataIndex: 'c_method' }, 
        { header: "ประเภทแบบ", width:210, sortable: true, dataIndex: 'c_type' }, 
        {
            header: "Status",  
            sortable:false,
            align: 'center',

Ext.onReady(function() {
  Ext.QuickTips.init();
  /*===============================================*/
  Ext.title_panel = "บันทึกใบขอเบิก(หน่วยงาน)";
  /*===============================================*/
  // pagingBar
  ...
  const gridMain = new Ext.grid.GridPanel({
    ...
    columns: [
      ...
      //         }
      //       },
      { header: "เอกสารอ้างอิง", sortable: false, align: "center", width: 100, dataIndex: "c_code_ref" },
      {
        id: "c_name",
        header: "เรื่อง",
        sortable: false,
  ...
  let myComboStores = [Ext.dc_cost, Ext.dc_expense_budget_type, Ext.po_expense, Ext.po_expense, Ext.po_emp, Ext.po_user_permission];

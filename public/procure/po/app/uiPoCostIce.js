...
//                                }
                            ...
                            Ext.Ajax.request({
                                ...
                                params: {
                                    mode: 'UPDATE_MIS',
                                    sp_check_period_hdr_id: Ext.getCmp('idID').getValue()
                                },
    ...
    var gridChecking = {
        ...
        columns: [
            ...
            {header: "เลขรับของ", align: "left", width: 50, dataIndex: "c_arrive_code"}, //c_arrive_code
            {header: "เอกสารอ้างอิง", align: "left", width: 55, dataIndex: "c_doc_ref"}, //c_arrive_code
...
//                                                rec.set("c_yyyy", parseInt(Ext.i_yyyy) + 543);
//                                                rec.set("nowc_yyyy", parseInt(rec.get("now_yyyy")) + 543);
        ...
        tbar: [
            {
                ...
                handler: function () {
                    if (Ext.isEmpty(Ext.getCmp('panelForm'))) {
                        Ext.getCmp("contenterCenter").add(Ext.panelForm());

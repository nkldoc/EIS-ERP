<?php
include("../api/List_RepDcCheque.php");
...
if( is_array($data_dtl) && count($data_dtl["data"]) > 0 ) {
	...
	foreach($data_dtl["data"] as $index => $jObj) {
		...
		$tbody	.= "<td ".$style." align='center' nowrap>".$jObj["c_show"]."</td>"; 
		
		$tbody	.= "<td ".$style." align='center'>".$jObj["c_cheque"]."</td>"; 
		
		$tbody	.= "<td ".$style." align='center'>".$jObj["c_bank_name"]."</td>";
		$tbody	.= "<td ".$style." align='center'>".$jObj["c_book_number"]."</td>";
		$tbody	.= "<td ".$style." align='center'>".$jObj["c_book_name"]."</td>"; 
		$tbody	.= "<td ".$style." align='center'>".$jObj["c_book_branch_name"]."</td>";
		$tbody	.= "<td ".$style." align='center'>".$jObj["c_book_type_name"]."</td>";		
		$tbody	.= "<td ".$style." align='center'>".$jObj["c_status"]."</td>";

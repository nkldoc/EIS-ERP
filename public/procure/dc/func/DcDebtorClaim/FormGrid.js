Ext.onReady(function() {
  Ext.QuickTips.init();
  /*===============================================*/
  Ext.title_panel = "สิทธิ์การรักษา";
  /*===============================================*/
  ...
  const gridMain = new Ext.grid.GridPanel({
    ...
    columns: [
      ...
      { header: "เลขที่เอกสาร", sortable: true, align: "center", width: 100, dataIndex: "c_code" },
      { id: "c_name", header: "ชื่อสิทธิ์การรักษา", sortable: true, dataIndex: "c_name" },
      { header: "กองทุน", sortable: true, align: "center", width: 200, dataIndex: "c_fund" },
      {
        header: "สถานะรายการ",
        sortable: true,
        align: "center",
  ...
  let myComboStores = [Ext.store_fund];

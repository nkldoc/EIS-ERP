<?php
include("../api/List_RepAssetDonate.php");
...
$caption = "รายงานครุภัณฑ์ถยอยรับรู้ " . ($_REQUEST['i_year'] + 543) /*. "<br> ระหว่าง : "
...
if (is_array($data_dtl) && count($data_dtl["data"]) > 0) {
	...
	foreach ($data_dtl["data"] as $index => $jObj) {
		//if ($jObj["i_type"] == '1') {
			...
			$tbody .= "<td style='" . $style . "' align='center' nowrap>" . $jObj["i_donate"] . "</td>";
			...
			<table id='tb_main' width="100%" class="table_report" style=" width: 2000px; display:none" border="0" cellspacing="1" cellpadding="0">
				<thead valign="top">
					<tr>
						...
						<th style="vertical-align:middle;" rowspan=0 nowrap>สินทรัพย์บริจาค</th>

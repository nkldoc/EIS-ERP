<?php
include("../api/List_RepBankAccountDetail.php");
	...
	foreach($data_dtl["data"] as $index => $jObj) {
		...
		if($totalCount == $jObj["numrow"]) {
			...
			$tbody	.= "<tr>
							...
							<td align='right' nowrap style='border-right: 1px solid; border-bottom: 1px solid;'>".$jObj["f_dr2"]."</td>
							<td align='right' nowrap style='border-right: 1px solid; border-bottom: 1px solid;'>".$jObj["f_cr2"]."</td>
						</tr>";
			$tbody	.= "<tr>
	...
	$data	= "	<table class='table-data' border='0' align='center' cellpadding='3' cellspacing='0' width='100%'>
					<thead>
						<tr>
							...
							<th rowspan=2 class='headerTitle01' style='border: 1px solid; border-left: none;' valign='middle' nowrap>ที่เอกสาร</th>
							<th rowspan=2 class='headerTitle01' style='border: 1px solid; border-left: none;' valign='middle' nowrap>รายการ</th>
							<th rowspan=2 class='headerTitle01' style='border: 1px solid; border-left: none;' valign='middle' nowrap>เดบิต (ฝาก)</th>
							<th rowspan=2 class='headerTitle01' style='border: 1px solid; border-left: none;' valign='middle' nowrap>เครดิต (ถอน)</th>
						</tr>
						<tr>
	...
	if($TYPE == "firstPage") {
		...
		$data	.= "<br>
					<table border='0' align='center' cellpadding='0' cellspacing='0' width='100%'>
						<tr><td style='text-align: left;'>ธนาคาร : {$dc_bank_name}</td></tr>
						<tr><td style='text-align: left;'>เลขที่บัญชี : {$dc_bank_acc_company_name}</td></tr>
					</table>
					<br>";
	}

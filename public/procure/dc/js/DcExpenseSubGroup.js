            ...
            buttons : [
                {
                    ...
                    handler : function() {
                        Ext.Ajax.request({
                            url : 'api/mnDcExpenseSubGroup.php' , 
                            params : { 
                                    mode : 'DELETE', 
                                    id : record.get('id')
                            }, 
...
dc_expense_group	= new Ext.data.JsonStore({
	autoLoad: true,
	url: "api/All_DcExpenseSubGroup.php",
	baseParams: { type: "dc_expense_group_id_all"},
	root: "data",
	idProperty: "id",
	fields: [ "id", "c_name" ]
});
        ...
        items:[{
                ...
                validator: function(val) {
                    if (!Ext.isEmpty(val)){ return true; } else {
                        return "กรุณา กรอกหมวดรายจ่ายย่อย";
                    }
                }
            },{
			xtype: 'combo',
			id: "dc_expense_group_id",
			hiddenName: "dc_expense_group_id",
...
searchGrid = function() {
    var filters = {
        ...
        store: new Ext.data.SimpleStore({
            fields: ["id", "c_name"],  
            data:[['c_name', "ชื่อหมวดรายจ่ายย่อย"],['c_code', "รหัส"]],
        }),
        value: 'c_name',
        valueField: 'id',
        displayField: 'c_name',
...
Ext.store = new Ext.data.JsonStore({
    ...
    autoDestroy: true,
    autoLoad: true,
    url : 'api/ListDcExpenseSubGroup.php',
    root: 'data',
...
Ext.onReady(function(){
    ...
    var gridMain = {
        ...
        columns:[
			...
			{ id: 'c_name', header: "หมวดรายจ่ายย่อย", width:350, sortable: true, dataIndex: 'c_name' }, 
            {
                header: "Status",  
                sortable:false,
                align: 'center',

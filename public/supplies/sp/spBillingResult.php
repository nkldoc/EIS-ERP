...
class clsPageStatus {
    ...
    function get_js() {
        return is_array($this->temp) ? ($this->temp['js'] ?? null) : null;
    }
...
$pg = new clsPageStatus($db, $_GET["st"] ?? $_SESSION["st"] ?? null);
$_SESSION["st"] = $_GET["st"] ?? $_SESSION["st"] ?? null;
...
?>
        ...
        <script type="text/javascript">
            //--------config ---------------------------------------------------
            Ext.menu_name = 'รายการสรุปเพื่อส่งเบิก';
            Ext.menu_code = 'ST0001';
            Ext.menu_i_entrance = '0';
        ...
        <script type="text/javascript" src="./tor/spBillingResult.js?_dc=<?= __VPRODUCT_; ?>"></script>

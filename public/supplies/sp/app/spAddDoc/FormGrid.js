    ...
    Ext.gridColumn = Ext.apply({column: [
            ...
            },
            {
                ...
                renderer: function (value, metaData, record, row, col, store, gridView) {
                    ...
                    var val = "บันทึกขออนุมัติเอกสารลงนาม";
                    var BtnText = "<img src='../images/icons/vcard_edit.png' style='margin-right:1px;' /><div><spen style='font-size:11px'>" + val + "</spen>";
                    return '<button ' + styleBu + ' type="button">' + BtnText + "</button>";
...
//                        rec.set("c_title", rec.json.singer.c_title);
//                        rec.set("c_first_name_eng", rec.json.singer.c_first_name_eng);
//                        rec.set("c_sub_name_eng", rec.json.singer.c_sub_name_eng);
//                        rec.set("c_name", rec.json.singer.c_name);

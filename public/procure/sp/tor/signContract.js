            ...
            callback: function (recordx, operation, success) {
                if (success) {
                    ...
                    new Ext.Window({
                        ...
                        width: Ext.getCmp("contenterCenter").getWidth() - 1,
                        height: Ext.getCmp("contenterCenter").getHeight() - 1,
                        modal: true,
                        plain: true,
                        maximizable: true,
                        collapsible: true,
...
goToMapping = () => {
    var date_Ymd = Ext.util.Format.date(Ext.getCmp("d_start_dateID").getValue(), "Ymd");
    ...
    if (msg == "") {
        Ext.Ajax.request({
            url: "tor/api/mnContractMappingCode.php",
            method: "POST",
            params: {
                mode: "MAPPINGCODECST",
                id: Ext.HDR_ID,
                c_code: Ext.getCmp('c_contrac_codeID').getValue(),
                sp_tor_contract_id: Ext.SelectStore.data.sp_tor_contract_id,
...
Ext.AppUx = function (app, menu) {
    ...
    var AppPoStore = function (statuss) {
        ...
        var colCnt = [
            ...
            //   id: "detailPeriod",
            //   renderer: function (value, metaData, record, row, col, store, gridView) {
            //     return "<button>Period Detail</button>";
            //   },
            // },
            {
                header: "เลขสัญญา",
        ...
        function d_doc_dateID_Change() {
            if (Ext.getCmp("d_start_dateID").getValue() == "") {
        ...
        function i_dayID_Change() {
            if (Ext.getCmp("i_dayID").getValue() != "") {
                ...
                if (Text_alert == "") {
                    ...
                    var firstDate = new Date(Ext.util.Format.date(Ext.getCmp("d_start_dateID").getValue(), "Y/m/d"));
        ...
        var PopContForm = new Ext.Poplov_in({
            ...
            cellClickGrid: function (grid, rowIndex, columnIndex, e) {
                ...
                var TextShow = c_tax_number_imp + " : " + record.data.c_name;
                Ext.getCmp("f_totalID").setValue(record.data.f_total_price);
                Ext.getCmp("i_parentID").setValue(record.data.dc_creditor_id);
                Ext.getCmp(nameID).setValue(TextShow);
            },
        });
        var colPeriod = [
...
//----------------------------------Insert Code---------------------------------------------------//
                                                                            if (this.getValue().inputValue == 4) {
                                                                                ...
                                                                                Ext.getCmp('form-widgets').insert(8, new Ext.ButtonGroup({
                                                                                    fieldLabel: "จับคู่",
                                                                                    frame: false,
                                                                                    border: false,
                                                                                        ...
                                                                                        new Ext.form.ComboBox(
                                                                                                {
                                                                                                    ...
                                                                                                    store: new Ext.data.JsonStore({
                                                                                                        ...
                                                                                                        baseParams: {type: "sp_type_mapping_code"},
                                                                                                        root: "data",
                                                                                                        idProperty: "id",
                                                                                                        fields: ["id", "c_code", "c_gen"]
                                                                                                    }),
                                                                                                    width: 300,
                                                                                                    //										  fieldLabel: "สัญญาที่จองไว้ล่วงหน้า",
                                                                                                    submitValue: true,
                                                                                                    hiddenName: "c_contrac_code",
                                                                                                    name: "c_contrac_code",
                                                                                                    id: "c_contrac_codeID",
                                                                                                    valueField: "c_code",
                                                                                                    displayField: "c_code",
...
//
                                                                                                        ...
                                                                                                        afterrender: function ()
                                                                                                        {
                                                                                                            ...
                                                                                                            this.store.load({
                                                                                                                'callback': function (record, operation, success) {
                                                                                                                    if (success)
                                                                                                                    {
                                                                                                                        Ext.getCmp('c_contrac_codeID').setValue(this.data.items[0].get('c_code'));
                                                                                                                    }
                                                                                                                }
                                                                                                            });
                                                                                                        }
                                                                                    ...
                                                                                    xtype: "label",
                                                                                    id: 'labelID',
                                                                                    style: "color:red ;white-space: nowrap;margin-right:5px;",
                                                                                    text: "* สัญญาที่จองไว้ล่วงหน้าหากหาไม่เจอให้ติดต่อ admin"
                                                                                }
                                                                                );
                                                                            } else {
                                                                                Ext.getCmp('form-widgets').remove(Ext.getCmp('buttonGroupID'));
                                                                            }
                                                                    ...
                                                                    items: [
                                                                        ...
                                                                        {
                                                                            boxLabel: "จับคู่เลขสัญญาที่จองไว้",
                                                                            name: "i_edit_type",
                                                                            inputValue: "4",
                                                                        },
                                                                    ]
                                                                    ...
                                                                    msgTarget: 'under',
                                                                    items: [
//            {xtype: 'displayfield', value: 'ประเภทสัญญา'},
...
//                                  fieldLabel: "ประเภทสัญญา",
                                                                        ...
                                                                        }, {xtype: 'displayfield', value: ')'}, {xtype: 'displayfield', value: 'ของที่ได้มา'},
                                                                        {
                                                                            xtype: "displayfield",
//                                  fieldLabel: "ของที่ได้มา",
...
//    columns: 2,
//    items: [
////        { xtype: "label", style: { color: "blue", }, text:"mycbxgrp"},
//        { id: 'cbxName', boxLabel: 'Name', name: 'mycbxgrp', inputValue: 1 },
////        { xtype: "label", style: { color: "blue", }, text:"Description"},
//        { id: 'cbxDescription', boxLabel: 'Description', name: 'mycbxgrp', inputValue: 2 }
//    ]
//},
//                                {
                                                    ...
                                                    buttons: [
                                                        {
                                                            ...
                                                            listeners: {
                                                                afterrender: function () {
                                                                    ...
                                                                    console.log(Ext.selectRow.get("i_type_bg"));
                                                            ...
                                                            handler: function () {
                                                                ...
                                                                // }
                                                                if (Ext.getCmp("i_edit_typeID").getValue().inputValue == 4) {
                                                                    alert('GO TO MAPPING');
                                                                    goToMapping();
                                                                    return false;
                                                                } else if (Ext.getCmp("i_edit_typeID").getValue().inputValue == 3) {
                                                                    GenCode_CTS();
                                                                    return;
                                                                } else if (msg == "") {
                                                                    var formSubmit = function () {

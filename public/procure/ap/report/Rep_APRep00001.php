<?php
include("../api/List_APRep00001.php");
...
$caption	= "รายงานงบประมาณที่ส่งเข้ามาที่ฝ่ายการเงิน";
...
if( is_array($data_dtl) && count($data_dtl["data"]) > 0 ) {
	...
	foreach($data_dtl["data"] as $index => $jObj) {
		...
		if( @$jObj["i_type"] == 1 ) {
			...
			$tbody	.= "<td ".$style." align='center'>".$jObj["d_doc_date"]."</td>";
			$tbody	.= "<td ".$style." align='center'>".$jObj["c_code"]."</td>";
			$tbody	.= "<td ".$style." align='center'>".$jObj["d_save_date"]."</td>";
			...
			$tbody	.= "<td ".$style.">".$jObj["c_cost_name"]."</td>";
			$tbody	.= "<td ".$style." align='right'>".number_format($jObj["f_dr"],2)."</td>";
			$tbody	.= "<td ".$style." align='right'>".number_format($jObj["f_cr"],2)."</td>";
			$tbody	.=	"</tr>";
			...
			$tbody	.=	"<tr>";
			$tbody	.= "<td ".$style." colspan='7' align='right'><b>รวม</b></td>";
			...
			$tbody	.=	"<tr>";
			$tbody	.= "<td ".$style." colspan='9'><b><font color='red'>คำอธิบายรายการ :</font> ".$jObj["c_comment"]."</b></td>";
			$tbody	.=	"</tr>";
			...
			$tbody	.=	"<tr>";
			$tbody	.= "<td ".$style." colspan='7' align='right'><b>รวมทั้งสิ้น</b></td>";
			$tbody	.= "<td ".$style." align='right'><b>".number_format($jObj["f_dr"],2)."</b></td>";
			$tbody	.= "<td ".$style." align='right'><b>".number_format($jObj["f_cr"],2)."</b></td>";
			$tbody	.=	"</tr>";

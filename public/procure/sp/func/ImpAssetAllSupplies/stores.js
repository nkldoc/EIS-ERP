Ext.store = new Ext.data.JsonStore({
  autoDestroy: false,
  autoLoad: true,
  url: "api/List_ImpAssetAllSupplies.php",
  baseParams: {
    type: "imp_assetall_supplies_hdr",
    // i_read: user_right_read,
  }, // Permission i_read
  root: "data",
  idProperty: "id",
  totalProperty: "totalCount",
  fields: [{ name: "no" }, { name: "id" }, , { name: "sp_check_period_hdr_id" }, { name: "c_name" }, { name: "c_comment" }, { name: "i_enable" }, { name: "d_create" }, { name: "d_update" }],
});
...
Ext.storeDtl = new Ext.data.JsonStore({
  ...
  autoLoad: false,
  url: "api/List_ImpAssetAllSupplies.php",
  baseParams: { type: "imp_assetall_supplies_dtl" },
  root: "data",
  idProperty: "id",
  totalProperty: "totalCount",

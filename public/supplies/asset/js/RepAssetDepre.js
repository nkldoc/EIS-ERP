Ext.onReady(function () {
  ...
  /* =============================================== */
  title_panel = "รายงานรายละเอียดค่าเสื่อมประจำเดือน";
  /* =============================================== */
  ...
  LookReport = function (type) {
    ...
    if (Ext.getCmp("am_mode_acc_id").getValue() == "") {
      msg += "<span style='white-space: nowrap;'>- กรุณาเลือกหมวดครุภัณฑ์</span><br>";

    }

    if (msg == "") {
      href = "report/Rep_AssetDepre.php";
      var resultUrl = "";
      resultUrl += "&type=" + type;
      ...
      resultUrl += "&am_mode_id=" + Ext.getCmp("am_mode_acc_id").getValue();
      resultUrl += "&in_year=" + Ext.getCmp("in_year").getValue().inputValue;

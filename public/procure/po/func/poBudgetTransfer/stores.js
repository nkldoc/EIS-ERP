Ext.store = new Ext.data.JsonStore({
  autoDestroy: false,
  autoLoad: true,
  url: "api/List_poBudgetTransfer.php",
  baseParams: { type: "bg_budget_hdr_transfer", i_read: user_right_read }, // Permission i_read
  root: "data",
  idProperty: "id",
...
let storeDtlRecord = Ext.data.Record.create([{ name: "no" }, { name: "id" }, { name: "bg_expense_begin_id" }, { name: "bg_expense_end_id" }, { name: "f_total" }, { name: "c_comment" }]);

Ext.storeDtl = new Ext.data.JsonStore({
  autoDestroy: false,
  autoLoad: false,
  url: "api/List_poBudgetTransfer.php",
  baseParams: { type: "bg_budget_dtl_transfer" },
  root: "data",
  idProperty: "id",
  totalProperty: "totalCount",

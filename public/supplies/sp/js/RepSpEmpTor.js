Ext.onReady(function () {
  Ext.QuickTips.init(); 
  Ext.title_panel = "รายงานผู้รับผิดชอบงานตาม TOR";  
...
//  });
  ...
  LookReport = function (type) {
    ...
    if (msg === "") {
      href = "report/RepSpEmpTor.php"; 
      var resultUrl = ""; 
      
      resultUrl += "&type=" + type;
      resultUrl += "&sp_emp_id=" + Ext.getCmp("sp_emp_idID").getValue(); 
      resultUrl += "&c_emp_name=" + Ext.getCmp("sp_emp_idID").lastSelectionText; 
...
//                          });
                  ...
                  }), 
                  {
                    ...
                    fieldLabel: "ตรวจสอบเอกสารระหว่างวันที่",
                    msgTarget: "under",
                    items: [
                      {
                        xtype: "datefield",
        ...
        buttons: [
          {
            ...
            handler: function () {
             //   console.log(Ext.getCmp("sp_emp_idID").lastSelectionText);
            LookReport("html");
            }, // End Handle
          },
          {

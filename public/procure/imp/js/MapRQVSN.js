...
Ext.onReady(function() {
	...
	/* =============================================== */
	title_panel		= "จับคู่ใบเบิกกับใบเบิกพิเศษ(ตั้งหนี้แล้วนอกระบบ/Vision Net)";	
	/* =============================================== */
	
	Ext.store = new Ext.data.JsonStore({
		autoLoad: false,
		url: "api/List_MapRQVSN.php",
		baseParams: { type: "imp_request_vsn_hdr", i_read: user_right_read }, // Permission i_read
	    root: "data",
	    idProperty: "id",

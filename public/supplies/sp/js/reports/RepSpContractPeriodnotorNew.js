...
Ext.urlReport     = true ? "../../reports/repSpContract_registrationGLnew" : "../../reports/printr.php?get=true"; //DEBUG (PDF/Excel เดิม)
Ext.urlReportHTML = "report/RepSpContract_registrationGLnew_html.php"; // endpoint HTML ใหม่
  // Spring Boot
  ...
  Ext.sp_tor_contract = new Ext.data.JsonStore({
    autoDestroy: false,
    autoLoad: false,
    url: "api/All_RepSpContractnew.php",
    baseParams: { type: "sp_tor_contract", all: "all", i_sys: "1" }, // *** เฉพาะคณะแพทย์ ***
    root: "data",
    idProperty: "id",
    fields: ["id", "c_code"],
    listeners: {
    ...
    Ext.dc_expense_budget_type = new Ext.data.JsonStore({
        autoDestroy: false,
        autoLoad: true,
        url: "api/All_RepSpTorExpnew.php",
  ...
  Ext.sp_emp = new Ext.data.JsonStore({
    autoDestroy: false,
    autoLoad: true,
    url: "api/All_RepSpContractPeriodnotornew.php",
    baseParams: { type: "sp_emp", all: "all", i_sys: "1" }, // *** เฉพาะคณะแพทย์ ***
    root: "data",
    idProperty: "id",
    fields: ["id", "c_name"],
    listeners: {
      load: function (t, records, options) {
        // backend (All_RepSpContractPeriodnotornew.php) กรองด้วย i_sys=1 ให้แล้วตั้งแต่ query
        // จึงไม่ต้องกรองซ้ำฝั่ง client อีก
  ...
  Ext.dc_expense_budget_type = new Ext.data.JsonStore({
    ...
    autoLoad: true,
    url: "api/All_RepSpTorExpnew.php",
    baseParams: { type: "dc_expense_budget_type", all: "all", i_sys: "1" }, // *** เฉพาะคณะแพทย์ ***
    root: "data",
    idProperty: "id",
    fields: ["id", "c_name"],
    listeners: {
...
Ext.dc_creditor = new Ext.data.JsonStore({
    ...
    autoLoad: true,
    url: "api/All_RepSpContractnew.php",
    baseParams: { type: "dc_creditor", all: "all", i_sys: "1" }, // *** เฉพาะคณะแพทย์ ***
    root: "data",
    idProperty: "id",
    fields: ["id", "c_name"],
    listeners: {
...
Ext.dc_cost = new Ext.data.JsonStore({
    autoDestroy: false,
    autoLoad: true,
    url: "api/RepSpContract_registrationGL_dcnew_cost.php",
    root: "data",
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                  ...
                  { xtype: "hidden", id: "i_sysID", name: "i_sys", value: "1" }, // *** บังคับเป็นคณะแพทย์เท่านั้น ***

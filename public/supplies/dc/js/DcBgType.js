...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: 'ชื่อประเภทงบประมาณ',
					width : 300,
                    name : 'c_name',
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบุ ชื่อประเภทงบประมาณ";
                        }
                    }
                },{
                    xtype: 'textarea',
...
searchGrid = function() {
    ...
    var cmbFilters = {
                    ...
                    store: new Ext.data.SimpleStore({
                        fields: ["id", "c_name"],  
                        data:[['c_name', "ชื่อประเภทงบประมาณ"]]
                    }),
                    value: 'c_name',
                    valueField: 'id',
                    displayField: 'c_name',
...
Ext.QuickTips.init();
        var gridMain = {
                region: 'center',
                title: 'แสดงข้อมูลประเภทงบประมาณ',
                xtype: 'grid',
                id:'tabpanel1',
                border: false,
                stripeRows: true,
                ...
                { id: 'c_name', header: "ชื่อประเภทงบประมาณ", width:210, sortable: true, dataIndex: 'c_name' }, 
                {
                        header: "Status",  
                        sortable:false,
                        align: 'center',

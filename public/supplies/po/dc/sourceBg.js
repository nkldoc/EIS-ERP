...
//Ext
  ...
  Ext.mnController = 'dc/controller/mnSourceBg.php' ;
  Ext.DAO = 'dc/DAO/ListSourceBg.php' ;
  Ext.title = 'ข้อมูลแหล่งที่มาของเงิน' ;
  ...
  Ext.extend ( searchGrid = function () {
      ...
      var cmbFilters = {
          ...
          store : new Ext.data.SimpleStore ( {
              fields : [ "id" , "c_name" ] ,
              data : [ [ 'c_name' , "แหล่งที่มาเงิน" ] , [ 'c_code' , "รหัสสถานะ" ] ]
          } ) ,
          value : 'c_name' ,
          valueField : 'id' ,
          displayField : 'c_name' ,

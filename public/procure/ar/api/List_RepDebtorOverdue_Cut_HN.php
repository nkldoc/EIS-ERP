...
function List_QueryParam()
{
	...
	$sqlMain = "
		...
		FROM dbo.ar_cut_invoice_hdr a
			...
			LEFT JOIN dbo.ar_cut_invoice_dtl c ON b.ar_debtor_type_id = c.ar_debtor_type_id
				...
				AND b.c_code_bill = c.c_code_bill
				AND b.f_cut = c.f_cut
		...
		WHERE b.ar_cut_invoice_dtl_id = {$_REQUEST["ar_cut_invoice_dtl_id"]}

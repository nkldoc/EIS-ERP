...
const saveDtl = function () {
  ...
  if (msg == "") {
    ...
    Ext.Ajax.request({
      url: "api/mn_poCloseReceiveHdr.php",
      method: "POST",
      params: {
        mode: mode,
        id: mode == "ADD_DTL" ? "" : Ext.getCmp("dtl_id").getValue(),
        po_close_receive_hdr_id: Ext.HDR_ID,
                    ...
                    },
                    {
                      ...
                      items: [{
                        ...
                        },
                        {
                          boxLabel: "ลบ",
                          name: "dtl_mode",
                          inputValue: "DELETE_DTL"
                        },
                        {
                          boxLabel: "โหลดวันหยุดประจำปี",
                          name: "dtl_mode",
                          inputValue: "LOAD_HOLIDAY"
                        }
                      ]
                    },
                    {

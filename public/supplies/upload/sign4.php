...
<html lang="th">
    ...
    <body>
    <form action="/supplies/mergeFocus" method="post" enctype="multipart/form-data">
<!--    <input type="text" name="foldername" placeholder="ชื่อโฟลเดอร์" required>
    ...
    <label>
      <input type="checkbox" name="signData" 
             value="JK.KUT|ผู้ช่วยศาสตราจารย์จักราวุธ มณีฤทธิ|ผู้ช่วยศาสตราจารย์จักราวุธ มณีฤทธิ|ปฏิบัติการแทนอธิการบดี">
     ตำแหน่งที่ A
    </label><br>
    ...
    <label>
      <input type="checkbox" name="signData" 
             value="PIYA.SUK|นางสาวปิยภรณ์ สุขประเสริฐ|หัวหนัาเจ้าที่ซื้อจ้าง|ลงนามแทน">
    ตำแหน่งที่ D
    </label><br>

...
Ext.urlReport = true ? "https://eis.nmu.ac.th:8443/reports/RepSpContractPeriodbg" : "https://eis.nmu.ac.th:8443/reports/printr.php?get=true"; //DEBUG
// Ext.urlReport = false ? "https://eis.nmu.ac.th:8443/reports/repSpContractPeriodbg" : "https://eis.nmu.ac.th:8443/reports/printr.php?get=true"; //DEBUG
  // Spring Boot
  Ext.titleReport = "รายงานข้อมูลการใช้เงินงบปรมาณ";
  ...
  function getTitleReport(v) {
      ...
      Ext.getCmp("dis_i_status_contractID").setValue(Ext.getCmp("i_status_contractID").items.items[(Ext.getCmp("i_status_contractID").getValue().inputValue)].boxLabel) ;       
        ...
        items: [
          {
            ...
            items: [
              {
                title: "รายงานข้อมูลการใช้เงินงบปรมาณ",
                ...
                items: [
                  ...
                  { xtype: "hidden", name: "jasperName", value: "RepSpContractPeriodbg" },
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                  ...
                  { xtype: "hidden", id: "dis_i_status_contractID", name: "dis_i_status_contract", value: "ทั้งหมด" },
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                new Ext.form.ComboBox({
                  ...
                  // PermissionEmp(),
                  {
                    ...
                    columns: [300],
                    fieldLabel: "สถานะ",
                    id: "i_status_contractID",   //i_status_contract
                    name: "i_status_contract", //i_status_contract
                    items: [
                      {
                        checked: true,
                        name: "i_status_contract",
                        inputValue: 0,
                        boxLabel: "รายงานดูข้อมูลการตรวจรับ",
                      },
                      {
                        name: "i_status_contract",
                        inputValue: 1,
                        // hidden: true,
                        boxLabel: "รายงานดูการใช้เงิน",
                      },
                      {
                        name: "i_status_contract",
                        inputValue: 2,

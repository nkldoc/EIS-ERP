...
//                contract_type_0: Ext.selectRow.data.i_type_contract,
                i_type_0: Ext.selectRow.data.i_purchase,
...
Ext.AppUx = function (app, menu, selectRow) {
    ...
    var PopCreditorForm = new Ext.Poplov_in({
        ...
        isCellClickGrid: true,        cellClickGrid: function (grid, rowIndex, columnIndex, e) {
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        new Ext.FormPanel({
                            ...
                            listeners:{
                                afterrender: function () {
                                        // Ext.getCmp("dc_cost_idID").setValue(38);
                                },
                            },
                            items: [
                                {
...
//                                                        }
                                                    ...
                                                    listeners: {
                                                        afterrender: function () {
                                                            this.fn = function () {
                                                              value = this.getValue() ;
                                                            //   console.log(value);
                                                              console.log(Ext.getCmp("i_type_bgID").getValue());
                                                            };
                                                          },
                                                      // selectRow 
                                                      Change: function () {
                                                        this.fn();
                                                        if(this.getValue() == 4){
                                                            Ext.getCmp("i_overlapID").setValue(3);
                                                        }
                                                      },
                                                      beforequery: function (q) {
                                                        if (q.query) {
                                                ...
                                                new Ext.form.ComboBox({
                                                        ...
                                                        this.select_value = function () {
                                                          if (Ext.getCmp("i_budget_year").getValue() > this.getValue()) {
                                                            ...
                                                            Ext.booking_store.load({
                                                              params: { dc_cost_id: Ext.getCmp("dc_cost_id2ID").getValue()
                                                                , i_yyyy_overlap: Ext.getCmp("i_yyyy_overlapID").getValue()},
                                                    ...
                                                    new Ext.form.ComboBox({
                                                        ...
                                                        name: "c_booking",
                                                        hiddenName: "bg_budget_dtl_overlap_id",
                                                        valueField: "bg_budget_dtl_overlap_id",
                                                ...
                                                },
                                                {
                                                    ...
                                                    listeners: {
                                                        change: function (cb, rec) {
                                                            Ext.getCmp("i_product_typeID").fn();
                                                            if (rec.getValue().inputValue == 1 && Ext.getCmp("i_product_typeID").getValue().inputValue == 0) {
                                                                Ext.getCmp("i_product_type1").setValue(true);
                                                            }
                                                        }
                                                    }
                                                },
                                                ...
                                                },
                                                {
                                                    ...
                                                    listeners: {
                                                        ...
                                                        change: function (cb, rec) {
                                                          ...
                                                          afterrender: function () {
                                                            this.fn2(Ext.getCmp("i_purchaseID").getValue().inputValue);
                                                            this.fn();
                                                          }
                                                      }
                                                  }, {
                                                    fieldLabel: "เลขที่เอกสารอ้างอิง",
                                                    readOnly: false,
                                                    id: "c_contract_noID",
                                                    name: "c_contract_no",
                                                    xtype: "textfield",
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function () {
                                            ...
                                            var msg = "";
                                            if (Ext.isEmpty(Ext.getCmp("dc_creditor_idID_Name").getValue())) {
                                                        ...
                                                        failure: function (form, action) {
                                                            switch (action.failureType) {
                                                                case Ext.form.Action.CLIENT_INVALID:
                                                                    Ext.Msg.alert("Failure", "กรุณากรอกข้อมูลคครบและห้ถูกต้อง");
                                                                    break;
...
//                                        alert(spHdrID);
    ...
    Ext.loadStore = function (status, show) {
        ...
        if (statusx === "edit" && Ext.isEmpty(Ext.selectRow)) {
            ...
            Ext.getCmp("dc_cost_idID").setValue(Ext.session.dc_cost_id);
            Ext.getCmp("dc_cost_id2ID").setValue(Ext.session.dc_cost_id);
            winApp.show();
            ...
            if (!Ext.selectRow.get("bg_budget_dtl_overlap_id"))
                Ext.selectRow.set("bg_budget_dtl_overlap_id", null);
            ...
            Ext.booking_store.setBaseParam("dc_cost_id", Ext.select.dc_cost2_id);
            Ext.booking_store.setBaseParam("i_yyyy_overlap", Ext.select.i_yyyy_overlap);
            Ext.booking_store.load();

  Ext.onReady ( function ()
  {
      ...
      if ( Ext.ITYPE_JV )
      {
          Ext.title_panel = "นำเข้าใบเบิก (Vision Net)" ;
      }
      else
      {
          Ext.title_panel = "บันทึกบัญชีตั้งหนี้ใบเบิก (Vision Net)" ;
      }
      /*===============================================*/
      // pagingBar
      ...
      const gridMain = new Ext.grid.GridPanel (
          {
                                      ...
                                      store : new Ext.data.SimpleStore (
                                          {
                                              ...
                                              data : [
                                                  ...
                                                  [ "c_code" , "เลขที่นำเข้าใบเบิก Vision Net" ]
              ...
              columns : [
                  new Ext.grid.RowNumberer (
                      ...
                      header : "เลขที่นำเข้าใบเบิก Vision Net" ,
                      sortable : false ,
                      align : "center" ,
                      dataIndex : "c_code" ,
                      width : 120 ,
                      ...
                      renderer : function ( value , metaData , record , row , col , store , gridView )
                      {
                          ...
                          else if ( record.data.i_is_post == 3 )
                          {
                              str = "ผ่านรายการแล้ว" ;
                          }
                          else
                      ...
                      sortable : true ,
                      width : 130 ,
                      dataIndex : "c_period_no"
                  } , {
                      header : "แหล่งเงิน" ,
                      sortable : true ,
                      width : 130 ,
                      dataIndex : "dc_expense_budget_type"
                  } , {
                      header : "วันที่เอกสาร" ,
                      sortable : true ,
                      align : "center" ,
      ...
      let myComboStores = [ Ext.dc_expense_budget_type , Ext.dc_expense_budget_type_all , Ext.dc_expense_group_vsn , Ext.dc_expense_acc_vsn_full , Ext.gl_dc_config_creditor , Ext.storeItems , Ext.store_dc_acc_last , Ext.store_dc_creditor ] ;

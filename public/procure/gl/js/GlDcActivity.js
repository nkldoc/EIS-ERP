...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: 'ชื่อกิจกรรม',
                    width : 300,
                    name : 'c_name',
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบุ ชื่อกิจกรรม";
                        }
                    }
                /*},{
                    xtype: 'textfield',
                    ...
                    validator: function(val) { 
                            ...
                            if (!regex.test(val))
                            { return "กรุณาระบุ ตำแหน่งบรรทัดที่จะโชว์ในรายงาน"; } else {
                                    return true;
                            }
                    },*/
                },{
...
Ext.QuickTips.init();
        var gridMain = {
                ...
                { id: 'c_name', header: "ชื่อกิจกรรม", width:210, sortable: true, dataIndex: 'c_name' }, 
                {
                        header: "Status",  
                        sortable:false,
                        align: 'center',

  ...
  Ext.d_cal_depre.load({
    callback: function (records, operation, success) {
      if (success) {
        ...
        if (Ext.getCmp("d_cutoff_date").getValue() == "") {
          msg += "<span style='white-space: nowrap;'>- กรุณาระบุวันที่ตัดจำหน่าย</span><br>";
        }
        ...
        if (msg == "") {
          ...
          Ext.Ajax.request({
            ...
            params: {
              ...
              d_cutoff_date: Ext.util.Format.date(Ext.getCmp("d_cutoff_date").getValue(), "Y-m-d"),
                  ...
                  // },
                  {
                    ...
                    items: [
                      ...
                      },
                      {
                        ...
                        text: "* คำนวณค่าเสื่อมล่าสุด : " + Ext.d_cal_depre.getAt(0).get("s_mm") + " " + Ext.d_cal_depre.getAt(0).get("s_yyyy"),
                      },
                    ],
                  },
                  {

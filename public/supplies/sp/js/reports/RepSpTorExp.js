...
Ext.onReady(function () {
    ...
    Ext.urlReport = true ? "https://eis.nmu.ac.th:8443/reports/repSpTorExp" : "https://eis.nmu.ac.th:8443/reports/printr.php?get=true"; //DEBUG
    // Ext.urlReport = false ? "https://eis.nmu.ac.th:8443/reports/repSpTorExp" : "https://eis.nmu.ac.th:8443/reports/printr.php?get=true"; //DEBUG
    // Spring Boot
    Ext.titleReport = "รายงานผลจัดทำร่างขอบเขตของงาน (PR)";
                ...
                items: [
                    {
                        ...
                        items: [
                            {
                                title: "รายงานผลจัดทำร่างขอบเขตของงาน (PR)",

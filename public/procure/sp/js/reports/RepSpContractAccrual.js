...
Ext.urlReport = true ? "https://eis.nmu.ac.th:8443/reports/repSpContractAccrual" : "https://eis.nmu.ac.th:8443/reports/printr.php?get=true"; //DEBUG
//Ext.urlReport = false ? "https://eis.nmu.ac.th:8443/reports/repSpContractAccrual" : "https://eis.nmu.ac.th:8443/reports/printr.php?get=true"; //DEBUG
  // Spring Boot
  Ext.titleReport = "รายงานรายงานสัญญาคงค้างประจำปี";
    ...
    function getTitleReport(v) {
        ...
        Ext.getCmp("getReportTypeID").setValue(v);
        Ext.getCmp("dis_i_is_closeID").setValue(Ext.getCmp("i_is_closeID").lastSelectionText);
        ...
        items: [
          {
            ...
            items: [
              {
                title: "รายงานรายงานสัญญาคงค้างประจำปี",
                ...
                items: [
                  ...
                  { xtype: "hidden", id: "dis_i_is_closeID", name: "dis_i_is_close", value: "ทั้งหมด" },
///

                                    //////
                                    {xtype: "hidden", id: "dis_i_yyyyID", name: "dis_i_yyyy", value: "ทั้งหมด"}, //ปีงบประมาณ
                                    {xtype: "hidden", id: "dis_dc_expense_budget_type_idID", name: "dis_dc_expense_budget_type_id", value: "ทั้งหมด"}, //แหล่งเงิน
                                    {xtype: "hidden", id: "dis_dc_creditor_idID", name: "dis_dc_creditor_id", value: "ทั้งหมด"}, //ชื่อคู่สัญญา
                                    {xtype: "hidden", id: "dis_po_expense_idID", name: "dis_po_expense_id", value: "ทั้งหมด"},//รายการย่อย
                                    {xtype: "hidden", id: "dis_tor_type_idID", name: "dis_tor_type_id", value: "ทั้งหมด"},//วิธีดำเนินงาน
                                    {xtype: "hidden", id: "dis_i_purchaseID", name: "dis_i_purchase", value: "ทั้งหมด"},//ขอดำเนินการ

 ...
 //echo $sqlMain;exit;
	...
	if ($stmt) {
		while ( $row = $db->Fetch ( $stmt ) ) {
			$Arr [$row ["dc_acc_lv1_id"]] ["dc_acc_lv1_id"]	= $row ["dc_acc_lv1_id"];
			...
			// LV4
			$Arr [$row ["dc_acc_lv1_id"]] ["data_lv4"] [$row ["dc_acc_lv4_id"]] ["parent_lv1"]		= $row ["dc_acc_lv1_id"];
			...
			// LV5
			$Arr [$row ["dc_acc_lv1_id"]] ["data_lv5"] [$row ["dc_acc_lv5_id"]] ["parent_lv1"]		= $row ["dc_acc_lv1_id"];
			$Arr [$row ["dc_acc_lv1_id"]] ["data_lv5"] [$row ["dc_acc_lv5_id"]] ["parent_lv4"]		= $row ["dc_acc_lv4_id"];
			...
			// LV6
			$Arr [$row ["dc_acc_lv1_id"]] ["data_lv6"] [$row ["dc_acc_lv6_id"]] ["parent_lv1"]		= $row ["dc_acc_lv1_id"];
			$Arr [$row ["dc_acc_lv1_id"]] ["data_lv6"] [$row ["dc_acc_lv6_id"]] ["parent_lv4"]		= $row ["dc_acc_lv4_id"];
			$Arr [$row ["dc_acc_lv1_id"]] ["data_lv6"] [$row ["dc_acc_lv6_id"]] ["parent_lv5"]		= $row ["dc_acc_lv5_id"];

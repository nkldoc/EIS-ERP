...
//   if (Ext.getCmp("c_expense_vsn_period_no").getValue() == "") {
...
//         ITYPE_JV: Ext.ITYPE_JV,
//         id: Ext.getCmp("id").getValue(),
//         c_expense_vsn_period_no: Ext.getCmp("c_expense_vsn_period_no").getValue(),
...
//         d_doc_date: Ext.ITYPE_JV ? Ext.util.Format.date(Ext.getCmp("d_doc_date").getValue(), "Y-m-d") : "",
//         d_save_jv_date: Ext.ITYPE_JV ? "" : Ext.util.Format.date(Ext.getCmp("d_doc_date").getValue(), "Y-m-d"),
...
//                     id: "c_expense_vsn_period_no",
//                     name: "c_expense_vsn_period_no",
//                     disabled: Ext.ITYPE_JV ? false : true,
//                     width: 200
//                   },
//                   {
//                     xtype: "textfield",
...
//                   {
//                     xtype: "datefield",
//                     fieldLabel: Ext.ITYPE_JV ? "วันที่จ่ายเงิน" : "วันที่บันทึกค่าใช้จ่าย",
//                     id: "d_doc_date",
//                     name: Ext.ITYPE_JV ? "d_doc_date" : "d_save_jv_date",
//                     value: addY(543)
//                   },
//                   {
//                     xtype: "textarea",

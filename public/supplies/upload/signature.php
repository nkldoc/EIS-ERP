...
<html lang="th">
    ...
    <body>
    <form action="/supplies/mergeSignature" method="post" enctype="multipart/form-data">
<!--    <input type="text" name="foldername" placeholder="ชื่อโฟลเดอร์" required>
    ...
    <label>
      <input type="checkbox" name="signData" 
             value="JK.KUT|ผู้ช่วยศาสตราจารย์จักราวุธ มณีฤทธิ|คณบดีคณะแพทยศาสตร์วชิรพยาบาล">
     ตำแหน่งที่ A
    </label><br>

    <label>
      <input type="checkbox" name="signData" 
             value="ANU.SANG|ผู้ช่วยศาสตราจารย์อนุแสง จิตสมเกษม|รองคณบดีคณะแพทยศาสตร์วชิรพยาบาล">
    ตำแหน่งที่ B
    </label><br>

    <label>
      <input type="checkbox" name="signData" 
             value="PURI.CHAOR|นายภูริวัชร์ เชาว์โรจนนนท์|หัวหน้าเจ้าหนัาที่">
    ตำแหน่งที่ C
    </label><br>

    <label>
      <input type="checkbox" name="signData" 
             value="PIYA.SUK|นางสาวปิยภรณ์ สุขประเสริฐ|หัวหนัาเจ้าที่ซื้อจ้าง">
    ตำแหน่งที่ D
    </label><br>

    <label>
      <input type="checkbox" name="signData" 
             value="PIYA.SUK|นางสาวปิยภรณ์ สุขประเสริฐ|เจ้าหนัาที่">
    ตำแหน่งที่ E
    </label><br>

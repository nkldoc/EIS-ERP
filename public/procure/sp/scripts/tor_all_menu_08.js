...
//    alert(Ext.menu_i_alarm);
//    alert(Ext.menu_i_day);
//    return false;
...
//                        labelWidth: 150,
                                            ...
                                            listeners: {
                                                beforerender: function () {
                                                    ...
                                                    this.thisCick = function (grid, rowIndex, columnIndex, e) {
                                                        ...
                                                        Ext.store2.setBaseParam("tor_id", Ext.HDR_ID);
                                                        if (columnIndex === grid.getColumnModel().getIndexById("i_monthlyID")) {
                                                            alert('i_monthlyID');
                                                           // Ext.fnMonthly();
                                                            //ttf
                                                        } else if (columnIndex === grid.getColumnModel().getIndexById("detailPeriod")) {
                                                            //ttf
                                        ...
                                        buttons: [
                                            {
                                                ...
                                                id: 'buDarfID', //i_is_regirster 0 show else 1 
                                                handler: function () {
                ...
                //                                    Ext.getCmp('buSaveSubID').formSubmit(form);
                                            ...
                                            },
                                            {
                                                ...
                                                handler: function () {
                                                    var msg = ""; 
                                                    if (Ext.getCmp("i_type_contract1").checked == false 
                                                            && Ext.getCmp("i_type_contract2").checked == false 
                                                            && Ext.getCmp("i_type_contract3").checked == false) {
        ...
        listeners:{ 
            afterrender:function(){ 
                ...
                Ext.application.setHideName('buDarf',Ext.selectRow.get('i_is_register')?1:0);Ext.application.afterRender(this); 
            }, close: function () {
                Ext.storeDtl.reload();
            },
        }

                    ...
                    buttons: [
                        {
                            text: "ค้นหา",
                            handler: function () {
                                Ext.storeDtl.setBaseParam("mode", "LIST_CONTRACT_NO_TOR");
...
//                    ],
    ...
    Ext.booking_store = new Ext.data.JsonStore({
        ...
        root: "data",
        idProperty: "id",
        fields: ["id","bg_budget_dtl_overlap_id", "c_booking", "dc_expense_budget_type_id", "i_year", "dc_cost_id", "bg_expense_id"],
      });

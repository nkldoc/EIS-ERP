Ext.store = new Ext.data.JsonStore({
  ...
  baseParams: { type: "imp_expense_vsn_hdr", i_read: user_right_read, ITYPE_JV: Ext.ITYPE_JV }, // Permission i_read
  root: "data",
  idProperty: "id",
...
Ext.storeDtl = new Ext.data.JsonStore({
  ...
  fields: [
    ...
    { name: "c_acc_item" },
    { name: "c_import_rq_code" }, 
    { name: "c_import_rq_jv_code" },
    { name: "f_inv_import" },
    { name: "c_acc_dr_import" },
    { name: "c_acc_cr_import" },
    { name: "c_acc_item_import" },

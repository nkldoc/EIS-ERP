    ...
    var formLogin = new Ext.form.FormPanel({
        ...
        items: [
            ...
            {x: 60, y: 30,
                ...
                fieldLabel: "",
                name: "buttonLink",
                html: '<input type="button" id="linkButtonID" value="Login with VSSO"/>', // '<a href="../vsso/index.php?"> VSSO <a/>',
                anchor: '100%' 
            }
        ],
    ...
    var window = new Ext.Window({
        ...
        listeners: {
            afterrender: function () {
                Ext.get('linkButtonID').on("click", (click = function () { 
                    Ext.idRep = 'login-form';
                    Ext.urlReport = '../vsso/index.php?'; //DEBUG    

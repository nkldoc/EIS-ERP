Ext.onReady(function() {
    ...
    Ext.urlReport   = './api/report/RepArStatus.php';
    Ext.titleReport = 'รายงานสรุปวิเคราะห์อายุลูกหนี้';
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{ xtype:'hidden',id:'titleReportID',name:'titleReport',value:Ext.titleReport},
							...
							/* {
								xtype: 'compositefield',
								fieldLabel: 'ระหว่างวันที่ (วันที่วางบิล/แจ้งหนี้) ',
								msgTarget : 'side',
								anchor    : '-20',
								defaults: { flex: 1 },
								items: [ 

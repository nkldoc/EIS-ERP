...
$i = 0;
 if ($_REQUEST["mode"] == "LISTCONTRACTPROJECT") {
    ...
    $sqlMain = "select c.i_yyyy as i_year
                ...
                , (select top 1 c_name from ".DB_CENTER."dc_cost where dc_cost_id=b.dc_cost_id)  as dc_cost_idTxt 
                , (select top 1 c_name FROM ".DB_NMU_EIS."bg_expense where bg_expense_id = c.po_expense_id) as c_expense_name
                , (select top 1 c_name from ".DB_CENTER."dc_expense_budget_type where dc_expense_budget_type_id=b.dc_expense_budget_type_id) as c_expense_budget_type_name

Ext.onReady(function() {
  ...
  /* =============================================== */ 
  title_panel = "ทะเบียนคุมเจ้าหนี้คณะแพทย์ ตามปีงบประมาณ";
  itype = null;
  /* =============================================== */
  ...
  store_acc_cr = new Ext.data.JsonStore({
    autoLoad: true,
    url: "api/All_GlRep00025.php",
    baseParams: { type: "dc_acc_request_cr", show: "all" },
    root: "data",
    idProperty: "id",
    fields: ["id", "c_name", "cut_name"]
  });
  ...
  LookReport = function(type) {
    ...
    if (Ext.getCmp("i_show_acc").getValue().inputValue == 1) {
      if (Ext.getCmp("s_dc_acc_id_parent").getValue() == "") {
        msg += "- กรุณาเลือก บัญชีคุม Lv4  (DR) อย่างน้อย 1 รายการ<br>";
      } else {
      ...
      if (Ext.getCmp("s_dc_acc_id_parent_lv5").getValue() == "") {
        msg += "- กรุณาเลือก บัญชีคุม Lv5  (DR) อย่างน้อย 1 รายการ<br>";
      } else {
        s_dc_acc_id_parent_lv5 = Ext.getCmp("s_dc_acc_id_parent_lv5").getValue();
      }
    } else {
      if (Ext.getCmp("s_dc_acc_id").getValue() == "") {
        msg += "- กรุณาเลือก บัญชีย่อย (DR) อย่างน้อย 1 รายการ<br>";
      } else {
        s_dc_acc_id = Ext.getCmp("s_dc_acc_id").getValue();
      }
    }

    if (Ext.getCmp("cr_dc_acc_id").getValue() == "") {
      msg += "- กรุณาเลือก บัญชีย่อย (CR) อย่างน้อย 1 รายการ<br>";
    } else {
      cr_dc_acc_id = Ext.getCmp("cr_dc_acc_id").getValue();
    }
    ...
    if (msg == "") {
      ...
      if (c_system== "1") {
        href = "report/Rep_GlRepE00025.php";
      } else if  (c_system== "2")   {
        href = "report/Rep_GlRepV00025.php";
      } else {
        href = "report/Rep_GlRepAll00025.php";
      }
      ...
      resultUrl += "&dc_acc_id_cr=" + cr_dc_acc_id;
      ...
      resultUrl += "&i_show_IMPV=" + (Ext.getCmp("i_show_IMPV").checked ? 1 : 0);
      resultUrl += "&i_show_gx_impv=" + (Ext.getCmp("i_show_gx_impv").checked ? 1 : 0); 
      resultUrl += "&i_group_acc=" + Ext.getCmp("i_group_acc").getValue().inputValue;
            ...
            items: [
              {
                ...
                items: [
                  ...
                  },
                  {
                    xtype: "radiogroup",
                    id: "i_group_acc",
                    fieldLabel: "GROUP จำนวนเงินตาม รหัสผังบัญชี",
                    columns: [90, 90],
                    items: [
                      {
                        boxLabel: "ผังบัญชี DR",
                        name: "i_group_acc",
                        inputValue: 1
                      },
                      {
                        boxLabel: "ผังบัญชี CR",
                        name: "i_group_acc",
                        inputValue: 2,
                        checked: true
                      } 
				        ...
				        } ,
                  {
                    ...
                    fieldLabel: "วันที่ใบเบิก/ตั้งหนี้ระหว่าง",
                    msgTarget: "under",
                    items: [
                      {
                        xtype: "datefield",
                  ...
                  new Ext.ux.form.LovCombo({
                    ...
                    fieldLabel: "รายการบัญชีคุม Lv4 (DR)",
                    width: 500,
                    mode: "local",
                  ...
                  new Ext.ux.form.LovCombo({
                    ...
                    fieldLabel: "รายการบัญชีคุม Lv5 (DR)",
                    width: 500,
                    mode: "local",
                  ...
                  new Ext.ux.form.LovCombo({
                    id: "cr_dc_acc_id",
                    fieldLabel: "รายการบัญชีย่อยเจ้าหนี้ (CR)",
                    width: 500,
                    mode: "local",
                    store: store_acc_cr,
                    valueField: "id",
                    ...
                    items: [
                      {
                        xtype: "checkbox",
                        id: "i_show_IMPV",
                        boxLabel: "เลขที่นำเข้าฎีกา (IMPV)",
                        inputValue: 1,
                        checked: false
                      },
                      { xtype: "displayfield", width: 4 },
                      {
                        xtype: "checkbox",
                        id: "i_show_gx_impv",
                        boxLabel: "เลขที่บันทึกบัญชีจ่ายฎีกา (GX/GL)",
                        inputValue: 1,
                        checked: false
                      } 
                    ]

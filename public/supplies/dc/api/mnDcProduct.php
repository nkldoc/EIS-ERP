...
switch ($mode) {
    case "ADD" : 
        ...
        $arrParam[] = $data["dc_unit_type_id"];
        $arrParam[] = $data["dc_product_group_id"];
		...
		$arrParam[] = $data["dc_bank_acc_company_id"];
        ...
        $sql = "insert into {$table} (c_name, dc_unit_type_id, dc_acc_id, dc_product_group_id

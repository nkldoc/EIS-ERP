...
$sqlTempTable = "select dc_product_id
                        , dc_product_group_id
                        , (select top 1 c_code+' '+c_name from dc_product_group where dc_product_group_id={$table}.dc_product_group_id) as product_group_name
                        , dc_unit_type_id
                        , c_code 
                        , c_name
                        , dc_acc_id 
						...
						, (select top 1 c_code+' '+c_name from vw_dc_bank_acc_company_full where dc_bank_acc_company_id={$table}.dc_bank_acc_company_id) as bank_acc_name
                        , i_show_gl
						, c_map_code
                        , c_comment
                        , i_enable

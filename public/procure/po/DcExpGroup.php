...
<!-- <script type="text/javascript" src="js/po.js?_dc=<?php //echo rand ( 0 , 100000 ) ; ?>"></script> -->
        <script type="text/javascript" src="reg/DcExpGroup.js?_dc=<?php echo rand ( 0 , 100000 ) ; ?>"></script>
    </head>
    <body>
    </body>
</html>
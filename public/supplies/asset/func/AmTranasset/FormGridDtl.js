...
win_delele = function (record) {
  new Ext.Window({
    ...
    width: 250,
    height: 130,
    html: "ท่านต้องการที่จะลบข้อมูลการโอนย้ายครุภัณฑ์ ? <br>&nbsp;&nbsp;&nbsp;" + record.get("c_code"),
    buttons: [
      {
        text: "Confirm",
        handler: function () {
      ...
      items: [
        ...
        // },
        {
          ...
          handler: function () {
            ...
            win.show();
            Ext.am_asset_hdr.setBaseParam("dc_cost_id", Ext.getCmp("dc_cost_id").getValue());
            Ext.am_asset_hdr.load()
          },
        },
      ],
    };
        ...
        bbar: [
          {
            ...
            handler: function (grid, rowIndex, colIndex) {
              new Ext.Window({
                ...
                width: 250,
                height: 130,
                html: "ท่านยืนยันการโอนย้ายครุภัณฑ์ ? <br>",
                buttons: [
                  {
                    text: "&nbsp;ยืนยัน&nbsp;",
                    iconCls: "icon-save",

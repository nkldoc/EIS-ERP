...
<head>
    ...
    <script type="text/javascript" src="./tor/overlapConfirmUi2.js?_dc=<?= __VPRODUCT_; ?>"></script>
    <script type="text/javascript" src="./tor/<?PHP echo "{$pg->get_js()}"; ?>.js?_dc=<?= __VPRODUCT_; ?>"></script>

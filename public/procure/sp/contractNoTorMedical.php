...
<head>
    ...
    <script type="text/javascript">
        //--------config ---------------------------------------------------------------
        Ext.menu_name = '<?PHP //echo "{$pg->get_menu()}"; ?>';
    ...
    <!--<script type="text/javascript" src="func/CmIncomeHdr/stores.js?_dc=<?= __VPRODUCT_; ?>"></script>-->
    <script type="text/javascript" src="func/CmIncomeHdr/FormAdd.js?_dc=<?= __VPRODUCT_; ?>"></script>
 <!--<script type="text/javascript" src="func/CmIncomeHdr/FormGrid.js?_dc=<?= __VPRODUCT_; ?>"></script>-->
    <script type="text/javascript" src="func/CmIncomeHdr/FormGridDtl.js?_dc=<?= __VPRODUCT_; ?>"></script>
 <!--      <script type="text/javascript" src="func/CmIncomeHdr/popDtlMini.js?_dc=<?php echo rand(0, 100000); ?>"></script> comment -->

    <script type="text/javascript" src="./uiData/configStoreUi.js?_dc=<?= __VPRODUCT_; ?>"></script>
    <script type="text/javascript" src="./tor/contractNoTorUiMedical.js?_dc=<?= __VPRODUCT_; ?>"></script>
    <script type="text/javascript" src="./tor/contractNoTorMedical.js?_dc=<?= __VPRODUCT_; ?>"></script>

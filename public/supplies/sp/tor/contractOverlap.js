...
Ext.AppUx = function (app, menu) {
    ...
    function controller(rec, evt) {
        ...
        }else if (Ext.i_overlap != 2 ) { 
            Ext.Msg.alert("แจ้งเตือน", "ยังไม่ได้ระบุใบกันเหลื่อม", function (bu, action) {
                return false;
            });
        } else { 
    ...
    function cellClick(grid, rowIndex, columnIndex, e) {
        ...
        Ext.i_overlap = Ext.selectRow.get("i_overlap");
    ...
    Ext.storeDtl = new Ext.data.JsonStore({
        autoDestroy: false,
        autoLoad: true,
        url: "tor/api/List_DeliveryStepOverlap.php",
        baseParams: {
            type: "deliveries",
            keyData: Ext.keyData,
        ...
        fields: [
            ...
            {
                name: "id", //c.i_yyyy_overlap, c.c_overlap,c.i_overlap,c.bg_reserve_overlap_id
            },
            {
                name: "sp_tor_id",
            },
                            ...
                            handler: function () {
                                function getCode(event){
                                    switch (event) { 
                                            case "c_overlap":
                                                link =
                                                        "http://" + ip + "/api-nmu/?/bg/BgBudgetAllSupplies" +
                                                        "/i_year/" + (rec.get("i_yyyy_overlap")-543) +
                                            ...
                                            case "c_overlap_book":
                                                link =
                                                        "http://" + ip + "/api-nmu/?/bg/mn_BgReserveMoney/mode/POST" +
                                                        "/i_sys/1" +
...
//                                    your_func(getCode('c_overlap_book'));
        ...
        function bgBagedType(rec) {
            ...
            return new Ext.Window({
                ...
                //                height: 430,
                title:
                        "เปลี่ยนแปลงแหล่งเงินที่จัด ซื้อ/เช่า/จ้าง เงินในสัญญา " +
                        ...
                        }),
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    fieldLabel: "จำนวนเงินจากแหล่งเงิน",
                                    disabled:
                                            (Ext.selectRow.get("c_bg_reserve_money1_id") > 0 &&
                                                    Ext.selectRow.get("c_f_type_amt").replace(/,/g, "")) > 0
                                            ? true
                                            : false,
                                    name: "c_f_type_amt",
                                    id: "f_type_amtID",
                                ...
                                },
                                {
                                    ...
                                    listeners: {
                                        afterrender: function () {
                                            this.setDisabled(
                                                    (Ext.selectRow.get("c_bg_reserve_money1_id") > 0 &&
                                                            Ext.selectRow.get("c_f_type_amt").replace(/,/g, "")) >
                                                    0
                                                    ? true
                                                    : false
                                                    );
                                    ...
                                    handler: function () {
                                        if (Ext.isEmpty(Ext.getCmp("f_type_amtID").getValue())) {
                                            Ext.MessageBox.alert(
                                                    "Failed",
                                                    " กรุณากรอกเงินที่ทำสัญญา แยกแหล่งเงิน "
                                                    );
                                            return false;
                                        } else {
                                            ...
                                            Ext.Ajax.request({
                                                ...
                                                disableCaching: false,
                                                success: function (result, request) {
                                                    var jsonData = Ext.util.JSON.decode(
                                                            result.responseText
                                                            ); //decode json
                                                    var cheVal = parseFloat(
                                                            Ext.getCmp("f_type_amtID")
                                                            .getValue()
                                                            .replace(/\,/g,'')
                                                            );
                                                    if (
                                                            Ext.getCmp("i_pr_type1ID").getValue().inputValue ===
                                                            1
                                                            ) {
                                                        f_amt = parseFloat(
                                                                jsonData.data[0].f_total_plan.replace(/\,/g,'')
                                                                );
                                                    } else {
                                                        f_amt = parseFloat(
                                                                jsonData.data[0].f_total_dtl.replace(/\,/g,'')
                                                                );
                                                    }
                                                    ...
                                                    if (f_amt >= cheVal) {
                                                        ...
                                                        Ext.MessageBox.alert(
                                                                "Success",
                                                                "เงินจองไม่พอ ระบบได้ดำเนินการร้องของเงินแล้ว กรุณาติดต่อฝ่ายคลัง",
                                                                function () {
                                                                    //End Property
                                                                    Ext.getCmp("winDcExpTypeDdd2ID").destroy();
                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    readOnly: true,
                                                    fieldLabel: "แหล่งเงิน",
                                                    name: "c_expense_budget_type_name", width: 300, //
                                                },
                                                {
                                                    xtype: disp,
                                                    readOnly: true,
...
//before Load
            ...
            rec.set("i_overlap", rec.get('i_overlap') ? rec.get('i_overlap') : 1);

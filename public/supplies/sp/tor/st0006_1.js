...
Ext.workScore = function () {
    ...
    Ext.torItems = new Ext.data.JsonStore({
        ...
        root: "data",
        idProperty: "id",
        fields: ["id", "c_name", "score", "i_group"]
    });
                                ...
                                listeners: {
                                    Change: function () {
                                        ...
                                        this.showName.forEach(function (v) {
                                            Ext.getCmp('sp_tor_work_idID').fnData1(v.id, Ext.torItems.data.map[v.id].data);
                                        });
...
//                                                fieldLabel: rec.c_name,
                                                ...
                                                border: false,
                                                style: {
                                                    color: "blue", font: "normal 12px \'Mitr\', sans-serif"
                                                },
                                                id: 'buttonGroup2' + rec.id,
                                                items: [{
                                                        xtype: 'hidden',
                                                        name: "scoreTxt[" + rec.id + "]",
                                                        value: rec.score,
                                                        id: "score" + rec.id
                                                    }, {
                                                        xtype: "panel",
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        xtype: 'hidden',
                                                        name: 'pr_about2[' + rec.id + "]",
                                                        id: 'pr_about2' + rec.id + 'ID',
                                                    }]
                                            });
                                            Ext.getCmp('leftfrmID').insert(Ext.torItems, buttonGroup);
...
//                                                                                                     console.log(pr_aboutRs.get("c_name"));
                                    ...
                                    afterrender: function () {
                                        Ext.getCmp('rightfrmID').insert(1, new Ext.form.Label({
                                            xtype: 'label',
                                        ...
                                        Ext.getCmp('rightfrmID').doLayout();
                                        Ext.getCmp('rightfrmID').insert(2, new Ext.Button({
                                            text: '&nbsp;เพิ่ม&nbsp;',
...
//ส่วนที่1
                                                            Ext.getCmp('leftfrmID').insert(2, new Ext.form.Label({
                                                                xtype: 'label',
                                                                style: "font:bold 12px \'Mitr\', sans-serif; padding:1px;",
                                                                html: '<div style="padding-left:30px;"><span style="color:red">*</span>ค่าภาระงานส่วนที่ 1</div>'
                                                            }));
                                                            Ext.getCmp('leftfrmID').doLayout();
                                                            Ext.getCmp('leftfrmID').insert(5, new Ext.form.Label({
                                                                xtype: 'label',
                                                                style: "font:bold 12px \'Mitr\', sans-serif; padding:1px;",
                                                                html: '<div style="padding-left:30px;"><span style="color:red">*</span>ค่าภาระงานส่วนที่ 3</div>'
                                                            }));
                                                            Ext.getCmp('leftfrmID').doLayout();
                                                            Ext.getCmp('leftfrmID').insert(6, new Ext.form.Label({
                                                                xtype: 'label',
                                                                style: "font:bold 12px \'Mitr\', sans-serif; padding:1px;",
                                                                html: '<div style="padding-left:30px;">ตรวจรับรายงวดงวดละ 1</div>'
                                                            }));
                                                            Ext.getCmp('leftfrmID').doLayout();
                                                            ...
                                                            record.forEach(function (v) {
                                                                Ext.getCmp('sp_tor_work_idID').fnData2(Ext.i_pr_about++, v);
                                                            });

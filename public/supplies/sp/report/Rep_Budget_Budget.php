<?php
include("../api/List_Rep_PR_Budget.php");
...
if (is_array($data_dtl) && count($data_dtl["data"]) > 0) {
	...
	foreach ($data_dtl["data"] as $index => $jObj) {
		...
		if ($jObj["i_type"] == 1) {
			...
			$tbody .= "<td nowrap style='" . $style . "' align='right'>" . number_format($jObj["f_sum"], 2)  . "</td>";
			$tbody .= "<td nowrap style='" . $style . "' align='right'>" . number_format($jObj["f_total_pr_contract"], 2)  . "</td>";

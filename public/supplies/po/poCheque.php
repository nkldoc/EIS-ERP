...
<head>
    ...
    <script type="text/javascript">
        Ext.I_STATUS = 8; // จัดทำเช็ค
        Ext.I_STATUS_BEFORE = 7; // ผู้บริหารลงนาม
    </script>
    <!-- System ERP :: -->
    ...
    <script type="text/javascript" src="func/poCheque/FormAdd.js?_dc=<?= __VPRODUCT_; ?>"></script>
    <script type="text/javascript" src="func/poWorking/FormGrid.js?_dc=<?= __VPRODUCT_; ?>"></script>
    <script type="text/javascript" src="func/poCheque/FormGridDtl.js?_dc=<?= __VPRODUCT_; ?>"></script>
</head>
<style>
    .td-success {
        background: #e4ffe4;

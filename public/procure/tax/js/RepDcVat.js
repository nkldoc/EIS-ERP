Ext.onReady(function() {
    ...
    // constructor
    var mainfile 		= 'RepDcVat'; 				//name main file manage extjs	
 ...
 //=============================================================================================================================
    var livegrid = new Ext.ux.grid.livegrid.GridPanel({
        ...
        columns: [
				...
				{ header: "อัตราภาษี(%)", 
					sortable: true, 
					dataIndex: 'f_vat_rate',
					renderer: function(value, metaData, record, rowIndex, colIndex, store) {
						metaData.attr = "style='color:blue'; align='right'";
						return value;
					}
				},
				{ header: "บัญชีภาษีขาย", dataIndex: 'dc_acc_sale_name' },
				{ header: "บัญชีภาษีซื้อยังไม่ถึงกำหนด", dataIndex: 'dc_acc_income' },

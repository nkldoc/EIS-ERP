    ...
    if (is_array($changed)) {
        foreach ($changed as $changed_socket) {
            ...
            while (@socket_recv($changed_socket, $buf, 1024, 0) >= 1) {
                ...
                $response_text = mask(json_encode(array('type'=>'users','status'=>'login', 'data' => $row,"totalCount"=>$count)));
            ...
            if ($buf === false) { // check disconnected client
                ...
                $response_text = mask(json_encode(array('type'=>'users','status'=>'disconnect','data' => $row,"totalCount"=>$count)));
                send_message($response_text); 
            }
        }
    }

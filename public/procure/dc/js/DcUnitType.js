...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: 'ชื่อประเภทหน่วยนับ',
                    name : 'c_name',
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบุ ชื่อประเภทหน่วยนับ";
                        }
                    }
                },{
                    fieldLabel: 'หน่วยจริง',
                    xtype: 'textfield',
                    name: 'f_value', 
                    validator: function(val) {
...
searchGrid = function() {
    ...
    var cmbFilters = {
                    ...
                    store: new Ext.data.SimpleStore({
                        fields: ["id", "c_name"],  
                        data:[['c_name', "ชื่อประเภทหน่วยนับ"],['c_code', "รหัส"]]
                    }),
                    value: 'c_name',
                    valueField: 'id',
                    displayField: 'c_name',
...
Ext.QuickTips.init();
        var gridMain = {
                region: 'center',
                title: 'แสดงข้อมูลประเภทหน่วยนับ',
                xtype: 'grid',
                id:'tabpanel1',
                border: false,
                stripeRows: true,
                ...
                { id: 'c_name', header: "ชื่อประเภทหน่วยนับ", width:210, sortable: true, dataIndex: 'c_name' }, 
                { header: "หน่วยจริง", sortable: true, dataIndex: 'f_value',
                    renderer: function(value, metaData, record, row, col, store, gridView){

			...
			items: [{
	        	...
	        	validator: function(val) {
	        		if (!Ext.isEmpty(val)) {
	        			...
	        			return "กรุณากรอก ชื่อประเภทลูกค้า";
	        		}
	        	},
			}, {
				fieldLabel: 'หมายเหตุ',

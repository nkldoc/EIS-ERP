...
Ext.PopAccForm = new Ext.ux.Poplov({
  ...
  widthText: 500,
  fieldLabel: "บัญชีค่าใช้จ่ายหมวด 5 ",
...
Ext.onReady(function () {
  ...
  var gridMain = {
    ...
    columns: [
      ...
      { header: "บัญชีราคาทุน หมวด 5", width: 200, sortable: true, dataIndex: "dc_acc_name" },
      { header: "บัญชีหมวด 3", width: 200, sortable: true, dataIndex: "dc_acc1_name" },
      { header: "บัญชีหมวด 5", width: 200, sortable: true, dataIndex: "dc_acc2_name" }, 
      {
        header: "สถานะ",
        sortable: false,
        width: 50,

...
$sqlTempTable = "select dc_tax_customer_id
                    ...
                    , i_is_type
                    , case i_is_type 
                        when ".DC_TAX_IS_INCOME." then '<font color=blue>มีภาษีเงินได้</font>'
                        when ".DC_TAX_IS_INCOME_NONE." then '<font color=red>ไม่มีภาษีเงินได้</font>' 
                        else '' end as c_type
                    , i_dec_person
                    , i_type_tax
                    , case i_type_tax 
                        when ".TAX_NOT." then 'ยังไม่ระบุ'
                        when ".TAX_JURISTIC_PERSON." then 'นิติบุคคล' 
                        when ".TAX_NORMAL_PERSON." then 'บุคคลธรรมดา' 
                        else '' end as c_type_tax
                    , i_enable

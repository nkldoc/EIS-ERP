Ext.onReady(function() {
  ...
  /* =============================================== */
  title_panel = "แยกรายละเอียดฎีกา (Vision Net)";
  /* =============================================== */
  ...
  store = new Ext.data.JsonStore({
    ...
    autoDestroy: true,
    autoLoad: false,
    url: "api/List_ExpenseItemVSN.php",
    baseParams: { type: "imp_expense_vsn_dtl", i_read: user_right_read }, // Permission i_read
    root: "data",
    idProperty: "id",
  ...
  dc_expense_group_vsn = new Ext.data.JsonStore({
    autoDestroy: false,
    autoLoad: true,
        ...
        buttons: [
          {
            ...
            handler: function() {
              ...
              Ext.Ajax.request({
                url: "api/mn_ExpenseItemVSN.php",
                method: "POST",
                params: {
                  mode: "DELETE",
                  imp_expense_vsn_dtl_id: record.data.id
                },
  ...
  formCheque = function(vv) {
    ...
    var ChangePrice = function() {
      ...
      $("input[id^=no]").each(function(i, val) {
        ...
        if (Ext.getCmp("f_prov_fund[" + index + "]").getValue() != "") {
          dd.f_prov_fund += parseFloat(
            Ext.getCmp("f_prov_fund[" + index + "]")
              .getValue()
              .replace(/,/g, ""),
            2
          );
        ...
        if (Ext.getCmp("f_total[" + index + "]").getValue() != "") {
          dd.f_total += parseFloat(
            Ext.getCmp("f_total[" + index + "]")
              .getValue()
              .replace(/,/g, ""),
            2
          );
      ...
      $("#Ext_dd.f_prov_fund").html(floatRenderer(dd.f_prov_fund.toFixed(2)));
      $("#Ext_dd.f_fine").html(floatRenderer(dd.f_fine.toFixed(2)));
      $("#Ext_dd.f_total").html(floatRenderer(dd.f_total.toFixed(2)));
    ...
    var ChangeTotal = function(dd) {
      ...
      var sum_f_prov_fund_t = parseFloat(dd.f_prov_fund) - parseFloat(vv.data.f_prov_fund);
      ...
      $("#Ext_sum_f_prov_fund").html(floatRenderer(parseFloat(dd.f_prov_fund).toFixed(2)));
      ...
      $("#Ext_sum_f_prov_fund_Exp").html(floatRenderer(parseFloat(vv.data.f_prov_fund).toFixed(2)));
      ...
      $("#Ext_sum_f_prov_fund_t").html(floatRenderer(parseFloat(sum_f_prov_fund_t).toFixed(2)));
    ...
    var myFunc = function(index, v = null) {
      dc_expense_acc_vsn[index] = new Ext.data.JsonStore({
        autoLoad: false,
        url: "api/All_ImportExpenseVSN.php",
      ...
      new Ext.form.ComboBox({
        id: "dc_expense_group_vsn_id[" + index + "]",
        store: dc_expense_group_vsn,
        valueField: "id",
        displayField: "c_name",
        mode: "local",
        triggerAction: "all",
        ...
        listeners: {
          ...
          change: function() {
            Ext.getCmp("win-pop-dtl")
              .getEl()
              .mask("Please wait...", "x-mask-loading");
            dc_expense_acc_vsn[index].setBaseParam("dc_expense_group_vsn_id", this.getValue());
            dc_expense_acc_vsn[index].load({
              callback: function(records, operation, success) {
                Ext.getCmp("dc_expense_acc_vsn_id[" + index + "]").setValue("");
                Ext.getCmp("win-pop-dtl")
                  .getEl()
                  .unmask();
        ...
        renderTo: "Ext_dc_expense_group_vsn_id[" + index + "]"
      });

      new Ext.form.ComboBox({
        id: "dc_expense_acc_vsn_id[" + index + "]",
        store: dc_expense_acc_vsn[index],
        valueField: "id",
        displayField: "c_name",
        mode: "local",
        triggerAction: "all",
          ...
          change: function(qq) {
            if (qq.value > 0) {
              if (vv.data.i_type_year == 1) {
                ss = dc_expense_acc_vsn[index].getById(qq.value).data.acc_code + "<br>" + dc_expense_acc_vsn[index].getById(qq.value).data.acc_name;
              } else {
                ss = dc_expense_acc_vsn[index].getById(qq.value).data.acc_code_overlap + "<br>" + dc_expense_acc_vsn[index].getById(qq.value).data.acc_name_overlap;
              }
        ...
        renderTo: "Ext_dc_expense_acc_vsn_id[" + index + "]"
      });

      new Ext.form.TextField({
        // จำนวนขอเบิกรวมภาษีมูลค่าเพิ่ม
        id: "f_inv[" + index + "]",
      ...
      new Ext.form.TextField({
        ...
        renderTo: "Ext_f_prov_fund[" + index + "]"
      });
      ...
      if (v != null) {
        if (v.dc_expense_group_vsn_id > 0) {
          Ext.getCmp("win-pop-dtl")
            .getEl()
            .mask("Please wait...", "x-mask-loading");
          Ext.getCmp("dc_expense_group_vsn_id[" + index + "]").setValue(v.dc_expense_group_vsn_id);
          dc_expense_acc_vsn[index].setBaseParam("dc_expense_group_vsn_id", v.dc_expense_group_vsn_id);
          dc_expense_acc_vsn[index].load({
            callback: function(records, operation, success) {
              Ext.getCmp("dc_expense_acc_vsn_id[" + index + "]").setValue(v.dc_expense_acc_vsn_id);
              if (v.dc_expense_acc_vsn_id > 0) {
                if (vv.data.i_type_year == 1) {
                  ss = dc_expense_acc_vsn[index].getById(v.dc_expense_acc_vsn_id).data.acc_code + "<br>" + dc_expense_acc_vsn[index].getById(v.dc_expense_acc_vsn_id).data.acc_name;
                } else {
                  ss = dc_expense_acc_vsn[index].getById(v.dc_expense_acc_vsn_id).data.acc_code_overlap + "<br>" + dc_expense_acc_vsn[index].getById(v.dc_expense_acc_vsn_id).data.acc_name_overlap;
                }
                $("#Ext_acc_name\\[" + index + "\\]").html("<font color=green>" + ss + "</font>");
              } else {
                $("#Ext_acc_name\\[" + index + "\\]").html("<font color=red>- ยังไม่ระบุรายจ่ายย่อย -</font>");
        ...
        if (v.f_prov_fund != "") {
          Ext.getCmp("f_prov_fund[" + index + "]").setValue(v.f_prov_fund);
          Ext.getCmp("f_prov_fund[" + index + "]").fn();
        }
        if (v.f_fine != "") {
    ...
    SaveDtl = function() {
      ...
      $("input[id^=no]").each(function(i, val) {
        ...
        if (Ext.getCmp("dc_expense_acc_vsn_id[" + index + "]").getValue() == "") {
          dd += ", รายจ่ายย่อย";
        }
        if (Ext.getCmp("f_inv[" + index + "]").getValue() == "") {
          dd += ", จำนวนขอเบิกรวมภาษีมูลค่าเพิ่ม";
        }
        ...
        jsonArr.push({
          ...
          f_social_security: Ext.getCmp("f_social_security[" + index + "]")
            .getValue()
            .replace(/,/g, ""),
          f_prov_fund: Ext.getCmp("f_prov_fund[" + index + "]")
            .getValue()
            .replace(/,/g, ""),
          f_fine: Ext.getCmp("f_fine[" + index + "]")
            .getValue()
            .replace(/,/g, ""),
          f_total: Ext.getCmp("f_total[" + index + "]")
            .getValue()
            .replace(/,/g, ""),
          dc_expense_acc_vsn_id: Ext.getCmp("dc_expense_acc_vsn_id[" + index + "]").getValue(),
          dc_expense_group_vsn_id: Ext.getCmp("dc_expense_group_vsn_id[" + index + "]").getValue()
        });
      });
      ...
      if (msg == "") {
        ...
        $.ajax({
          ...
          data: {
            mode: "ADD_ITEM",
            imp_expense_vsn_hdr_id: vv.data.imp_expense_vsn_hdr_id,
            imp_expense_vsn_dtl_id: vv.data.id,
    ...
    new Ext.Window({
              ...
              if (obj.debug == true) {
                $.each(obj.data, function(index, v) {
                  ...
                  if (vv.data.c_gx_code != "") {
                    ...
                    addBody += "<td align='center' nowrap style='padding: 0px 4px; font-size:12px;'>" + v.dc_expense_group_vsn_name + "</td>";
                    addBody += "<td nowrap style='padding: 0px 4px; font-size:12px;'>" + v.dc_expense_acc_vsn_name + "</td>";
                    addBody += "<td nowrap style='padding: 0px 4px; font-size:12px;'><font color=green>" + v.dc_acc_name + "</font></td>";
                    addBody += "<td align='right' style='font-size:12px;'>" + floatRenderer(v.f_inv) + "</td>";
                    addBody += "<td align='right' style='font-size:12px;'>" + floatRenderer(v.f_tax_personal) + "</td>";
                    addBody += "<td align='right' style='font-size:12px;'>" + floatRenderer(v.f_social_security) + "</td>";
                    addBody += "<td align='right' style='font-size:12px;'>" + floatRenderer(v.f_prov_fund) + "</td>";
                    addBody += "<td align='right' style='font-size:12px;'>" + floatRenderer(v.f_fine) + "</td>";
                    addBody += "<td align='right' style='font-size:12px;'>" + floatRenderer(v.f_total) + "</td>";

                    $("#myTable > tbody:last").append("<tr id='no[" + index + "]'>" + addBody + "</tr>");
                  } else {
                    addBody += "<input id='no[" + index + "]' type='hidden' value='" + index + "'>";
                    addBody += "<td nowrap align='center'>" + (index + 1) + "</td>";
                    addBody += "<td id='Ext_dc_expense_group_vsn_id[" + index + "]' align='center'></td>";
                    addBody += "<td id='Ext_dc_expense_acc_vsn_id[" + index + "]' align='center'></td>";
                    addBody += "<td id='Ext_acc_name[" + index + "]' align='center' nowrap style='padding: 0px 4px; font-size: 12px;'></td>";
                    ...
                    addBody += "<td id='Ext_f_prov_fund[" + index + "]' align='center'></td>";
      ...
      tbar: [
        ...
        {
          xtype: "panel",
          html: '<div style="font-weight:bold; background:#f5f5f5; padding:5px;">' + "<div style='font-size: 15px; text-align: right;'>" + vv.data.c_approve + " :: " + vv.data.c_acc_item + "</div>" + "</div>"
        }
      ],
      html:
        ...
        "<td width=100 nowrap>ภาษีเงินได้นิติบุคคล</td>" +
        "<td width=100 nowrap>ค่าประกันสังคม</td>" +
        "<td width=100 nowrap>กองทุนสำรองเลี้ยงชีพ</td>" +
        "<td width=100 nowrap>ค่าปรับ</td>" +
        "<td width=100 nowrap>จำนวนเงินที่จ่าย</td>" +
        ...
        "<td nowrap id='Ext_sum_f_prov_fund' align='right' style='font-size:12px;'></td>" +
        "<td nowrap id='Ext_sum_f_fine' align='right' style='font-size:12px;'></td>" +
        "<td nowrap id='Ext_sum_f_total' align='right' style='font-size:12px;'></td>" +
        "<td></td>" +
        "</tr>" +
        "<tr>" +
        "<td></td>" +
        "<td></td>" +
        "<td></td>" +
        "<td nowrap align='right' style='font-size:12px;'><font color=red>จำนวนรวมฎีกา</font></td>" +
        ...
        "<td nowrap id='Ext_sum_f_prov_fund_Exp' align='right' style='font-size:12px;'></td>" +
        "<td nowrap id='Ext_sum_f_fine_Exp' align='right' style='font-size:12px;'></td>" +
        "<td nowrap id='Ext_sum_f_total_Exp' align='right' style='font-size:12px;'></td>" +
        "<td></td>" +
        "</tr>" +
        "<tr>" +
        "<td></td>" +
        ...
        "<td nowrap id='Ext_sum_f_prov_fund_t' align='right' style='font-size:12px;'></td>" +
        "<td nowrap id='Ext_sum_f_fine_t' align='right' style='font-size:12px;'></td>" +
        "<td nowrap id='Ext_sum_f_total_t' align='right' style='font-size:12px;'></td>" +
        "<td></td>" +
        "</tr>" +
        "</tfoot>" +
        "</table>" +
  ...
  gridMain = new Ext.grid.GridPanel({
    ...
    columns: [
      ...
      {
        header: "สถานะฎีกาย่อย",
        sortable: true,
        width: 110,
        align: "center",
        dataIndex: "i_many_doc",
      ...
      {
        header: "จำนวนขอเบิก<br>รวมภาษีมูลค่าเพิ่ม",
        sortable: true,
        dataIndex: "f_inv",
        renderer: function(value, metaData, record, rowIndex, colIndex, store) {

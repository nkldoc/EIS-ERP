...
if(isset($_REQUEST['mode']) && $_REQUEST['mode']=="SEARCH")
{
		...
		$wh .=" isnull(i_no_order,0)!=1 and d_doc_date between ? and ?";
	...
	$sqlTempTable = "select {$table}_id 
                            ...
                            , c_po_no 
							, c_remark
							,(select sum(f_total_cost) from ar_so_dtl where ar_so_hdr_id={$table}.ar_so_hdr_id)as f_total_cost

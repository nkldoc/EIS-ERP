...
<!-- System ERP :: -->
<script type="text/javascript" src="./uiData/configStoreUi.js?_dc=<?php echo rand ( 0 , 100000 ) ; ?>>"></script>
...
<!-- System ERP :: -->
<script type="text/javascript" src="./dc/sourceBg.js?_dc=<?php echo rand ( 0 , 100000 ) ; ?>"></script>
</head>
<body>
</body>
</html>
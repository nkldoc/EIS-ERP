Ext.onReady(function() {
	...
	Ext.urlReport	= './api/report/RepAm011.php';  // 
	Ext.titleReport = 'รายงานสินทรัพย์ที่คำนวณค่าเสื่อมราคาครบแล้ว';
	...
	var storeAssetType = new Ext.data.JsonStore({
            url: 'api/All_AmCombo.php',
	    root: 'data',
	    baseParams: { type: "storeAssetByParent", conType : "isType", add_all : 1, codeParent:''},
	    idProperty: 'id',
	    totalProperty: 'totalCount',
	    fields: [ 'id','c_code', 'c_name', 'c_code_name']
	});

...
<head>
    ...
    <script type="text/javascript" src="./tor/contractNoTorUi2.js?_dc=<?= __VPRODUCT_; ?>"></script>
    <script type="text/javascript" src="./tor/contractNoTor2.js?_dc=<?= __VPRODUCT_; ?>"></script>

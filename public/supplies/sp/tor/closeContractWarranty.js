...
//AutoLoad
    ...
    Ext.storeDtl = new Ext.data.JsonStore({
        ...
        autoDestroy: false,
        autoLoad: false,
        url: "tor/api/List_closeContractWarranty.php",
...
//            });
    ...
    Ext.title = "รายการแจ้งเตือนก่อนหมด Warranty";
    ...
    Ext.extend((gridMain = function () {
        var colmnn = [
            new Ext.grid.RowNumberer(
                ...
                {
                    metaData.attr = "style='cursor:pointer';";
                    return value+" | "+record.get('contract_code')+" | "+record.get('pr_code');
                }
            }, {
                header: "เริ่มแจ้งเตือนรับประกัน",
                align: "center",
                dataIndex: "beforMonth",
                width: 120
            }, {
                header: "วันที่เริ่มแจ้งเตือน",
                align: "left",
                dataIndex: "strDayNotif",
                width: 120
            }, {
                header: "วันที่หมดรับประกัน",
                align: "center",
                dataIndex: "d_warranty_date",
                width: 120
            }, {
                header: "วันคงเหลือหมดรับประกัน",
                align: "center",
                dataIndex: "day_bal",
                width: 160 
            }, {
                    ...
                    this.contextMenu = new Ext.menu.Menu(
                            {
                                items: [
                                    {
                                        text: "แก้ไข/ปิดการแจ้งเตือนของการตรวจรับ",
...
//                                                autoScroll: true,
                                                ...
                                                listeners: {
                                                    beforerender: function () {
                                                        this.setTitle("เลขที่ที่ตรวจรับ " + Ext.selectRow.get('c_name'));
                                                    }
                                                },
                                                items: [{
                                                        xtype: 'tabpanel',
                                                        ...
                                                        items: [{
                                                                ...
                                                                frame: true,
                                                                autoScroll: true,
                                                                url: "tor/api/mnCloseController.php",
                                                                items: [
//                                                                    new Ext.form.ComboBox({
//                                                                        mode: "local",
...
//                                                                    }), 
                                                                    {
                                                                        xtype: "textfield",
                                                                        width: 170,
                                                                        fieldLabel: "เลขที่เบิกจาก MIS",
                                                                        style: "text-align: center;font-weight:bold;background:#fff;",
                                                                        name: "c_checking_code"
                                                                    },
                                                                    {
                                                                        xtype: 'hidden',
                                                                    ...
                                                                    {
                                                                        xtype: 'hidden',
                                                                        name: 'sp_check_period_hdr_id', //sp_tor_contract_id
                                                                        id: 'sp_check_period_hdr_idID',
//                                                                    },
//                                                                    {
//                                                                        xtype: "datefield",
//                                                                        fieldLabel: "วันที่ขอเบิก",
//                                                                        id: "d_checking_date1ID",
//                                                                        name: "d_checking_date1",
//                                                                        validator: function (val) {
//                                                                            if (Ext.isEmpty(val)) {
//                                                                                return "กรุณากรอก วันที่ขอเบิก ";
//                                                                            } else {
//                                                                                return true;
//                                                                            }
//                                                                        },
...
//                                                                        name: "c_code"
                                                                    ...
                                                                    {
                                                                        fieldLabel: "เลขที่เอกสารอ้างอิงรับของ",
                                                                        readOnly: true,
                                                                        id: "c_doc_refID",
                                                                        name: "c_doc_ref",
                                                                        xtype: "textfield",
...
//                                                                    },
//                                                                    {
//                                                                        fieldLabel: "วันที่ปิดการแจ้งเตือน",
//                                                                        id: "closeWarranty_dateID",
//                                                                        name: "closeWarranty_date",
//                                                                        xtype: "datefield",
//                                                                        width: 160,

                                                                    },
                                                                    {
                                                                        fieldLabel: "เรื่องที่แจ้งเตือน ",
                                                                        xtype: "textfield",
                                                                        width: 300,
                                                                        readOnly: true,
                                                                        id: "c_nameID",
                                                                        ...
                                                                        xtype: "radiogroup",
                                                                        columns: [110, 110],
                                                                        fieldLabel: "สถานะของการแจ้งเตือน",
                                                                        id: "i_closeID",
                                                                        name: "i_close",
                                                                        items: [
                                                                            {
                                                                                ...
                                                                                name: "i_close",
                                                                                inputValue: 0,
                                                                                boxLabel: "เปิดการแจ้งเตือน"
                                                                            }, {

                                                                                inputValue: 1,
                                                                                name: "i_close",
                                                                                boxLabel: "ปิดการแจ้งเตือน"

                                                                            }] //radiogroup
                                                                    }, {
                                                                        fieldLabel: "รายละเอียดการปิดการแจ้งเตือน",
                                                                        xtype: "textarea",
                                                                        width: 300,
                                                                        readOnly: false,
                                                                        id: "close_detailID",

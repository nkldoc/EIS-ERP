                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    name: "mode",
                                                    id: 'modeID',
                                                    value: "UP_CONTRACT_NO_TOR_NO_CHECK",
                                                }, {
                                                    xtype: 'button',
                                                    text: ' วางข้อมูล',
                                                    id: 'buPassID',
...
//                      console.log("asdf");
                                            ...
                                            if (msg == "") {
                                                ...
                                                Ext.getCmp('modeID').setValue('UP_CONTRACT_NO_TOR_NO_CHECK');
                                        ...
                                        text: "ออกเลขสัญญา (ไม่ตรวจรับ) ",
                                        id: "buGenCodeID",
                                        iconCls: "icon-script-save",
                                        handler: function () {
                                            Ext.getCmp('modeID').setValue('GENCODECTSNOTOR');
//                                            var form = Ext.getCmp("form-main").getForm();
//                                            form.url = "tor/api/mnContractCode.php"
//                                            formSubmit(form);
...
console.log(Ext.selectRow.get('i_yyyy'));
console.log(Ext.selectRow.get('sp_emp_id'));
            winApp.show();
            // alert(Ext.selectRow.data.txtdc_department_idID);
...
//                                                                                        Ext.getCmp("dc_department_id").setValue(Ext.selectRow.get("txtdc_department_idID"));
            Ext.getCmp("sp_emp_idID_Name").setValue(Ext.selectRow.get("txtsp_emp_idID"));
//                                                                                        Ext.getCmp("sp_emp_id").setValue(Ext.selectRow.get("sp_emp_id"));

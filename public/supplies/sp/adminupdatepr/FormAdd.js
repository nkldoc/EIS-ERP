                                    ...
                                    new Ext.form.ComboBox({
                                        ...
                                        listeners: {
                                            ...
                                            , {
                                                xtype: 'container',
                                                layout: 'column',
                                                fieldLabel: 'สถานะ', // ย้าย label มาไว้ที่ตัวแม่
                                                anchor: '100%',
                                                defaults: {
                                                    border: false
                                                },
                                                items: [
                                                    {
                                                        // ช่องแสดงสถานะเดิมของคุณ (ปรับความกว้างเล็กน้อย)
                                                        xtype: "textfield",
                                                        width: 120,
                                                        value: Ext.select_row.c_name_status,
                                                        style: "text-align: center;font-weight:bold;background:#eee;color:#333;",
                                                        readOnly: true
                                                    }, {
                                                        xtype: "button",
                                                        text: "ปรับสถานะเมูนู",
                                                            ...
                                                            new Ext.Window({
                                                                ...
                                                                items: [
                                                                    ...
                                                                    },
                                                                    {
                                                                        xtype: "radiogroup",
                                                                        columns: [180, 180],
                                                                        fieldLabel: "การย้อนเมนู/กลับไปเมนูเดิม",
                                                                        id: "modecancelID",
                                                                        style: {"font-weight": "bold"},
                                                                        items: [{
                                                                                xtype: "hidden",
...
//  / 2. สร้าง ComboBox โดยเรียกใช้ Store ด้านบน
                                                                            new Ext.form.ComboBox({
                                                                                fieldLabel: 'เลือกเมนูที่ต้องการย้อน',
                                                                                mode: "local", // หากโหลดครั้งเดียวจาก afterrender ใช้ local ถูกต้องแล้วครับ
                                                                                store: Ext.returnMenu,
                                                                                valueField: "id",
                                                                                displayField: "c_name",
                                                                                id: 'sp_status_hdr_idID',
                                                                                name: 'sp_status_hdr_id',
                                                                                hiddenName: "sp_status_hdr_id",
                                                                                editable: false, // บล็อกไม่ให้ผู้ใช้พิมพ์ ป้องกันปัญหาพิมพ์แล้วหาไม่เจอ
                                                                                triggerAction: 'all',
                                                                                width: 460,
                                                                                listWidth: 450,
                                                                                emptyText: '--- เลือกเมนูที่ต้องการถอย---',
                                                                                selectOnFocus: true,
                                                                                listeners: {
                                                                                    afterrender: function () {


                                                                                        var selectedRow = Ext.selectRow;
                                                                                        var selectedId = Ext.selectRow && Ext.selectRow.data ? Ext.selectRow.data.id : null;
                                                                                        ...
                                                                                        Ext.returnMenu.setBaseParam('id', selectedId);
                                                                                        Ext.returnMenu.reload({callback: function (record, operation, success) {
                                                                                                if (success) {
                                                                                                    Ext.getCmp('sp_status_hdr_idID').setValue(selectedRow.data.tor_status_id);
                                                                                                }
                                                                                            }});
                                                                                ...
                                                                                // เปลี่ยนจาก {reasonText} เป็น {c_name} ให้ตรงกับ fields ของ Store
                                                                                tpl: '<tpl for="."><div class="x-combo-list-item" style="white-space: normal; word-wrap: break-word;">{c_name}</div></tpl>',
                                                                            ...
                                                                            if (msg == "") {
                                                                                Ext.Ajax.request({
                                                                                    ...
                                                                                    params: {
                                                                                        ...
                                                                                        sp_status_hdr_id: Ext.getCmp('sp_status_hdr_idID').getValue(),
                                                                                        sp_status_old_hdr_id: Ext.selectRow.data.tor_status_id,
...
//                                                    {
//                                                        // คอมโบโบว์สำหรับกดเปลี่ยนสถานะ
//                                                        xtype: 'combo',
//                                                        width: 150,
//                                                        style: 'margin-left: 5px;', // เว้นระยะห่างจากช่องแรก
//                                                        mode: 'local',
//                                                        triggerAction: 'all',
//                                                        editable: false,
//                                                        emptyText: 'เปลี่ยนสถานะ...',
//                                                        store: new Ext.data.ArrayStore({
//                                                            fields: ['id', 'name'],
//                                                            data: [
//                                                                ['1', 'ใช้งาน (Active)'],
//                                                                ['2', 'ระงับการใช้งาน (Inactive)'],
//                                                                ['3', 'ยกเลิก (Cancel)']
//                                                            ]
//                                                        }),
//                                                        valueField: 'id',
...
//                                                                var selectedText = record.get('name');
//
//                                                                // ทำงานเมื่อเลือกสถานะใหม่ เช่น ส่งไปบันทึก หรืออัปเดตหน้าจอ
//                                                                console.log('เปลี่ยนเป็นรหัส:', selectedValue);
//
//                                                                // ตัวอย่าง: ถ้าอยากให้เลือกแล้วข้อความใน textfield เปลี่ยนตาม
//                                                                // combo.ownerCt.items.itemAt(0).setValue(selectedText);
//                                                            }
//                                                        }
//                                                    }
                                                ]

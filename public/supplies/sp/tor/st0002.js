    ...
    (gridMain = function () {
      ...
      gridMain.superclass.constructor.call(this, {
        ...
        tbar: [
          ...
          {
            xtype: "button",
            text: " การให้ภาระงานหน่วยงานและรายบุคคล",
            ...
            handler: function (e) {
              Ext.torScores = new Ext.data.JsonStore({
                ...
                autoLoad: true,
                url: "api/All_spAlert.php",
                baseParams: { type: "sp_tor_score_emp" },
                root: "data",
                idProperty: "id",
                fields: ["id", "c_name", "c_department", "dc_department_id", "score", "c_tor_id"],
              });

              var tab3 = new Ext.FormPanel({
                region: "center",
                labelAlign: "top",
                title: "การให้ภาระงานหน่วยงานและรายบุคคล",
                id: "tabPanel2ID",
                icon: "../images/icons/chart_pie.png",
              ...
              if (!Ext.isEmpty(Ext.getCmp("tabPanel2ID"))) Ext.getCmp("contenterCenter").remove(Ext.getCmp("tabPanel2ID"));
              Ext.getCmp("contenterCenter").add(tab3);
              Ext.getCmp("contenterCenter").setActiveTab(tab3);
            },
          },
          {
            xtype: "button",
            text: " ข้อมูลการแจกงาน",
            icon: "../images/icons/chart_pie.png",
            handler: function (e) {
              Ext.torScores = new Ext.data.JsonStore({
                autoDestroy: false,
                autoLoad: true,
                url: "api/All_spAlert.php",
                baseParams: { type: "sp_tor_department" },
                root: "data",
                idProperty: "id",
              ...
              if (!Ext.isEmpty(Ext.getCmp("tabPanelID"))) Ext.getCmp("contenterCenter").remove(Ext.getCmp("tabPanelID"));
              Ext.getCmp("contenterCenter").add(tab2);
              Ext.getCmp("contenterCenter").setActiveTab(tab2);
            },
          },

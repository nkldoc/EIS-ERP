Ext.onReady(function() {
	...
	/*===============================================*/
  	var title_panel		= "งบแสดงฐานะการเงิน";
	/*===============================================*/
	var store_acc_all_parent_lv2 = new Ext.data.JsonStore({
		autoLoad : true,
		url : "api/All_GlRep00002.php",
	...
	LookReport = function( type) {
		...
		if (Ext.getCmp("dc_cost_id").getValue() == "") {
 		...
 		if( msg == "" ) {
			...
			var href				= "report/Rep_GlRep00002.php";
			var href_details		= "report/Rep_GlRep00002_dtl.php";
	    	var resultUrl			= "";
			...
			items: [{
				...
				items: [{
					...
					items: [new Ext.form.ComboBox({
						...
						xtype : "displayfield",
						value : "<font size=2 color=red><b>แสดงผลแบบ : ยอดสะสม เท่านั้น</b></font>"
					} 
					/*, new Ext.ux.form.LovCombo({
						id : "dc_cost_id",

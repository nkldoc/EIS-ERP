...
Ext.QuickTips.init();
	...
	var gridMain = {
		region: 'center',
		title: 'แสดงข้อมูลประเภทการประกันภัย',
		xtype: 'grid',
		id:'tabpanel1',
		border: false,
		stripeRows: true,
		...
		tbar: [{	
			...
			,' ', '-', {
				...
				handler : function() {  
					...
					{ header: "รหัส", sortable: true, dataIndex: 'id' , align:'center'},
					{ id: 'c_name', header: "ประเภทการประกันภัย ", sortable: true, dataIndex: 'c_name' },
					{
						header: "Status",  
						sortable:false,
						align: 'center',
	...
	var panelForm = {
		region: 'center',
		title: 'ข้อมูลประเภทการประกันภัย',
		xtype: 'panel',
		id:'tabpanel2',
		border: false,
		disabled: true,
			...
			items: [{
	        	...
	        	validator: function(val) {
	        		if (!Ext.isEmpty(val)) {
	        			...
	        			return "กรุณากรอก หมวดประกันภัย";
	        		}
	        	},
			}, {

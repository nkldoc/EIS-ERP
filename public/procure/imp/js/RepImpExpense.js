Ext.onReady(function() {
  ...
  if (Ext.TYPE_PAGE == "ephys") {
    title_panel = "รายงานนำเข้าข้อมูลค่าใช้จ่าย (e-phys)";
    itype = Ext.DC_EXP_BG_ITYPE_EPHYS;
  } else if (Ext.TYPE_PAGE == "vsn1") {
    title_panel = "รายงานนำเข้าถอนคืนเงินรับฝาก (Vision Net)";
    itype = Ext.DC_EXP_BG_ITYPE_VISIONNET;
  } else if (Ext.TYPE_PAGE == "vsn2") {
    title_panel = "รายงานนำเข้าถอนคืนรายได้โรงพยาบาล (Vision Net)";
    itype = Ext.DC_EXP_BG_ITYPE_VISIONNET;
  } else if (Ext.TYPE_PAGE == "vsn3") {
    title_panel = "รายงานนำเข้าข้อมูลค่าใช้จ่าย (Vision Net)";
    itype = Ext.DC_EXP_BG_ITYPE_VISIONNET;
  } else if (Ext.TYPE_PAGE == "all") {
    title_panel = "รายงานนำเข้าข้อมูลค่าใช้จ่าย";
    itype = null;
  }
  /* =============================================== */
  ...
  LookReport = function(type) {
    ...
    if (msg == "") {
      if (Ext.TYPE_PAGE == "ephys") {
        href = "report/Rep_RepImpExpense.php";
      } else if (Ext.TYPE_PAGE == "all") {
      ...
      resultUrl += "&i_prevent_money=" + (Ext.getCmp("i_prevent_money").checked ? 1 : 0);
      resultUrl += "&i_cancel=" + (Ext.getCmp("i_cancel").checked ? 1 : 0);

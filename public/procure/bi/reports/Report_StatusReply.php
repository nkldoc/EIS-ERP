...
<head>
        ...
        <title>Reply Report Dashboard - EIS รายงานทักท้วง</title>
...
<body>
        <div class="container-fluid pt-3 pb-5">
                ...
                <div class="card-custom p-3">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="font-weight-bold m-0">รายงานสรุปรายการทักท้วง (Reply Report) - EIS</h5>
                        </div>
                                        ...
                                        <div class="info-box bg-primary text-white">
                                                ...
                                                <div class="d-flex justify-content-around align-items-center">
                                                        <div class="text-center">
                                                                ...
                                                                <h3 id="sum_sent_all" class="cursor-pointer" title="คลิกเพื่อดูรายละเอียดทั้งหมด">0</h3>
                                                        </div>
                                                        <div class="text-center border-left border-right px-4">
                                                                <small>โดนทักท้วง</small>
                                                                <h3 id="sum_reply_all" class="cursor-pointer" title="คลิกเพื่อดูรายการที่ถูกทักท้วงทั้งหมด">0</h3>
                                                        </div>
                                                        <div class="text-center">
                        ...
                        <div class="modal-content border-0 shadow-lg">
                                ...
                                <div class="modal-body p-0">
                                        <div class="p-3 bg-white border-bottom d-flex justify-content-between align-items-center">
                                                ...
                                                <div id="modalSummaryStats" class="small text-muted"></div>
                                        </div>
                                                ...
                                                <table class="table table-hover table-striped mb-0" id="modalTable">
                                                        <thead class="thead-light">
                                                                <tr>
                                                                        ...
                                                                        <th class="sticky-top">เลขที่รับของ</th>
                                                                        <th class="sticky-top">เลขที่ตรวจรับ</th>
                                                                        <th class="sticky-top">เลขที่ส่งเบิก</th>
                                                                        <th class="sticky-top" style="min-width:280px;">ชื่อโครงการ/สัญญา</th>
                                                                        ...
                                                                        <th class="sticky-top" style="min-width:110px;">วันที่ส่งกลับทักท้วง</th>
        ...
        <style>
                ...
                #modalTable tbody tr { min-height: 56px; }
                #modalTable tbody tr:hover { background-color: #f1f8ff; }
                .sticky-top { position: sticky; top: 0; z-index: 1020; }
                .table-responsive { background-color: #fff; }
                .table-responsive::-webkit-scrollbar { width: 8px; height: 8px; }
                .table-responsive::-webkit-scrollbar-track { background: #f1f1f1; }
                .table-responsive::-webkit-scrollbar-thumb { background: #bbb; border-radius: 4px; }

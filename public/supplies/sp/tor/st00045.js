...
Ext.AppUx = function (app, menu) {
    ...
    Ext.storeDtl = new Ext.data.JsonStore({
        ...
        baseParams: {
            type: "po_working_dtl_Allocate_money",
            keyData: Ext.keyData,
                                                                            ...
                                                                            callback: function (recordx, operation, success) {
                                                                                if (success) {
                                                                                    if (!Ext.isEmpty(Ext.selectRow)) {
                                                                                        ...
                                                                                        //button
                                                                                        console.log(Ext.selectRow);
                                                                                        Ext.getCmp("tor_delete_comment").setValue(Ext.selectRow.get("tor_delete_comment"));
            ...
            items: [
                {
                    ...
                    items: [
                        new Ext.FormPanel({
                            ...
                            url: window.location.protocol + "//" + window.location.hostname + "/sp_mn/api/mnUploadDoc.php",//"tor/api/mnTorController.php",
                            frame: true,
                            autoScroll: true,
                            labelAlign: "left",
                            bodyStyle: "padding:1px",
...
//                                                                    alert(Ext.i_bg_type);
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function () {
                                        ...
                                        if (Ext.getCmp("i_is_registerID").getValue().inputValue == "2" && Ext.selectRow.get("tor_hdr_dtl") == "0") {
                                            ...
                                            //     form.submit({
                                            //         waitMsg: "Saving Data...",
                                            //         params: {mode: "UPDATE_PDF_ENABLED"},
                                            //         success: function (form, action) {
                                            //             Ext.Msg.alert("Success", action.result.msg, function (form, action) {
                                            //                 Ext.storeDtl.reload({
                                            //                     callback: function (record, operation, success) {
        ...
        var tab2 = function () {
            ...
            var linkDownload = window.location.protocol + "//" + window.location.hostname + "/sp_mn/api/upload_enabled";
                    ...
                    buttons: [
                        {
                            ...
                            handler: function () {
                                ...
                                Ext.storeDtl.setBaseParam("i_enabled", Ext.getCmp("i_enabledID").getValue().inputValue); // Ext.getCmp("searchEnabledID").getValue().inputValue);
                                ...
                                Ext.storeDtl.setBaseParam("type_enabled", null);
            ...
            (gridMain = function () {
                var colmnn = [
                    ...
                    // },
                    {
                        ...
                        renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                            ...
                            if (record.data.i_is_upload == null) {
                                ...
                                return '<button style="display: flex" onclick="window.open(\'' + linkDownload + record.data.c_code + '.pdf' + '?T=Tap_' +  Math.floor(Math.random() * 100000) 
                    ...
                    },
                    {
                        ...
                        width: 105,
                        align: "center",
                        dataIndex: "pdf_enabled",
                        editor: new Ext.form.TextField({}),
                        renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                            var linkDownload = window.location.protocol + "//" + window.location.hostname + "/sp_mn/api/upload_enabled/";
                            var BtnText = "<img src='../images/icons/page_white_acrobat.png' style='margin-right:1px;' /><div><spen style='font-size:11px'>&nbspเอกสาร PR</spen>";
                            if (record.data.pdf_enabled == 0) {
                                return "-";
                            } else if (record.data.pdf_enabled == 1) {
                                return '<button style="display: flex" onclick="window.open(\'' + linkDownload + record.data.c_code + '.pdf' + '?T=Tap_' +  Math.floor(Math.random() * 100000) 
                                + '\')" type="button">' + BtnText + "</button>";
                            }
                        },

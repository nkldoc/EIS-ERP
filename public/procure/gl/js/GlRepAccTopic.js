...
Ext.onReady(function() {
	...
	/*===============================================*/
	var title_panel	= "แสดงข้อมูลหัวข้อที่ 1";
	/*===============================================*/
	...
	Ext.store = new Ext.data.JsonStore({
	    ...
	    autoDestroy: true,
		autoLoad: true,
	    url: "api/List_GlRepAccTopic.php",
	    baseParams: { type: "gl_rep_acc_dtl", i_read: user_right_read }, //Permission i_read
	    root: "data",
	    idProperty: "id",
	...
	Ext.gl_rep_acc_hdr	= StoreJson("api/All_GlRepAccTopic.php", "gl_rep_acc_hdr");
	...
	function controllTab(record,butt) {
		...
		if( butt == "add" ) {
			...
			Ext.vw_dc_acc.setBaseParam("gl_rep_acc_dtl_id",record.get("id"));
			Ext.vw_dc_acc.load();
		            ...
		            items: [new Ext.FormPanel({
							...
							listeners: {
								...
								change: function(combo, newValue) {
									...
									if ( newValue == "" ) {
										...
										Ext.vw_dc_acc.setBaseParam("gl_rep_acc_dtl_id", "");
										Ext.vw_dc_acc.load();
		                ...
		                buttons: [{
		                    ...
		                    handler: function(grid, rowIndex, colIndex) {
								...
								if(Ext.getCmp("c_name").getValue() == "") { msg	+= "- กรุณากรอก ชื่อหัวข้อที่ 1<br>"; }
								...
								if (msg == "") {
									...
									Ext.Ajax.request({
										...
										params: {
											...
											gl_rep_acc_hdr_id: Ext.getCmp("gl_rep_acc_hdr_id").getValue(),
	...
	gridMain = new Ext.grid.GridPanel({
		...
		columns: [
			...
			{ id: "c_name", header: "ชื่อหัวข้อที่ 1", sortable: true, dataIndex: "c_name" },

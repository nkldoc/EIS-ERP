...
$arrParam = array();
$arrCountParam = array();
$sqlTempTable = "select dc_tax_income_id
                    , parent_id
                    , i_rank_bank
                    , c_code
                    , c_name
                    ...
                    , i_is_method
                    , case i_is_method 
                        when ".DC_TAX_INCOME_METHOD_NOSUM." then 'ไม่ต้องสรุปข้อมูลรายปี'
                        when ".DC_TAX_INCOME_METHOD_ISSUM." then 'ต้องสรุปข้อมูลรายปี' 
                        else '' end as c_method
                    , i_is_type
                    , case i_is_type 
                        when ".DC_TAX_INCOME_TYPE_MONTH." then 'แบบแสดงรายการประจำเดือน'
                        when ".DC_TAX_INCOME_TYPE_YEAR." then 'แบบสรุปรายการประจำปี' 
                        else '' end as c_type
                    , i_enable

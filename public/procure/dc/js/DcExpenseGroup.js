...
dc_bg_type	= new Ext.data.JsonStore({
	autoLoad: true,
	url: "api/All_DcExpenseGroup.php",
	baseParams: { type: "dc_bg_type_all"},
	root: "data",
	idProperty: "id",
	fields: [ "id", "c_name" ]
});
...
Ext.store = new Ext.data.JsonStore({
    ...
    autoDestroy: true,
    autoLoad: true,
    url : 'api/ListDcExpenseGroup.php',
    root: 'data',
...
Ext.onReady(function(){
    ...
    var gridMain = {
        ...
        columns:[
			...
			{ id: 'c_name', header: "หมวดรายจ่าย", width:350, sortable: true, dataIndex: 'c_name' }, 
            {
                header: "Status",  
                sortable:false,
                align: 'center',

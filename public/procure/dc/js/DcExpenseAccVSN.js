...
formSoDtl = function() {
    formSoDtl.superclass.constructor.call(this, {  
        ...
        defaults:{ flex:1, },   
        title:'รายการจ่ายบัญชี (Vision Net)',  
        items:[{
                id : "role-form-mode",
                xtype : "hidden",
                name : "mode",
                ...
                xtype: 'textfield',
                fieldLabel: 'รายการจ่ายบัญชี (Vision Net)',
                name : 'c_name',
                anchor: '70%',
...
//			Ext.PopAccOverlapForm.mini,
			{
                ...
                fieldLabel: 'รายการรายได้ที่เมนูสมุดรายวัน',
                xtype: 'radiogroup',
                columns: [80,100],
                items: [
...
searchGrid = function() {
    var filters = {
        ...
        store: new Ext.data.SimpleStore({
            fields: ["id", "c_name"],  
            data:[['c_name', "รายการจ่ายบัญชี (Vision Net)"],['c_code', "รหัส"]],
        }),
        value: 'c_name',
        valueField: 'id',
        displayField: 'c_name',
...
Ext.store = new Ext.data.JsonStore({
    ...
    autoDestroy: true,
    autoLoad: true,
    url : 'api/ListDcExpenseAccVSN.php',
    root: 'data',
...
Ext.storeExpenseVisionNet = new Ext.data.JsonStore({ 
    storeId: 'myStore1', 
    autoLoad: true,
    url : 'api/All_DcCombo.php',
    root: 'data',
    baseParams: { type : 'storeExpenseVisionNet' }, //Permission i_read
    idProperty: 'id',
    totalProperty: 'totalCount', 
    fields: [ 'id', 'c_code', 'c_name']
});
...
Ext.PopExpenseGroupForm = new Ext.ux.Poplov({ 
    text		: 'หมวดรายจ่ายย่อย Vision Net',  
    id			: 'dc_expense_vsn_idID',	//go to relation     dc_expense_group_vsn_id	
    iconCls		: 'page_magnify', 
    valueHidden : 'dc_expense_vsn_id', 	//go to hidden
    store		: Ext.storeExpenseVisionNet,
    headerGrid	: columnMini,
    widthText	: 500,  
    fieldLabel	: 'หมวดรายจ่ายย่อย  Vision Net'
}); 
...
Ext.onReady(function(){
    ...
    var gridMain = {
        region: 'center',
        title: 'แสดงข้อมูลรายการจ่ายบัญชี (Vision Net)',
        xtype: 'grid',
        id:'tabpanel1',
        border: false,
        stripeRows: true,
        ...
        columns:[
			...
			//{ header: "หมวดรายจ่าย", width:300, sortable: true, dataIndex: 'txtdc_expense_group_vsn_idID' },
			{ header: "หมวดรายจ่ายย่อย", width:300, sortable: true, dataIndex: 'txtdc_expense_vsn_idID' },
			{ id: 'c_name', header: "รายการจ่ายบัญชี (Vision Net)", width:400, sortable: true, dataIndex: 'c_name' },  
            {
                header: "Status",  
                sortable:false,
                align: 'center',

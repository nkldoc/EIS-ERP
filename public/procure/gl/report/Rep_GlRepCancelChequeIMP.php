<?php
include("../api/List_GlRepCancelChequeIMP_BTN.php");
...
if($_REQUEST["page"] == "GlRepCancelChequeIMP") {
	$caption	= "รายงาน ยกเลิกบัญชีย่อยเงินฝากธนาคาร";
} else if($_REQUEST["page"] == "GlRepCancelChequeBTN") {
	$caption	= "รายงาน ยกเลิกบัญชีเงินฝากธนาคาร(ไม่มีรายละเอียดค่าใช้จ่าย)";
}
...
if( is_array($data_dtl) && count($data_dtl["data"]) > 0 ) {
	...
	foreach($data_dtl["data"] as $index => $jObj) {
		...
		if (($_REQUEST["page"] == "GlRepCancelChequeIMP") || ($_REQUEST["page"] == "GlRepCancelChequeBTN"))
		{						

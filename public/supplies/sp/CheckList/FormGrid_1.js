...
Ext.AppUx = function (app, menu) {
    ...
    Ext.senMsgToProcure = (msgType, msg, cost_id) => {
        Ext.Ajax.request({
            url: "https://eis.vajira.ac.th/procure/websocket/event",
            params: {
                                                    ...
                                                    items: [
                                                        {
                                                            name: "mode_2",
                                                            checked: true,
                                                            inputValue: "UPDATEFORMCheckList",
...
//                        console.log(window.parent.Ext.getCmp('refresh-parentID'));
                                            ...
                                            window.parent.Ext.globValue = Ext.apply({sp_tor_id: Ext.selectRow.get('id'), pr_code: Ext.selectRow.get('c_code'), c_name: Ext.selectRow.get('c_name'), tor_type_id: Ext.selectRow.get('tor_type_id'), update: Ext.util.Format.date(new Date(), 'Y-m-d H:i:s')});

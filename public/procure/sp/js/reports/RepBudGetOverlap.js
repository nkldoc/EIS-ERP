                ...
                items: [
                    {
                        ...
                        items: [
                            {
                                title: "รายงานการใช้ใบกันเหลื่อม ฝ่ายพัสดุ",
                                    ...
                                    // },
                                    {
                                        ...
                                        items: [
                                            {
                                                ...
                                                inputValue: 1,
                                                checked: true,
                                                boxLabel: "รูปแบบรายงานมองจากพัสดุ",
                                            },
                                            {
                                                inputValue: 2,
                                                name: "i_bg",
                                                boxLabel: "รูปแบบรายงานมองจากใบกัน(ยังไม่สามารถใช้งานได้)",
                                            },
                                            {
                                                // hidden : true,
                                                name: "i_bg",
                                                inputValue: 3,
                                                boxLabel: "รูปแบบรายงานมองจากพัสดุ(รายการที่ยังใช้เงินไม่หมด)",
                                                // load: function () {
                                        ...
                                        listeners: {
                                            ...
                                            change: function () {
                                                ...
                                                //     Ext.getCmp('i_type_fID').hide();
                                                // } else {
                                                //     Ext.getCmp('i_type_fID').show();
                                                // }
                                            },
                                        },
                                    },

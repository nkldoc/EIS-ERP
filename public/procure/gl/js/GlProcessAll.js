Ext.onReady(function() {
	...
	/*===============================================*/
	var title_panel		= "ประมวลผลบัญชี ภาพรวม/ตามบัญชี/ต้นทุน";
	/*===============================================*/
    ...
    var panelForm	= new Ext.Panel ({
        ...
        items: [{
			...
			buttonAlign: "left",
			buttons: [{
				text: "ประมวลผล ภาพรวม/ตามบัญชี/ต้นทุน",
				...
				handler: function() {
					...
					if( msg == "" ) {
						...
						var progressbar = Ext.MessageBox.show({
					        title: "Please wait",
					        msg: "กำลังประมวลผลบัญชี (ภาพรวม/ตามบัญชี/ต้นทุน)	",

<?php
include ("../api/List_GlRep00013.php");
...
$caption = "รายงาน รายละเอียดเงินฝากธนาคาร";
...
$panda = substr($_REQUEST["date_end"],0,4)+543;
echo "<div align='center'><strong>" . $caption . "</strong></div>";
echo "<div align='center'><strong>ปีงบประมาณ " . ($panda) . "</strong></div>";

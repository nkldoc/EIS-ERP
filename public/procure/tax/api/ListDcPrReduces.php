...
$arrParam = array();
$arrCountParam = array();
$sqlTempTable = "select dc_pr_reduce_id
                    , c_code
                    , c_name
                    , c_comment
                    , f_amount
	...
	{
            $temp = array("no" => ($i++), 
                            "id"                        => $row["dc_pr_reduce_id"],
                            "c_code"                    => $row["c_code"],
                            "c_name"                    => $row["c_name"],
                            "c_comment"                 => $row["c_comment"],
                            "f_amount"                  => $row["f_amount"],
                            "f_amount2"                 => $row["f_amount2"],
                            "i_reduce_type"             => $row["i_reduce_type"],
                            "i_is_private"              => $row["i_is_private"],
                            "i_standard"                => $row["i_standard"],

...
if (is_array($data_dtl) && count($data_dtl["data"]) > 0) {
	...
	foreach ($data_dtl["data"] as $index => $jObj) {
		...
		$tbody .= "<td align='left'>" . $jObj["po_expense_name"] . "</td>";
	...
	<div class="outer">
		...
		<div class="class-t">
			<div class="hh">
				...
				<div style="position: relative; left: 2px;">8 - 30 วัน : <?= $data_dtl["ii_than30_1"] ?> ฏีกา</div>
			...
			<div class="hh">
				...
				<div style="position: relative; left: 2px;">8 - 30 วัน : <?= $data_dtl["ii_than30_2"] ?> ฏีกา</div>
			...
			<div class="hh">
				...
				<div style="position: relative; left: 2px;">8 - 30 วัน : <?= $data_dtl["ii_than30_3"] ?> ฏีกา</div>
			...
			<div class="hh">
				...
				<div style="position: relative; left: 2px;">8 - 30 วัน : <?= $data_dtl["ii_than30_4"] ?> ฏีกา</div>

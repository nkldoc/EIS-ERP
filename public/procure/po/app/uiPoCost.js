                        ...
                        buttons: [
                            {
                                ...
                                handler: function () {
                                    if(Ext.getCmp("po_emp_idID").getValue()== 0 ){
                                        ...
                                        return false;
                                    } else if (Ext.getCmp("po_creditor_idID").getValue() == 0 ){
                                        Ext.Msg.alert('Failure', 'ยังไม่ได้ระบุเจ้าหนี้');
                                        return false;
                                    } else if (Ext.getCmp("po_creditor_idID").getValue() == null ) {
                                        Ext.Msg.alert('Failure', 'ยังไม่ได้ระบุเจ้าหนี้');
                                        return false;
                                    } else if (Ext.getCmp("po_creditor_transfer_id").getValue() == null) {
                                        Ext.Msg.alert('Failure', 'ยังไม่ได้ระบุเจ้าหนี้');
                                        return false;
                                    } else if (Ext.getCmp("po_creditor_transfer_id").getValue() == 0){
                                        Ext.Msg.alert('Failure', 'ยังไม่ได้ระบุเจ้าหนี้');
                                        return false;
                                    }
    ...
    var gridChecking = {
        ...
        columns: [
...

            {
                ...
                editor: new Ext.form.TextField({}),
                renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                    var BtnText = "<img src='../images/icons/page_white_acrobat.png' style='margin-right:1px;' /><div><spen style='font-size:11px'>&nbspเอกสารนประกอบใบเบิก</spen>";

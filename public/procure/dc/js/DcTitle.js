...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: 'ชื่อคำนำหน้า',
                    name : 'c_name',
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบะ ชื่อคำนำหน้า ";
                        }
                    }
                },{
                    xtype: 'textarea',
...
Ext.QuickTips.init();
        var gridMain = {
                ...
                { id: 'c_name', header: "ชื่อคำนำหน้า", width:210, sortable: true, dataIndex: 'c_name' }, 
                {
                        header: "Status",  
                        sortable:false,
                        align: 'center',

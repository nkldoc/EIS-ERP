Ext.onReady(function () {
    ...
    Ext.urlReport = (1) ?'https://eis.nmu.ac.th:8443/reports/reportImc003' : 'https://eis.nmu.ac.th:8443/reports/printr.php?get=true'; 


    // Spring Boot
    Ext.titleReport = 'รายงานใบสั่งขายโฆษณาโทรทัศน์/วิทยุ (IMC)';
    ...
    function displayTitleReport(v) {
        //set display title report get,set text


//        console.log(Ext.getCmp("s_year").getValue());
//        console.log(store_year);
//        console.log(store_month);
    ...
    function frmWithOutAjax(value) {
        ...
        frm.setAttribute('target', "ReportImc003");
    ...
    var panelForm = new Ext.Panel({
        ...
        items: [{
                ...
                items: [{
                        ...
                        items: [{
                                title: "รายงานใบสั่งขายโฆษณาโทรทัศน์/วิทยุ (IMC)",
                                ...
                                items: [{xtype: 'hidden', id: 'titleReportID', name: 'titleReport', value: Ext.titleReport},
                                    ...
                                    {xtype: 'textfield', name: 'jasperName', value: "newimc001Lavel1"},

Ext.store = new Ext.data.JsonStore({
  ...
  fields: [{ name: "no" }, { name: "id" }, { name: "c_code" }, { name: "c_approve" }, { name: "d_approve_date" }, { name: "cost_name" }, { name: "budget_name" }, { name: "bg_expense_name" }, { name: "creditor_name" }, { name: "f_total" }]
});

  /* global Ext, user_right_read, user_right_add, user_right_edit, user_right_delete */
// @ts-ignore
...
//            params: ''
  ...
  Ext.po = Ext.apply ( {
      store : new Ext.data.JsonStore ( {
          ...
          autoDestroy : true ,
//          autoLoad : true ,
          url : 'reg/DAO/ListEmpHasRight.php' ,
          root : 'data' ,
          baseParams : {
...
//                      window.drestroy () ;
  ...
  Ext.onReady ( function () {
      ...
      Ext.hasWindow = 'DcEmpPo' ;
      Ext.mnController = 'reg/controller/mnDcEmpPo.php' ;


      //ปิดเมนู
      Ext.DAO = 'reg/DAO/ListDcEmpPo.php' ;

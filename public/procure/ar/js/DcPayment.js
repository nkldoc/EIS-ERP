...
Ext.QuickTips.init();
	...
	var gridMain = {
		region: 'center',
		title: 'แสดงข้อมูลเงื่อนไขการชำระเงิน',
		xtype: 'grid',
		id:'tabpanel1',
		border: false,
		stripeRows: true,
		...
		tbar: [{	
                ...
                store     : new Ext.data.SimpleStore({
							  ...
							  data: [
								...
								[ 'c_name', "ชื่อเงื่อนไขการชำระเงิน" ]
							  ]
							})
				,
				valueField: "value",
	...
	var panelForm = {
		region: 'center',
		title: 'ข้อมูลเงื่อนไขการชำระเงิน',
		xtype: 'panel',
		id:'tabpanel2',
		border: false,
		disabled: true,
        ...
        items: [
		{
			...
			items: [{
				...
				fieldLabel: 'ชื่อเงื่อนไขการชำระเงิน',
				xtype: 'textfield',
				name: 'c_name',
	        	validator: function(val) {
	        		if (!Ext.isEmpty(val)) {
	        			...
	        			return "กรุณากรอก ชื่อเงื่อนไขการชำระเงิน";
	        		}
	        	},
			}, {
				fieldLabel: 'หมายเหตุ',

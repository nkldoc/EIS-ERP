...
/*    border-bottom-color: #999;
    ...
    border-top-style: solid;*/ 
        ...
        <script type="text/javascript" src="./../js/MultiCellSelectionModel.js?_dc=<?= __VPRODUCT_; ?>"></script>
        <script type="text/javascript" src="./uiData/configStoreUi.js?_dc=<?= __VPRODUCT_; ?>"></script>
        <script type="text/javascript" src="./tor/spMonthly.js?_dc=<?= __VPRODUCT_; ?>"></script> 
<!--gen_new-->
        <!--<script type="text/javascript" src="./tor/<?PHP echo "deliverWork_New.js?_dc=" . __VPRODUCT_; ?>"></script>-->
        <script type="text/javascript" src="./tor/<?PHP echo "deliverWorkGroup.js?_dc=" . __VPRODUCT_; ?>"></script>

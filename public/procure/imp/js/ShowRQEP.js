...
Ext.onReady(function() {
	...
	/* =============================================== */
	title_panel		= "แสดงสถานะใบเบิกทั้งหมด (e-PHIS)";	
	/* =============================================== */
	
	Ext.store = new Ext.data.JsonStore({
		autoLoad: false,
		url: "api/List_ShowRQEP.php",
		baseParams: { type: "imp_request_ephis_dtl_all", i_read: user_right_read }, // Permission i_read
	    root: "data",
	    idProperty: "id",
	...
	gridMain = new Ext.grid.GridPanel({
		...
		columns: [
			...
			{ header: "-", sortable: false, align: "center", width:100, dataIndex: "c_type_request" }, 

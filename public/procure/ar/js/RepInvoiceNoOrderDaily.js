Ext.onReady(function() {
    ...
    Ext.urlReport   = './api/report/RepInvoiceNoOrderDaily.php';
    Ext.titleReport = 'รายงาน Order ที่วางบิล/แจ้งหนี้แล้ว กรณีไม่มี Order';
    ...
    function frmWithOutAjax(value){
            ...
            frm.setAttribute('target',"ReportNoOrder");	

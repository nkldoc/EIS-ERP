...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <iframe src="<?= OST_HOST ?>://<?= NMU_EIS_HOST ?>/asset/AmModeAcc.php?_dc=<?= __VPRODUCT_; ?>" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px" height="100%" width="100%"></iframe>

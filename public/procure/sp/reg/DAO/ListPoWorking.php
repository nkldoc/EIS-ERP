...
, row_number() over (order by a.po_status_hdr_id asc) as row 
from dbo.po_working_hdr a 
inner join dbo.po_working_dtl b on b.po_working_hdr_id = a.po_working_hdr_id

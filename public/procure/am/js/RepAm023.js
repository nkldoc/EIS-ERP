Ext.onReady(function() {
    ...
    Ext.urlReport	= './api/report/RepAm023.php';  // 
    Ext.titleReport = 'รายงานบัญชีสินทรัพย์ถาวร (บัญชี)';
    ...
    var storeAcc = new Ext.data.JsonStore({
        url: 'api/All_AmCombo.php',
        baseParams : {type : 'storeAcc', i_all : 1, i_group : '12', start:0, limit:2000},
        root: 'data',
        idProperty: 'id',
        totalProperty: 'totalCount',
        fields: [ 'id','c_code', 'c_name', 'c_code_name']
    ...
    storeAcc.load({
            callback : function (records, operation, success)
            {
                if (success)
                {
                        Ext.getCmp('s-dc_acc_id').setValue(0);
                }
            }
    });

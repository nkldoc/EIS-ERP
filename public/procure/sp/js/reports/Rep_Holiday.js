...
Ext.onReady(function () {
    ...
    Ext.urlReport = (true) ? 'https://eis.nmu.ac.th:8443/reports/reportHoliday' : 'https://eis.nmu.ac.th:8443/reports/printr.php?get=true'; //DEBUG  
...
//    Ext.urlReport = (false) ? 'https://eis.nmu.ac.th:8443/reports/reportSpEmp' : 'https://eis.nmu.ac.th:8443/reports/printr.php?get=true'; //DEBUG 
    // Spring Boot
    Ext.titleReport = 'รายงานวันหยุดประจำปีงบประมาณ';
// storeYear
  var years = [];
    ...
    var panelForm = new Ext.Panel({
        ...
        items: [{
                ...
                items: [{
                        ...
                        items: [{
                                title: "รายงานวันหยุดประจำปีงบประมาณ",

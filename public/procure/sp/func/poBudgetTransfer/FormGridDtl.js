...
const saveDtl = function(mode) {
  ...
  sto.forEach(function(v) {
    jsonArr.push({
      po_budget_transfer_dtl_id: v.data.id,
      c_code_ref: v.data.c_code_ref,
      po_expense_begin_id: v.data.po_expense_begin_id,
      po_expense_end_id: v.data.po_expense_end_id,
      ...
      new Ext.grid.EditorGridPanel({
        ...
        columns: [
          ...
          }),
          {
            ...
            sortable: false,
            align: "center",
            dataIndex: "po_expense_begin_id",
            width: 400,
            editor: new Ext.form.ComboBox({
              mode: "local",
              id: "editor_po_expense_begin_id",
          ...
          },
          {
            ...
            sortable: false,
            align: "center",
            dataIndex: "po_expense_end_id",
            width: 400,
            editor: new Ext.form.ComboBox({
              mode: "local",
              id: "editor_po_expense_end_id",
              store: Ext.po_expense,
              valueField: "id",
              displayField: "c_name",
              triggerAction: "all",

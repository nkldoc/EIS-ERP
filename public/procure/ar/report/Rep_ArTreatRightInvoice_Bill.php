<?php
include("../api/List_RepArTreatRightInvoice_Bill.php");
...
$caption = "ข้อมูลรายละเอียดเรียกเก็บ";
...
if (is_array($data_dtl) && count($data_dtl["data"]) > 0) {
	...
	foreach ($data_dtl["data"] as $index => $jObj) {
		...
		if ($jObj["i_type"] == 1) {
			...
			$tbody .= "<td style='" . $style . "' align='center' nowrap>" . $jObj["d_doc_date"] . "</td>";
			...
			$tbody .= "<td style='" . $style . "' align='center' nowrap>" . $jObj["d_encash_date"] . "</td>";
			...
			// GEN TBODY
			$tbody .= "<tr>";
			$tbody .= "<td colspan=11 style='" . $style . "' align='right'><b>รวมเรียกเก็บ</b></td>";

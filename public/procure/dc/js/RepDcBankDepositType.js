Ext.onReady(function() {
	...
	/*===============================================*/
	var title_panel		= "รายงานประเภทเงินฝาก";
	/*===============================================*/
	
	var store_main_all = new Ext.data.JsonStore({
	    autoDestroy: true,
		autoLoad: true,
	    url : "api/ALL_RepDcBankDepositType.php",
	    root: "data",
	...
	LookReport = function( type ) {
		...
		if( msg == "" ) {
			...
			var href		= "report/Rep_DcBankDepositType.php";
	    	var resultUrl	= "";
			
	    	resultUrl	+= "&type="+type;
	    	resultUrl	+= "&i_main="+Ext.getCmp("i_main").getValue();

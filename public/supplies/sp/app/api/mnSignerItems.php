...
$sql = "INSERT INTO sp_approval_signatures (
            sp_approval_signatures_id, sp_approval_hdr_id, signer_role, role_id,
            signature_image_path, i_is_acting_role, signer_name, sign_date,
            dc_user_sign_id, c_comment, i_enable, i_delete,
...
$params = [
    1,                      // sp_approval_signatures_id
    101,                    // sp_approval_hdr_id
    'Manager',              // signer_role
    5,                      // role_id
    'signatures/sign1.png', // signature_image_path
    0,                      // i_is_acting_role
    'John Doe',             // signer_name
    date('Y-m-d H:i:s'),    // sign_date
    10,                     // dc_user_sign_id
    'Approved',             // c_comment
    1,                      // i_enable
    2,                      // i_delete
    1001,                   // dc_user_create_id
    2001,                   // dc_user_create_cost_id
    date('Y-m-d H:i:s'),    // d_create
    1001,                   // dc_user_update_id
    2001,                   // dc_user_update_cost_id
    date('Y-m-d H:i:s')     // d_update
];

// Execute the query
//$stmt = sqlsrv_query($conn, $sql, $params);
$stmt2 = $db->QueryParam($sql2, $params);
if ($stmt === false) {

...
// -----------------------------------------------------
//
//define("__VPRODUCT_","mcot_erp-2562-01-11-00-01");	//
define("__VPRODUCT_", "mcot_erp-" . rand(0, 100000));
// บริษัท
define("COMPANY_NAME", ".:: PPP SOLUTION ::.");

define("DB_SERVER", "."); //Panda PPP  NKLFIBER 2.4 Ice 192.168.1.90 192.168.0.185
 define("DB_NAME", "NMU_ERP"); //003 //MCOT_ERP001 MCOT_ERP001 ,mcot2_20190109b

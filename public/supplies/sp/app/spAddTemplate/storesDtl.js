...
let fields_main = [
  ...
  { name: "i_purchase" },
  { name: "i_quick" },
  { name: "c_instead_dep_sign" },
  { name: "i_instead_dep_sign" },
  { name: "c_instead_cost_sign" },
  { name: "i_instead_cost_sign" },
  { name: "i_instead_main" },
  { name: "c_instead_main" },
  { name: "i_instead_sub" },
  { name: "c_instead_sub" },
  { name: "dc_position_executive_sub_id" },
  { name: "f_inv" },
  { name: "f_vat_rate" },
  { name: "f_vat" },
  { name: "f_inv_vat" },
  ...
  { name: "po_emp_id" },
  { name: "i_inside_cost" },
  { name: "i_cost_sign_out" },
  { name: "i_pdf_dtl_outside" },
  { name: "d_doc_date" },
  { name: "d_inv_date" },
  { name: "parent_id" },
  { name: "parent_c_code_ref" },
  { name: "parent_c_code_ref1" },
  { name: "d_audit_date" },
  { name: "cost_name" },
  ...
  { name: "dc_executive_id" },
  { name: "dc_executive_name" },
  { name: "dc_approve_id" },
  { name: "dc_approve_name" },
  { name: "dc_approve_id_old" },
...
Ext.storeMutiSave = new Ext.data.JsonStore({
  autoDestroy: false,
  autoLoad: false,
...
Ext.po_paymant_type = new Ext.data.JsonStore({
  autoDestroy: false,
  autoLoad: true,
  url: "api/All_PoWorkingImpHdr.php",
  baseParams: { type: "po_paymant_type" },
  root: "data",
  idProperty: "id",
  fields: ["id", "c_name"],
});

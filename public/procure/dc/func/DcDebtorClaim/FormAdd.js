const saveHdr = function(type) {
  ...
  if (Ext.getCmp("c_name").getValue() == "" || Ext.getCmp("c_name").getValue() == null) {
    msg += "<span style='white-space: nowrap;'>- กรุณากรอก ชื่อสิทธิ์การรักษา</span><br>";
  }

  if (Ext.getCmp("i_fund").getValue() == "" || Ext.getCmp("i_fund").getValue() == null) {
    msg += "<span style='white-space: nowrap;'>- กรุณาเลือก กองทุน</span><br>";
  }
  ...
  if (msg == "") {
    ...
    Ext.Ajax.request({
      ...
      params: {
        ...
        i_fund: Ext.getCmp("i_fund").getValue(),

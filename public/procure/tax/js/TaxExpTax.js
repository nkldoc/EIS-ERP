...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            title:'ข้อมูลอัตราการหักค่าใช้จ่ายทางภาษี',  
            items:[{
                    id : "frm-mode",
                    xtype : "hidden",
                    name : "mode",
...
Ext.QuickTips.init();
    var gridMain = {
        region: 'center',
        title: 'แสดงข้อมูลอัตราการหักค่าใช้จ่ายทางภาษี',
        xtype: 'grid',
        id:'tabpanel1',
        border: false,
        stripeRows: true,
        ...
        { header: "วันที่เริ่มใช้", sortable: true, align: "center", renderer:shortThaiDate, dataIndex: 'd_start' },
        { header: "อัตรา(%)", sortable: true, dataIndex: 'i_percent', align:'center' },
        { header: "วงเงินสูงสุด", sortable: true, dataIndex: 'f_exp_max',
            renderer: function(value, metaData, record, row, col, store, gridView){

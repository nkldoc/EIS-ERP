...
Ext.AppUx = function (app, menu) {
    ...
    Ext.tor_type_idTxt = Ext.apply({
        tor_type_id1: {     0: "แบบมีหัวงาน/ฝ่าย พิจารณาผล(ไม่เกิน 5 แสนบาท)"
                            , 1: "แบบมีคณะกรรมการ พิจารณาผล(เกิน 5 แสนแสนบาท)"
                    },
    });
    Ext.sp_tor_type_id = Ext.apply({
        tor_type_id1: {     1: "จัดซื้อ"
                            , 2: "จัดจ้าง"
                            , 3 : "จัดเช่า"
                    },
    });
    ...
    function winProcess(rec) {
          console.log(rec);
          console.log(rec.get("dc_creditor_id"));
        new Ext.Window({
            id: "win-processID",
            title: "ผ่านรายการ PR",
            modal: true,
            ...
            buttons: [
                {
                    ...
                    {
                        console.log(rec);
                        // rec.get("dc_tax_customer_id");
                        // return ;
                        if ( rec.get("dc_tax_customer_id") == 0 ){
                            Ext.Msg.alert("แจ้งเตือน", "ยังไม่ได้กรอกข้อมูลผู้เสียภาษี", function (bu, action) {
                                            return false;
                                        });
                        } else {
                            Ext.Ajax.request({
                                url: "tor/api/mnTorController.php",
                                params: {
                                    mode: "Update_Dc_Tax_Customer_Pdf", //UPDATE_TOR_DTL_BG
                                    sp_tor_hdr_period_id : rec.get("sp_tor_hdr_period_id"), //sp_dtl_id
                                    i_is_upload: 2,
                                },
                                method: "POST", //POST
                                success: function (result, request) {
                                    ...
                                    Ext.getCmp("win-processID").destroy(); 
                                    // Ext.getCmp("win-processID").getEl().unmask(); 
                                },
                                failure: function (result, request) {
                                    Ext.MessageBox.alert("Failed", result.responseText); // connect error
                                },
    ...
    Ext.storeDtl = new Ext.data.JsonStore({
        ...
        baseParams: {
            ...
            type_menu: 2, //ชุดสอง ผู้รับผิดชอบ 
        },
        root: "data",
        idProperty: "id",
        totalProperty: "totalCount",
    ...
    var AppPoStore = function (statuss) {
        ...
        var modeSave =( ( Ext.selectRow.get("i_type_bg") == 2 ) || (Ext.selectRow.get("i_type_bg") == 4) || (Ext.selectRow.get("i_type_bg") == 8)  )? {
            xtype: "radiogroup",
            columns: [280],
                    ...
                    items: [
                        new Ext.FormPanel({
                            ...
                            listeners:{
                                afterrender:function(){
                                        // 
                                        Ext.getCmp('dc_expense_budget_type_id').getStore().reload({
                                            callback: function (records, operation, success) { 
                                                Ext.getCmp('dc_expense_budget_type_id').fn();
                                            }
                                        });
                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    id: "sp_tor_type_idID",
                                                    name: "sp_tor_type_id",
                                                    value: Ext.selectRow.get("c_purchase"),
                                                    listeners: {
                                                        afterrender: function () {
                                                            this.fn = function () {
                                                                // Ext.getCmp('c_nameID').setValue(Ext.getCmp('c_name_hdr_id').getValue());
                                                ...
                                                },
                                                {
                                                    ...
                                                    name: "sp_c_type_contract",
                                                    value: Ext.selectRow.get("c_type_contract"),
                                                    id: "sp_c_type_contractID",
                                                    listeners: {
                                                        beforerender: function () {},
                                                        afterrender: function () {
                                                            this.fn = function () {
                                                ...
                                                },
                                                {
                                                    xtype: "textfield",
                                                    fieldLabel: "ของที่ได้มา",
                                                    name: "sp_c_product_type",
                                                    value: Ext.selectRow.get("c_product_type"),
                                                    id: "sp_c_product_typeID",
                                                    listeners: {
                                                        beforerender: function () {},
                                                        afterrender: function () {
                                                            this.fn = function () {
                                                    ...
                                                    listeners: {
                                                        beforerender: function () {
                                                            this.fn = function () {
                                                                //i_type_contract
                                                                //
                                                                // console.log(Ext.selectRow.get("i_purchase"));
                                                                // return ;
                                                ...
                                                },
                                                {
                                                    xtype: disp,
                                                    fieldLabel: "เหตุผล",
                                                    id: "delete_c_commentID", // // delete_c_comment
                                                ...
                                                },
                                                {
                                                    ...
                                                    items: [
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            text: "* วันที่ผู้รับผิดชอบงานคิดเห็นว่าควรเริ่มคิด PA",
                                                        },
                                                    ],
                                                },
                                                {
                                    ...
                                    handler: function () {
                                        ...
                                        if (Ext.getCmp("i_is_registerID").getValue().inputValue == "2" && Ext.selectRow.get("tor_hdr_dtl") == "0") {
                                            ...
                                            var formSubmit = function (form) {
                                                form.submit({
                                                    waitMsg: "Saving Data...",
                                                    params: {mode: "UPDATEDIT_TOR", i_entrance : 1},
                                                    success: function (form, action) {
                                                        Ext.Msg.alert("Success", action.result.msg, function (form, action) {
                                                            Ext.storeDtl.reload({
                                                                callback: function (record, operation, success) {
                                            ...
                                            if (form.isValid()) {
                                                if (Ext.getCmp("modesubID2").getValue().inputValue === "VIEW") {
                                                    ...
                                                    Ext.Msg.show({
                                                            title: "แจ้งเตือน!",
                                                            msg: "คุณต้องการยืนยันการแก้ไขรายการของ  "+ Ext.selectRow.data.c_code,
                                                            width: 400,
            ...
            (gridMain = function () {
                var colmnn = [
                    ...
                    },
                    {
                        ...
                        renderer: function (value, metaData, record, row, col, store, gridView) {
                            ...
                            if (record.get("i_is_register") == 0){ 
                                ...
                                BtnText = '&nbspบันทึกแล้ว';  IconImg = '../images/icons/cog_start.png';
                            }   else if (record.get("i_is_register") == 2){
                                BtnText = '&nbspบันทึกแล้ว';  IconImg = '../images/icons/application_go.png';
                            } else {
                                BtnText = '&nbspยังไม่บันทึก'; IconImg = '../images/icons/application_form.png';
                            }
                    ...
                    },
                    {
                        ...
                        hidden: true,
                        align: "left",
                        dataIndex: "c_name_status", //c_tor_type
                        width: 150,
                    },
                    {
                ...
                gridMain.superclass.constructor.call(this, {
                    ...
                    listeners: {
                        dblclick: function (dataview, index, item, e) {
                            ...
                            // window.open(linkDownload + Ext.selectRow.get("i_upload_period") + ".pdf?T=Tap_" + Math.floor(Math.random() * 100000), "Monitoring", 'fullscreen="yes"');
                            Ext.buAct = "update";

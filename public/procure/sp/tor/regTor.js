...
Ext.AppUx = function (app, menu) {
    ...
    Ext.costID = Ext.session.dc_cost_id; //หน่วยงานผู้รับผิดชอบ พัสดุ
    Ext.menuCode = "ST0001";
    ...
    Ext.loadStore = function (status, show) {
        ...
        if (statusx === "edit" && Ext.isEmpty(Ext.selectRow))
            ...
            if ((Ext.selectRow.get("i_enabled") == 1 && Ext.selectRow.get("c_code") == "") || Ext.isEmpty(Ext.selectRow.get("c_code"))) {
                Ext.getCmp("modesubgencodeID").show();
                // Ext.getCmp("modesubdelID").show();
            } else {
                Ext.getCmp("modesubgencodeID").hide();
                // Ext.getCmp("modesubdelID").hide();
            }
                                                                    ...
                                                                    items: [{
                                                                            ...
                                                                            listeners: {
                                                                                rowclick: function (grid, rowIndex, e) {
                                                                                    ...
                                                                                    Ext.getCmp("areaPrnID" + i).setValue(
                                                                                            record.get('c_code') + '|' +
                                                                                            record.get('d_doc_ref') + '|' +
                                                                                            record.get('c_name') + '|' +
                                                                                            record.get('f_total_amt')
                                                                                            );
                                                        ...
                                                        afterrender: function () {
                                                            this.fn = function (i) {
                                                                ...
                                                                if (i == 3) {
                                                                    ...
                                                                    //Ext insert
                                                                    Ext.getCmp('contenerFormID').insert(5, new Ext.Button({
...
//                                                                    Ext.getCmp("modesubID").getValue().inputValue = "";
                                                                }
                                                                Ext.getCmp('contenerFormID').doLayout();
                                                            };
                                                            Ext.getCmp('i_type_bgID').fn(this.getValue());
//                                                 
...
//                                                    
                                                ...
                                                },
                                                {
                                                    ...
                                                    listeners: {
                                                        afterrender: function () {
                                                            if (!Ext.isEmpty(Ext.selectRow)) {
                                                                if (Ext.getCmp("i_type_bgID").getValue().inputValue == 5 && Ext.selectRow.get("sp_contract_id") == "0")
                                                                    this.show();
                                                                else
                                                                    this.hide();
                                                            } else {
                                                ...
                                                },
                                                {
                                                    ...
                                                    xtype: "checkboxgroup",
                                                    fieldLabel: "มากกว่า 1 แหล่งเงิน",
                                                    name: "i_multi_bg",
                                                    id: "i_multi_bgID",
                                                    columns: 1,
                                                    items: [
                                                    ...
                                                    handler: function () {
                                                        ...
                                                        afterrender: function () {
                                                                ...
                                                                return new Ext.ButtonGroup({
                                                                    ...
                                                                    items: [
                                                                        new Ext.form.ComboBox({
                                                                            ...
                                                                            width: 400,
                                                                            submitValue: true,
                                                                            name: "dc_expense_budget_type_idTxt[" + local_i + "]",
                                                                            hiddenName: "dc_expense_budget_type_id[" + local_i + "]",
                                                                            ...
                                                                            xtype: "textfield",
                                                                            name: "f_total_amt[" + local_i + "]",
                                                                            id: "f_total[" + local_i + "]ID",
                                                                            listeners: {
                                                                                blur: function () {
                                                                                    this.fn();
                                                                                },
                                                            ...
                                                            this.fn = function () {
                                                                if (Ext.getCmp('i_multi_bgChekID').checked === true) {
                                                                    Ext.getCmp('buttonFindBgID').show();
                                                                } else {
                                                                    Ext.getCmp('buttonFindBgID').hide();
                                                                }
                                                            };
                                                            Ext.getCmp('buttonFindBgID').fn();
                                                        }
                                                ...
                                                new Ext.ButtonGroup({
                                                    ...
                                                    listeners: {
                                                        afterrender: function () {
                                                            console.log(Ext.i_bg);
                                                            console.log(Ext.arr_bg.length);
                                                        }
                                                    },
                                                    items: [
                                                        new Ext.form.ComboBox({
                                                            ...
                                                            width: 400,
                                                            submitValue: true,
                                                            name: "dc_expense_budget_type[0]_idTxt",
                                                            hiddenName: "dc_expense_budget_type[0]_id",
                                                            id: "dc_expense_budget_type[0]_idID",
                                                            valueField: "id",
                                                            displayField: "c_name",
                                                            triggerAction: "all",
                                                            forceSelection: true,
                                ...
                                new Ext.FormPanel({
                                    ...
                                    items: [
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    listeners: {
                                                        ...
                                                        afterrender: function () {
                                                            this.fn = function () {
                                                                //i_qtyID f_unit_costID f_net_total_amtID //parseFloat(this.getValue().replace(/,/g, "") / 1);
                                        ...
                                        {},
                                        {
                                         ...
                                         xtype: "displayfield",
                                         fieldLabel: "ประเภทการหัก",
                                         name: "sp_bg_mode_Name",
                                         //                                          value: Ext.bgMtype[1],
                                         id: "sp_bg_mode_NameID",
                                                ...
                                                beforerender: function () {
                                                    this.thisCick = function (grid, rowIndex, columnIndex, e) {
                                                        ...
                                                        if (columnIndex != grid.getColumnModel().getIndexById("delete")) {
                                                            ...
                                                            //                                                            Ext.getCmp("am_mode_idID").setValue(record.data.am_mode_id ? record.data.am_mode_id : null);
                                                            //                                                            Ext.getCmp("inv_mode_idID").setValue(record.data.inv_mode_id ? record.data.inv_mode_id : null);
                                                            //                                                            Ext.getCmp("sp_bg_mode_idID").setValue(record.data.sp_bg_mode_id ? record.data.sp_bg_mode_id : 1);

                                                            // Ext.getCmp("f_bg_peroidID").setValue('0.00');
                                                            Ext.getCmp("f_net_total_amtID").setValue(record.data.f_net_total_price);
                                                            //inv_mode_id am_mode_id sp_bg_mode_id  f_peroid_amt
                                                            ...
                                                            // Ext.getCmp("tabpanelMain4ID").setHeight(474);
                            ...
                            bbar: [
                                {
                                    ...
                                    handler: function () {
                                        if (Ext.getCmp("modeSub2ID").getValue() == "ADD") {
                                            ...
                                            //Ext.MessageBox.alert("แจ้งเตือน", "ต้องตรวจสอบเงินจองอีกครั้ง");
                                            Ext.getCmp("modeSub2ID").setValue("ADD");
                                        }
                                    },
                                },
            ...
            (gridMain = function () {
                var colmnn = [
                    ...
                    /*  {
                     ...
                     var BtnText = "<img src='../images/icons/application_go.png' style='margin-right:1px;' /><div><spen style='font-size:11px'>&nbspผ่านรายการแล้ว</spen>";                                    
                     } else   if(Ext.isEmpty(record.get("c_code")) && record.get("tor_status_id") == null){
                     var BtnText = "<img src='../images/icons/application_form.png' style='margin-right:1px;' /><div><spen style='font-size:11px'>&nbspบันทึกแล้ว</spen>";
                     } else {

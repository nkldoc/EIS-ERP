...
$i_type_emp = $_SESSION["i_type_emp"];
            ...
            <div class="container-xl"> 
                <div style="width:600px;">
                    ...
                    <div class="x-box-ml"><div class="x-box-mr"><div class="x-box-mc">
                                ...
                                <input type="text" size="40" name="search" id="searchID" />
                ...
                <div id="group11" class="app-card app-card-accordion shadow-sm mb-4"  style="display:none;">
                    <div class="app-card-header p-4 pb-2  border-0">
                        ...
                        <h4 class="app-card-title" id="ttg1"><?= $g1["name"] . " " ?></h4> 
                    ...
                    <div class="app-card-body p-4 pt-0">
                        <div id="faq1-accordion" class="faq1-accordion faq-accordion accordion">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faq1-heading-5" style="padding-left:30px;">
                                    ...
                                    <button class="accordion-button btn btn-link" type="button" id="c_contract_noID"> 
                                        1. รายการที่ทำรายการส่งสัญญา ERP
                                    </button> 
                                    <button class="accordion-button btn btn-link" type="button" id="receiveID"> 
                                        2. รายการที่ทำรายการรับของจาก ERP
                                    </button>
                                    <button class="accordion-button btn btn-link" type="button"id="close_contractID"> 
                                        3. รายการที่ทำรายการปิดสัญญา ERP
                                    </button>
                                </h2>
    ...
    Ext.onReady(function () {
            ...
            new Ext.Window({
                ...
                listeners: {
                    ...
                    afterrender: function (win) {
                        ...
                        Ext.getCmp("proProcesID").update('<iframe src="../sp/contractErp.php?" frameborder="0" width="100%" height="100%"></iframe>');
                    }
                }
            });
        ...
        Ext.resultContract = function () {
            new Ext.Window({
                id: 'proProcesID',
                height: Ext.getBody().getViewSize().height,
                width: Ext.getBody().getViewSize().width - 10, //80%
                modal: true,
                plain: true,
                layout: "fit",
//                maximizable: true,
...
//        Chat.initialize();
        ...
        //1
        document.getElementById('c_contract_noID').onclick = function (e) {
                            Ext.EventObject.stopEvent();
                            Ext.newPr();
...
//                Ext.Msg.alert("แจ้งเตือนจากระบบ", "View Status", function (form, action) {  }); 
        ...
        var search = new Ext.form.ComboBox({
            ...
            onSelect: function (record) { // override default onSelect to do redirect
                window.location = String.format('./api/All.php?t={0}&p={1}', record.data.topicId, record.id);
            }
        });
    });
</script>

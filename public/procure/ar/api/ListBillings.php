...
if(isset($_REQUEST['mode']) && $_REQUEST['mode']=="SEARCH")
{
        ...
        $wh = " "
                . "isnull({$table}.i_no_order,0)=0 and isnull({$table}.i_parent,0)=0 " 
        ...
        $wh = " isnull({$table}.i_no_order,0)=0 and isnull({$table}.i_parent,0)=0 and ISNULL({$table}.i_enable,".STATUS_DISABLE.") =?"; // Search No Enable = 1  

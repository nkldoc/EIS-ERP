Ext.onReady(function() {
	...
	/*===============================================*/
	var title_panel	= "ธนาคาร";
	/*===============================================*/
	var store = new Ext.data.JsonStore({
		storeId: "myStore",
	    autoDestroy: true,
		autoLoad: true,
	    url : "api/List_DcBank.php",
	    root: "data",
	...
	var gridMain = new Ext.grid.GridPanel({
		...
		columns: [
			...
			{ header: "ชื่อย่อธนาคาร", sortable: true, dataIndex: "name_shot" },
			{ id: "c_name", header: "ชื่อธนาคาร", sortable: true, dataIndex: "c_name" },
			{ header: "สถานะธนาคารหลัก", sortable: true, width: 200, align: "center", dataIndex: "c_main" },
        ...
        items: [{
			...
			items: [{
				...
				items: [{
					...
					items: [{
		    			...
		    			mode: "local",
		    			triggerAction: "all",
		    			emptyText: "- กรุณาเลือกสถานะธนาคารหลัก -",
						forceSelection: true,
						selectOnFocus: true
					}, {
						xtype: "checkbox",
			...
			buttons: [{
				...
				handler: function() {
					...
					if(Ext.getCmp("c_name").getValue() == "")	{ msg	+= "- กรุณากรอกชื่อธนาคาร<br>"; }
					if(i_main == "" || i_main == null) {
						msg	+= "- กรุณาเลือกสถานะธนาคารหลัก<br>";
					}
					...
					if (msg == "") {
						...
						Ext.Ajax.request({
							...
							params : { 
								...
								name_shot: Ext.getCmp("name_shot").getValue(),

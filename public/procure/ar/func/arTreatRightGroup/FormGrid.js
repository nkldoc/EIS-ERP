Ext.onReady(function () {
  Ext.QuickTips.init();
  /*===============================================*/
  Ext.title_panel = "กลุ่มสิทธิ์การรักษา";
  /*===============================================*/
  // pagingBar
      ...
      buttons: [
        {
          ...
          handler: function () {
            ...
            Ext.Ajax.request({
              url: "api/mn_arTreatRightGroup.php",
              method: "POST",
              params: {
                mode: mode,
                id: id,
  ...
  const gridMain = new Ext.grid.GridPanel({
            ...
            items: [
              ...
              { xtype: "tbspacer", width: 4 },
              {
                ...
                store: new Ext.data.SimpleStore({
                  fields: ["value", "text"],
                  data: [["c_name", "กลุ่มสิทธิ์การรักษา"]],
                }),
                value: "c_name",
                valueField: "value",
                displayField: "text",
    ...
    columns: [
      ...
      {
        id: "c_name",
        header: "ชื่อกลุ่มสิทธิ์การรักษา",
        sortable: false,
        align: "center",
        dataIndex: "c_name",
      ...
      {
        header: "ผังบัญชีเรียกเก็บ",
        sortable: true,
        align: "center",
        width: 400,
        dataIndex: "dc_acc_name",
        renderer: function (value, metaData, record, rowIndex, colIndex, store) {
          metaData.attr = "style='text-align: left;'";
          return value;
        },

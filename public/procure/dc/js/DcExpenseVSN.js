...
searchGrid = function() {
    var filters = {
        ...
        store: new Ext.data.SimpleStore({
            fields: ["id", "c_name"],  
            data:[['c_name', "หมวดรายจ่ายย่อย"],['c_code', "รหัส"]],
        }),
        value: 'c_name',
        valueField: 'id',
        displayField: 'c_name',
...
Ext.store = new Ext.data.JsonStore({
    ...
    fields: [
        ...
        {name:'txtdc_expense_group_vsn_idID'},
        {name:'c_code'},
        {name:'c_name'},  
		{name:'c_name_trim'},
        {name:'dc_acc_id'}, 
...
Ext.storeExpenseGroupVisionNet = new Ext.data.JsonStore({ 
    storeId: 'myStore1', 
    autoLoad: true,
    url : 'api/All_DcCombo.php',
    root: 'data',
    baseParams: { type : 'storeExpenseGroupVisionNet' }, //Permission i_read
    idProperty: 'id',
    totalProperty: 'totalCount', 
...
Ext.PopExpenseGroupForm = new Ext.ux.Poplov({ 
    text		: 'หมวดรายจ่าย Vision Net',  
    id			: 'dc_expense_group_vsn_idID',	//go to relation     dc_expense_group_vsn_id	
    iconCls		: 'page_magnify', 
    valueHidden : 'dc_expense_group_vsn_id', 	//go to hidden
    store		: Ext.storeExpenseGroupVisionNet,
    headerGrid	: columnMini,
    widthText	: 280,  
    fieldLabel	: 'หมวดรายจ่าย  Vision Net'
}); 
...
Ext.onReady(function(){
    ...
    var gridMain = {
        region: 'center',
        title: 'แสดงข้อมูลหมวดรายจ่ายย่อย',
        xtype: 'grid',
        id:'tabpanel1',
        border: false,
        stripeRows: true,
        ...
        columns:[
			...
			{ id: 'c_name', header: "หมวดรายจ่ายย่อย", width:400, sortable: true, dataIndex: 'c_name' },  
            {
                header: "Status",  
                sortable:false,
                align: 'center',

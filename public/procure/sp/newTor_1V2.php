...
<?php include("../lib/loadCss.php"); ?>
        ...
        <script type="text/javascript" src="./tor/regTorFormGridDtl.js?_dc=<?= __VPRODUCT_; ?>"></script>
        <script type="text/javascript" src="./tor/regTor_1V2.js?_dc=<?= __VPRODUCT_; ?>"></script>
    </head>

...
if ($type == "po_working_dtl1") {
    ...
    $sqlMain = "
		...
		SELECT
            ...
            (SELECT dc_budget_type_id FROM NMU_EIS..bg_reserve_money WHERE bg_reserve_money_id = c.bg_reserve_money2_id) AS dc_expense_budget_type_id2_po,
            (SELECT dc_budget_type_id FROM NMU_EIS..bg_reserve_money WHERE bg_reserve_money_id = c.bg_reserve_money3_id) AS dc_expense_budget_type_id3_po,

Ext.onReady(function() {
	...
	/*===============================================*/
  	var title_panel		= "งบแสดงผลการดำเนินงาน  (ช่วงเวลา)";
	/*===============================================*/
 ...
 //   var store_dc_acc	= StoreJson('../api/All_GlRep00003.php', 'dc_acc');

 	var store_dc_acc	= new Ext.data.JsonStore({
		autoLoad: true,
 		url: "api/All_GlRep00003.php",
		...
		if( Ext.getCmp("s_dc_cost_id").getValue() == "" ) { msg	+= "- กรุณาเลือกศูนย์ต้นทุนทางบัญชี<br>"; }
 		if ((the_i_show==true) && (Ext.getCmp("s_dc_acc_id").getValue()=="") ) { msg	+= "- กรุณาเลือกรหัสบัญชี<br>"; }
  		...
  		if( msg == "" ) {
			...
			var href		= "report/Rep_GlRep00003.php";
	    	var resultUrl	= "";

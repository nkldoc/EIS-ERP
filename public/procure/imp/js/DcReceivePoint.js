...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: 'ชื่อจุดรับเงิน',
                    name : 'c_name',
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบะ ชื่อจุดรับเงิน ";
                        }
                    }
                },{
                    xtype: 'textarea',
...
Ext.store = new Ext.data.JsonStore({
    ...
    autoDestroy: true,
    autoLoad: true,
    url : 'api/ListDcReceivePoint.php',
    root: 'data',
...
Ext.QuickTips.init();
        var gridMain = {
                ...
                { id: 'c_name', header: "ชื่อจุดรับเงิน", width:210, sortable: true, dataIndex: 'c_name' }, 
                {
                        header: "Status",  
                        sortable:false,
                        align: 'center',

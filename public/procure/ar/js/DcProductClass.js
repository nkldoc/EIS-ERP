...
Ext.QuickTips.init();
    ...
    autoDestroy: true,
	autoLoad: true,
    url : 'api/ListDcProductClass.php',
    root: 'data',
	...
	var gridMain = {
		...
		tbar: [{	
                ...
                store     : new Ext.data.SimpleStore({
							  ...
							  data: [
								[ 'c_code', "รหัส" ],
								[ 'c_ref_doc', "รหัสใบวางบิล/ใบแจ้งหนี้" ],
			...
			,' ', '-', {
				...
				handler : function() {  
					...
					{ id: 'c_name', header: "ชื่อหน่วยเงิน", sortable: true, dataIndex: 'c_name' },
	...
	var panelForm = {
        ...
        items: [
		{
			...
			items: [{
				...
				fieldLabel: 'รหัสใบวางบิล/ใบแจ้งหนี้',
				xtype: 'textfield',
				name: 'c_ref_doc',
	        	validator: function(val) {
	        		if (!Ext.isEmpty(val)) {
	        			...
	        			return "กรุณากรอก รหัสใบวางบิล/ใบแจ้งหนี้";
	        		}
	        	},
			}, {

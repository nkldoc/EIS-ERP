...
if (is_array($data_dtl) && count($data_dtl["data"]) > 0) {
	...
	foreach ($data_dtl["data"] as $index => $jObj) {
		if ($jObj["i_type"] == 2) {
			...
			$tbody .= "<td colspan=12 align='right'><b>" . $jObj["treat_right_name"] . "</b></td>";
			$tbody .= "<td align='right' nowrap><b>" . number_format($jObj["f_cut"], 2)  . "</b></td>";
			...
			// GEN TBODY
			$tbody .= "<tr style='" . $style . "'>";
			$tbody .= "<td colspan=12 align='right'><b>รวมใบตัดชำระ {$jObj["c_code_cut"]}</b></td>";
			$tbody .= "<td align='right' nowrap><b>" . number_format($jObj["f_cut"], 2)  . "</b></td>";
			$tbody .= "<td align='right' nowrap></td>";
			$tbody .= "</tr>";
			...
			// GEN TBODY
			$tbody .= "<tr style='" . $style . "'>";
			$tbody .= "<td colspan=12 align='right'><b>รวมทั้งสิ้น</b></td>";
			$tbody .= "<td align='right' nowrap><b>" . number_format($jObj["f_cut"], 2)  . "</b></td>";
			$tbody .= "<td align='right' nowrap></td>";
			$tbody .= "</tr>";
		} else if ($jObj["i_adjust"] == 0) {
			$style = "";
			// GEN TBODY
			$tbody .= "<tr style='" . $style . "'>";
			$tbody .= "<td align='center' nowrap>" . $jObj["numrow"] . "</td>";
			$tbody .= "<td align='center' nowrap>" . $jObj["debtor_type_name"] . "</td>";
			$tbody .= "<td align='center' nowrap>" . $jObj["treat_right_name"] . "</td>";
			$tbody .= "<td align='center' nowrap>" . $jObj["cost_name"] . "</td>";
			$tbody .= "<td align='center' nowrap>" . $jObj["c_code_bill"] . "</td>";
			$tbody .= "<td align='center' nowrap>" . $jObj["c_code_cut"] . "</td>";
			$tbody .= "<td align='center' nowrap>" . $jObj["d_cut_date"] . "</td>";
			...
			$tbody .= "<td align='right' nowrap>" . number_format($jObj["f_cut"], 2)  . "</td>";
			...
			// GEN TBODY
			$tbody .= "<tr style='" . $style . "'>";
			$tbody .= "<td align='right' nowrap colspan=12>รับเพิ่ม/คืนเงิน</td>";
			$tbody .= "<td align='right' nowrap>" . number_format($jObj["f_cut"], 2)  . "</td>";
			$tbody .= "<td align='center' nowrap>" . $jObj["lastdate"] . "</td>";
			$tbody .= "</tr>";
		}

...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'combo',
                    fieldLabel: 'ชนิดบัญชีภาษีซื้อยังไม่ถึงกำหนด',
                    store: Ext.storeDcAccIncome,
                    //width: 300,
                    valueField: 'id',
                    displayField: 'c_code_name',
                    submitValue : true,
                    //disabled:true,
                    hiddenName : 'dc_acc_income_id',
                    mode: "local",
                    triggerAction: "all",
                    ...
                    validator: function(val) {
                        ...
                        if (!Ext.isEmpty(val)){
                            ...
                            return "กรุณาเลือกบัญชีภาษีซื้อยังไม่ถึงกำหนด";
                        }
                    }
                },{
                    xtype: 'textarea',
...
Ext.storeDcAccIncome = new Ext.data.JsonStore({
    //autoDestroy: true,
    autoLoad: true,
    url: 'api/All_TaxCombo.php',
    baseParams: {type : 'storeDcAcc', i_condi:2, limit:2000},
    root: 'data',
    idProperty: 'id',
    fields: [ 'id', 'c_name', 'c_code_name']
});
...
Ext.QuickTips.init();
    var gridMain = {
        region: 'center',
        title: 'แสดงข้อมูลภาษีมูลค่าเพิ่ม',
        xtype: 'grid',
        id:'tabpanel1',
        border: false,
        stripeRows: true,
        ...
        { id: 'c_name', header: "อัตราภาษี %", width:120, sortable: true, dataIndex: 'f_vat_rate',
            renderer: function(value, metaData, record, rowIndex, colIndex, store) {

...
Ext.QuickTips.init();
	...
	var gridMain = {
		region: 'center',
		title: 'แสดงข้อมูลหมวดของการประกันภัย',
		xtype: 'grid',
		id:'tabpanel1',
		border: false,
		stripeRows: true,
		...
		tbar: [{	
			...
			,' ', '-', {
				...
				handler : function() {  
					...
					{ id: 'c_name', header: "หมวดประกันภัย ", sortable: true, dataIndex: 'c_name' },
					{
						header: "Status",  
						sortable:false,
						align: 'center',
	...
	var panelForm = {
		region: 'center',
		title: 'ข้อมูลหมวดของการประกันภัย',
		xtype: 'panel',
		id:'tabpanel2',
		border: false,
		disabled: true,

...
<?php include("../lib/loadCss.php"); ?>
        ...
        .x-form-display-field{ padding:2px; }
        .topAlign{ color:blue !important; border-bottom:1px solid #ccc;}
        input.fqty{ width:80%; }

        .bnt-null{ padding:2px; }
        label[for^="bbf"]
        {
...
//------------------------------------------------------------------------------
        ...
        <script type="text/javascript" src="./tor/editContract.js"></script>

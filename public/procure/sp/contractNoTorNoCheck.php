...
<head>
    ...
    <script type="text/javascript" src="./tor/contractNoTorUiNoCheck.js?_dc=<?= __VPRODUCT_; ?>"></script>
    <!--<script type="text/javascript" src="./tor/contractNoTor.js?_dc=<?= __VPRODUCT_; ?>"></script>-->
    <script type="text/javascript" src="./tor/contractNoTorNoCheck.js?_dc=<?= __VPRODUCT_; ?>"></script>

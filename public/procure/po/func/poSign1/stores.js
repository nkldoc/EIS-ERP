...
Ext.storeSign = new Ext.data.JsonStore({
  ...
  idProperty: "id",
  totalProperty: "totalCount",
  fields: [{ name: "no" }, { name: "id" }, { name: "budget_name" }, { name: "c_code" }, { name: "c_approve" }, { name: "d_doc_date" }, { name: "expense_name" }, { name: "c_creditor" }, { name: "f_total" }]
});

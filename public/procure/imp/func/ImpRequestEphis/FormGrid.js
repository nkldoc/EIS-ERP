Ext.onReady(function() {
  ...
  let myComboStores = [Ext.dc_expense_budget_type_all, Ext.dc_expense_budget_type, Ext.dc_expense_group_vsn, Ext.dc_expense_acc_vsn_full,Ext.gl_dc_config_creditor,Ext.store_dc_creditor];

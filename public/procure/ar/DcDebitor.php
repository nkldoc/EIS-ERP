...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php 
		...
		echo "Ext.AR_CLASS_TYPE_JOIN				= ".AR_CLASS_TYPE_JOIN."; //รายได้จากการร่วมดำเนินกิจการ  \r\n";
		//
		echo "Ext.CNT_TYPE1							= ".AR_CONTACT_PERSONAL_TYPE1.";  //1=ลูกหนี้  \r\n";
		echo "Ext.CNT_TYPE2							= ".AR_CONTACT_PERSONAL_TYPE2." // 2=ลูกหนี้/เจ้าหนี้ \r\n"; 
		echo "Ext.CNT_TYPE3							= ".AR_CONTACT_PERSONAL_TYPE3."; //3=เจ้าหนี้   \r\n";
 
		?>
	</script>
	<script type="text/javascript" src="js/DcDebitor.js?_dc=<?php echo rand(0,100000); ?>"></script>
	<style> #ext-comp-1080{ color:red; } </style>
</head>
<body>
</body>
</html>
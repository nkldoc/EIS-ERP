...
switch ($mode) {
    case "ADD" : 
        ...
        $arrParam[] = $data["dc_expense_group_id"];
		...
		$arrParam[] = $data["dc_expense_sub_group_id"];
		$arrParam[] = $data["dc_acc_id"];
...
// 		$arrParam[] = ($data["dc_acc_id_overlap"]=="" || $data["dc_acc_id_overlap"]=="0") ? $data["dc_acc_id"] : $data["dc_acc_id_overlap"];
        ...
        $sql = "insert into {$table} (c_name, dc_expense_group_id, dc_acc_id
                                        ...
                                        ,i_delete,c_name_trim,dc_expense_sub_group_id,dc_acc_id_overlap)
                                values (? ,? , ?
                                          , ?, ?, ?, ?
                                          , ?, ?, ?
                                          , ?, ?, ?

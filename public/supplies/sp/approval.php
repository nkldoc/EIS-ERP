...
// --------config ---------------------------------------------------------------
            Ext.loadConfig = ()=> {
                Ext.Ajax.request({
                    url: '/supplies/approval/conf/config.json',
                    method: 'GET',
        ...
        <script type="text/javascript" src="./tor/torUiApproval.js?_dc=<?= __VPRODUCT_; ?>"></script>
        <script type="text/javascript" src="./tor/approval.js?_dc=<?= __VPRODUCT_; ?>"></script> 

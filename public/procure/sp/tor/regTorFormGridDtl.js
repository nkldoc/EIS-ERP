...
formPanelDtl = function (args,store) {
  formPanelDtl.superclass.constructor.call(this, {
    ...
    loadMask: true,
    items: [
      new Ext.grid.GridPanel({   //EditorGridPanel
        id: "gridEditor",
        region: "center",
        layout: "fit",
        height: 400,
        ...
        columns: [
          ...
          },
          {
            ...
            renderer: function (value, metaData, record, rowIndex, colIndex, store) {
              var BtnText = "<img src='../images/icons/page_white_acrobat.png' style='margin-right:1px;' /><div><spen style='font-size:11px; color: green;'>&nbsp<b>" + record.data.c_code_d + "</b>&nbsp</spen>";

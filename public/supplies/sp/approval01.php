...
//print_r($_SESSION['dc_emp_id'], $return);
//exit();
?>
...
APSTEPS50
     */        
            Ext.status_sigature_document = 'APSTEPS11'; //APSTEPS[10-50]s
            Ext.step_sign_emp = 'APSTEPS20'; //APSTEPS[10-50]s 
            Ext.title = "พนักงานผู้ดำเนินการ ลงนามตรวจสอบ";
            Ext.GLOBAL_BU_SAVE_TH ="บันทึกการลง ลงนาม";
            //
            Ext.keyData = 1;
            Ext.menu_i_alarm = 1;
            Ext.menu_i_day = 1;

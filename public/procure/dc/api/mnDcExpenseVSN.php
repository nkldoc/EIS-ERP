...
$mode		= $_REQUEST["mode"];
$table 		= "dc_expense_vsn";
$keyName 	= "dc_expense_vsn_id";
...
switch ($mode) {
    case "ADD" : 
        ...
        $arrParam[] = $data["dc_expense_group_vsn_id"];
        ...
        $sql = "insert into {$table} (c_name, dc_expense_group_vsn_id

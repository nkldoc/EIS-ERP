Ext.onReady(function() {
	...
	/* =============================================== */
	if(bank_month == true) {
		var title_panel = "รายงานBank Statement (รายเดือน)";
	} else {
		var title_panel = "รายงานBank Statement";
	}
	/* =============================================== */
	...
	LookReport = function(type) {
		...
		if (Ext.getCmp("dc_bank_id").getValue() == "") { msg += "- กรุณาเลือกธนาคาร<br>"; }
		if (Ext.getCmp("dc_bank_acc_company_id").getValue() == "") { msg += "- กรุณาเลือกเลขที่บัญชี<br>"; }

		if (msg == "") {

			var href = "report/Rep_RepBankStatement.php";
			var resultUrl = "";

Ext.onReady(function () {
  ...
  /* =============================================== */
  title_panel = "รายงานจองงบปนะมาณ(เงินคงเหลือ)";
  /* =============================================== */
  ...
  LookReport = function (type) {
    ...
    if (msg == "") {
      href = "report/BiExpenseBudget.php";
      ...
      resultUrl += "&dc_expense_budget_type_id=" + dc_expense_budget_type_id;
        ...
        buttons: [
          {
            ...
            handler: function () {
              // console.log(Ext.getCmp("i_expense").getValue().inputValue);
              LookReport("html");
            }, // End Handle
          },
          {

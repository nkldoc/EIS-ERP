...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: 'ชื่อหน่วยเงิน',
                    name : 'c_name',
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบุ ชื่อหน่วยเงิน ";
                        }
                    }
                },{
                    xtype: 'textfield',
...
searchGrid = function() {
    ...
    var cmbFilters = {
                    ...
                    store: new Ext.data.SimpleStore({
                        fields: ["id", "c_name"],  
                        data:[['c_name', "ชื่อหน่วยเงิน"],['c_code', "รหัสหน่วยเงิน"]]
                    }),
                    value: 'c_name',
                    valueField: 'id',
                    displayField: 'c_name',
...
Ext.QuickTips.init();
        var gridMain = {
                ...
                { id: 'c_name', header: "ชื่อหน่วยเงิน", width:210, sortable: true, dataIndex: 'c_name' }, 
                {
                        header: "Status",  
                        sortable:false,
                        align: 'center',

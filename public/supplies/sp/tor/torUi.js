            ...
            success: function (result, request) {
                ...
                if (jsonData.success) {
                    Ext.storeDtl.reload({callback: function (record, operation, success) {
                            Ext.getCmp('button' + i).setDisabled(true);
                        }});
                } else {
                            ...
                            listeners: {
                                afterrender: function () {
                                    ...
                                    if (statusx == 'reverse') {
                                        ...
                                        var selectedId = selectedRow && selectedRow.data ? selectedRow.data.id : null;
...
//                                        hidden: Ext.displayMenuId,
    ...
    Ext.returnMenu = new Ext.data.JsonStore({
        autoDestroy: false,
        autoLoad: true,
        url: "tor/api/mnTorController.php",
        baseParams: {
            type: "list", mode: "ALL_STATUS_MENU",
        },
        root: "data",
        idProperty: "id",
        fields: ["id", "c_name"],

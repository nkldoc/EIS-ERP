...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <script type="text/javascript">
            ...
            Ext.status_sigature_document = 'APSTEPS20'; //APSTEPS[10-50]s
            Ext.step_sign_emp = 'APSTEPS30'; //APSTEPS[10-50]s 
            Ext.title = "หัวหน้าพัสดุ ลงนามตรวจสอบ";
            //
            Ext.keyData = 1;
            Ext.menu_i_alarm = 1;
            Ext.menu_i_day = 1;
     ...
     <!--Doument Sing--> 
        <script type="text/javascript" src="app/spDocAppSign/stores.js?_dc=<?= __VPRODUCT_; ?>"></script>        
        <script type="text/javascript" src="app/spDocAppSign/FormGrid.js?_dc=<?= __VPRODUCT_; ?>"></script> 
        <script type="text/javascript" src="app/spDocAppSign/FormAdd.js?_dc=<?= __VPRODUCT_; ?>"></script>
        <script type="text/javascript" src="app/spDocAppSign/FormGridDtl.js?_dc=<?= __VPRODUCT_; ?>"></script>
        <script type="text/javascript" src="app/spDocAppSign/FormAddDtl.js?_dc=<?= __VPRODUCT_; ?>"></script>
    </head>

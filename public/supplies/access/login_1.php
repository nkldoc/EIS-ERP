...
//    $session->put("DOMAIN", $_SESSION["DOMAIN"]);
//    $session->put("DOMAIN_NAME", $_SESSION["DOMAIN_NAME"]);
//    $session->put("user_id", $_SESSION["user_id"]); 
...
//    $session->put("created", $_SESSION["created"]);       

...
<head>
    <meta charset="UTF-8">
    <title>PDF Viewer with Addable Text, Underline and Undo</title>
...
<body>
    <h2>📌 คลิก PDF → ขีดเส้นใต้ ➕ เพิ่มข้อความ ↩️ Undo 📤 ส่งข้อมูล</h2>
    ...
    <div id="position"></div>
    <div>
        <button id="submitArrayID">📤 ส่ง Multi Array Json</button>
    ...
    <script>
        ...
        // คลิกเพื่อขีดเส้นใต้ชั่วคราว + แสดงข้อความ
        ...
        document.getElementById("undo-button").addEventListener("click", function () {
            const currentPage = parseInt(pageNumInput.value);

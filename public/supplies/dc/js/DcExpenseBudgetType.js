      ...
      buttons: [
        {
          ...
          handler: function() {
            Ext.Ajax.request({
              url: "api/mnDcExpenseBudgetType.php",
              params: {
                mode: "DELETE",
                id: record.get("id")
              },
...
Ext.store = new Ext.data.JsonStore({
  ...
  autoDestroy: true,
  autoLoad: true,
  url: "api/ListDcExpenseBudgetType.php",
  root: "data",
...
Ext.onReady(function() {
  ...
  var gridMain = {
    ...
    columns: [
      ...
      { id: "c_name", header: "ประเภทเงิน", width: 350, sortable: true, dataIndex: "c_name" },
      {
        header: "Status",
        sortable: false,
        align: "center",

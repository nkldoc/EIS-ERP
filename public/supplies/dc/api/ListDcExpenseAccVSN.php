...
$sqlTempTable = "select dc_expense_acc_vsn_id 
                        , dc_expense_vsn_id
                        , (select top 1 c_code+' '+c_name from dc_expense_vsn where dc_expense_vsn_id={$table}.dc_expense_vsn_id) as expense_vsn_name
                        , c_code 
                        , c_name
                        , c_name_trim
...
while($row =$db->Fetch($stmt))				
{
    $temp = array("no" => ($i++), 
                    ...
                    "txtdc_expense_vsn_idID"	=> $row["expense_vsn_name"], 
                    "c_code" 					=> $row["c_code"],
                    "c_name" 					=> $row["c_name"], 

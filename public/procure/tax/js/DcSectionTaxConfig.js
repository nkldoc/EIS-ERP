    ...
    if(butt=='add'){  
        ...
        var win = new Ext.Window({
            ...
            buttons : [{
                        ...
                        handler : function() {
                            Ext.Ajax.request({
                                url : 'api/mnDcSectionTaxConfig.php' , 
                                params : { 
                                        mode : 'DELETE', 
                                        id : record.get('id'),
                                }, 
...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'combo',
                    fieldLabel: 'มาตราภาษี',
                    id: 'frm-dc_section_tax_id',
                    store: Ext.storeDcSectionTax,
                    valueField: 'id',
                    displayField: 'c_name',
                    submitValue : true,
...
Ext.store = new Ext.data.JsonStore({
    ...
    autoDestroy: true,
    autoLoad: true,
    url : 'api/ListDcSectionTaxConfig.php',
    root: 'data',
...
Ext.storeDcSectionTax = new Ext.data.JsonStore({
    //autoDestroy: true,
    autoLoad: true,
    url: 'api/All_TaxCombo.php',
    baseParams: {type : 'storeDcSectionTax'},
    root: 'data',
    idProperty: 'id',
    fields: [ 'id', 'c_name']
});
...
Ext.QuickTips.init();
    var gridMain = {
        region: 'center',
        title: 'แสดงข้อมูลภาษีบุคคลภายใน',
        xtype: 'grid',
        id:'tabpanel1',
        border: false,
        stripeRows: true,
        ...
        { header: "มาตรา", width:300, sortable: true, dataIndex: 'c_name' }, 
        { header: "คำอธิบาย", width:300, sortable: true, dataIndex: 'c_comment' }, 
        {
            header: "Status",  
            sortable:false,
            align: 'center',

...
Ext.onReady(function () {
    Ext.QuickTips.init();
    Ext.idRep = "frm-repOverlap";

    //Spring Boot cross context
    Ext.urlReport1 = 1 ? "https://eis.nmu.ac.th:8443/reports/repOverlap" : "https://eis.nmu.ac.th:8443/reports/printr.php?get=true"; //DEBUG 
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    ...
                                    {xtype: "hidden", name: "jasperName", value: "repOverlap"},
                                    ...
                                    {
                                        xtype: "radiogroup",
                                        columns: [100, 100, 50, 50],
                                        fieldLabel: "ยืนยันกันเหลื่อม",
                                        id: "CfOverlapID",
                                        name: "CfOverlap",
                                        items: [
                                            {

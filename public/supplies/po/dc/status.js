...
Ext.mnController = 'dc/controller/mnDcStatus.php';
Ext.DAO = 'dc/DAO/ListDcStatus.php';
Ext.title = 'ข้อมูลสถานะของการดำเนินงาน';
      ...
      var MenuButton = function () {
          ...
          var combo = new Ext.form.ComboBox ( {
              store : new Ext.data.SimpleStore ( {
                  fields : [ "id" , "c_name" ] ,
                  data : [ [ 'c_name' , "ชื่อสถานะการดำเนินงาน" ] , [ 'c_code' , "รหัสสถานะการดำเนินงาน" ] ]
              } ) ,
              value : 'c_name' ,
              valueField : 'id' ,
              displayField : 'c_name' ,
              ...
              items : [ combo , // A Field in a Menu
                  {
                      ...
                      text : 'ข้อมูลหลัก ระบบลงทะเบียนการเบิกจ่าย' ,
                      menu : {

...
if($_REQUEST["type"] == "gl_rep_acc_hdr") {
	...
	$sqlMain	= "	SELECT * FROM gl_rep_acc_hdr WHERE i_enable=? AND i_delete=? AND i_level_dtl=2 ORDER BY c_name;";
	...
	$sqlMain	= "	SELECT
					...
					FROM gl_rep_acc_dtl a
						LEFT JOIN gl_rep_acc_map b ON a.gl_rep_acc_dtl_id = b.gl_rep_acc_dtl_id
					WHERE b.gl_rep_acc_dtl_id IS NULL
						AND gl_rep_acc_hdr_id = ?
					ORDER BY c_name;";

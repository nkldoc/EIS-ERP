              ...
              buttons: [
                  {
                      ...
                      handler: function () {
                          var msg = "";
                              ...
                              if ([null,'',0,0.00,'0.00'].includes(Ext.getCmp("f_total_averageID").getValue())) {
          ...
          beforerender: function (g) {
            ...
            this.contextMenu = new Ext.menu.Menu({
              items: [
                ...
                // },
                 {
                   ...
                   handler: function (e) {
                       ...
                       console.log(grid.getTopToolbar());
                     if (grid.getTopToolbar()) {
                         grid.getTopToolbar().show();
                     }else{
                ...
                {
                   text: "แสดงหน้าจอ",
                   icon: "../images/icons/application_xp_terminal.png",
                   handler: function (e) {
                        requestFullScreen();
                   },
                   scope: this,

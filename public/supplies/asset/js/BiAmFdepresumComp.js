Ext.onReady(function () {
  ...
  /* =============================================== */
  title_panel = "รายงานภาพรวมสินทรัพย์เปรียบเทียบระหว่างปี";
  /* =============================================== */
  ...
  LookReport = function (type) {
    ...
    if (msg == "") {
      href = "report/Bi_AmFdepresumComp.php";
      var resultUrl = "";
      resultUrl += "&type=" + type;
      resultUrl += "&i_year1=" + Ext.getCmp("i_year1").getValue();
      resultUrl += "&i_year2=" + Ext.getCmp("i_year2").getValue();

...
const saveDtl = function(mode) {
  ...
  sto.forEach(function(v) {
    jsonArr.push({
      bg_budget_dtl_transfer_id: v.data.id,
      c_code_ref: v.data.c_code_ref,
      bg_expense_begin_id: v.data.bg_expense_begin_id,
      bg_expense_end_id: v.data.bg_expense_end_id,
    ...
    items: [
      new Ext.grid.EditorGridPanel({
        ...
        columns: [
          ...
          {
            header: "รายจ่ายย่อย<br>(ต้นทาง)",
            sortable: false,
            align: "center",
            dataIndex: "bg_expense_begin_id",
            width: 400,
            editor: new Ext.form.ComboBox({
              mode: "local",
              id: "editor_bg_expense_begin_id",
          ...
          {
            header: "รายจ่ายย่อย<br>(ปลายทาง)",
            sortable: false,
            align: "center",
            dataIndex: "bg_expense_end_id",
            width: 400,
            editor: new Ext.form.ComboBox({
              mode: "local",
              id: "editor_bg_expense_end_id",
              store: Ext.bg_expense,
              valueField: "id",
              displayField: "c_name",
              triggerAction: "all",

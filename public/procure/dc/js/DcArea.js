...
formAdd	 = function() {
        formAdd.superclass.constructor.call(this, {
            ...
            items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: 'รหัสหน่วยธุรกิจ',
                    name : 'c_branch',
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบุ รหัสหน่วยธุรกิจ ";
                        }
                    }
                },{
                    xtype: 'textfield',
                    fieldLabel: 'ชื่อหน่วยธุรกิจ',
                    name : 'c_name',
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบุ ชื่อหน่วยธุรกิจ ";
                        }
                    }
                },{
                    xtype: 'textfield',
                    ...
                    validator: function(val) {
                        if (!Ext.isEmpty(val)){ return true; } else {
                            return "กรุณาระบุ เลขประจำตัวผู้เสียภาษีอากร ";
                        }
                    }
                },{
                    xtype: 'textarea',
                    ...
                    columns: [120,100],
                    items: [
                            { boxLabel: 'สำนักงานใหญ่', name: 'i_branch', inputValue: Ext.DC_AREA_LOCATION_HEADQUARTER },
                            { boxLabel: 'สาขา', name: 'i_branch', inputValue: Ext.DC_AREA_LOCATION_BRANCH, checked: true }
                    ] 		        	
                }, { 
...
searchGrid = function() {
    ...
    var cmbFilters = {
                    ...
                    store: new Ext.data.SimpleStore({
                        fields: ["id", "c_name"],  
                        data:[['c_name', "ชื่อหน่วยธุรกิจ"],['c_branch', "รหัสชื่อหน่วยธุรกิจ"]]
                    }),
                    value: 'c_name',
                    valueField: 'id',
                    displayField: 'c_name',
...
Ext.QuickTips.init();
        var gridMain = {
                ...
                { header: "รหัสหน่วยธุรกิจ", sortable: true, dataIndex: 'c_branch' ,
                    renderer: function(value, metaData, record, rowIndex, colIndex, store) {
                        metaData.attr = "align='center'";
                        return value;
                    }
                },
                { id: 'c_name', header: "ชื่อหน่วยธุรกิจ", width:210, sortable: true, dataIndex: 'c_name' }, 
                {
                        header: "ประเภทหน่วยธุรกิจ",  
                        sortable:false,
                        align: 'center',
                        renderer: function(value, metaData, record, row, col, store, gridView){
                            var i_branch = record.get('i_branch'); 
                            if(parseInt(i_branch) === parseInt(Ext.DC_AREA_LOCATION_HEADQUARTER)){
                                    return 'สำนักงานใหญ่';
                            }else{
                                    return 'สาขา'; 
                            }

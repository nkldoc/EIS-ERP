...
<head>
    ...
    <script type="text/javascript">
        //--------config ---------------------------------------------------------------
        Ext.URL_SERVER_ERP = '<?PHP echo URL_SERVER_ERP; ?>'; 
        Ext.URL_SERVER_API = '<?PHP echo URL_SERVER_API; ?>'; 
        Ext.URL_SERVER_PRODUCT = '<?PHP echo URL_SERVER_PRODUCT; ?>'; 
        Ext.URL_ERP_LOGIN = '<?PHP echo URL_ERP_LOGIN; ?>'; 
        
//define("SERVER_RUN_APP", "eis."); //@TODO uat-eis., PRODUCT eis
//define("SERVER_RUN_API", "eis."); //@TODO api-eis., PRODUCT api-eis
//define("SERVER_RUN_BASE", "."); //@TODO DEV . UAT 192.168.201.10, PRODUCT 192.168.201.198 
////@TODO
//define("URL_SERVER_ERP","https://erpdev.vajira.ac.th");   //@TODO 
//define("URL_SERVER_API","https://".SERVER_RUN_API.".vajira.ac.th/procure");                 //api-jula
//define("URL_SERVER_PRODUCT","https://".SERVER_RUN_APP.".vajira.ac.th:8443/supplies");     //jula uat-product  
//define("URL_ERP_LOGIN",URL_SERVER_ERP.'/web/session/authenticate'); 
//define("URL_ERP_API",URL_SERVER_ERP."/api/chula"); 
    ...
    <script type="text/javascript" src="./tor/contractErp.js?_dc=<?= __VPRODUCT_; ?>"></script>

Ext.onReady(function () {
  ...
  /* =============================================== */
  Ext.title_panel = "อัตราการตัดชำระหนี้ของยอดเรียกเก็บ ตามช่วงเวลา";
  /* =============================================== */
  ...
  LookReport = function (type) {
    ...
    href = type == "chart" ? "reports/Rep_BICutAnalysisPeriod.php" : "";
    ...
    resultUrl += "&i_mm2=" + Ext.getCmp("i_mm2").getValue();

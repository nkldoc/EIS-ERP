<?php
include("../api/List_RepDcBankDepositType.php");
...
$caption	= "รายงานประเภทเงินฝาก";

if($_REQUEST["type"] == "excel") { $export->headerExcel($caption); }

$thead[]	= "ลำดับ";
$thead[]	= "รหัส";
$thead[]	= "ชื่อประเภทเงินฝาก";
$thead[]	= "คำอธิบายเพิ่มเติม";
$thead[]	= "สถานะ";
$thead[]	= "สถานะประเภทเงินฝากหลัก";
$thead[]	= "สำหรับรายงานรายละเอียดเงินฝากธนาคาร";
...
if( is_array($data_dtl) && count($data_dtl["data"]) > 0 ) {
	...
	foreach($data_dtl["data"] as $index => $jObj) {
		...
		$tbody	.= "<td ".$style." align='center'>".$CONF_I_BANK_DEPOSIT_TYPE_MAIN[$jObj["i_main"]]."</td>";
		$tbody	.= "<td ".$style." align='center'>".$CONF_I_BANK_DEPOSIT_TYPE_ITYPE[$jObj["i_type"]]."</td>";
		$tbody	.=	"</tr>";
...
<?php
	...
	$i_main	= ($_REQUEST["i_main"] > 0)? $CONF_I_BANK_DEPOSIT_TYPE_MAIN[$_REQUEST["i_main"]] : "เลือกทั้งหมด";
	
	echo "<div align='center'><strong>".$caption."</strong></div>";
	echo "<div><strong>สถานะประเภทเงินฝากหลัก : <font color='blue'>".$i_main."</font></strong></div>";

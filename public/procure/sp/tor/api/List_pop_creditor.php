...
$sqlTempTable = "SELECT ROW_NUMBER() OVER (ORDER BY a.d_create DESC) AS row ,a.dc_creditor_id
                        FROM NMU.dbo.dc_creditor a
			inner join dbo.sp_tor_contract b on a.dc_creditor_id=b.dc_creditor_id
                        WHERE a.i_enable = 1 AND a.i_delete = 2 and a.i_key = 1 ";

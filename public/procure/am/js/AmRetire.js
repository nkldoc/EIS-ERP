...
Ext.onReady(function() {
	...
	var sGroup2= [{ //lable
		xtype: 'displayfield',  
		value:'หน่วยงานเจ้าของสินทรัพย์   : ',
		cls: 'ui-label',  
	...
	var gridMain = new Ext.grid.GridPanel({
		...
		columns: [
			...
			{ header: "เลขที่ตัดจำหน่าย", sortable: true, width:100, dataIndex: "c_code_gen", align:'center' },
			{ header: "เลขที่เอกสาร", sortable: true, width:100, dataIndex: "c_code", align:'center' },
			{ header: "วันที่ตัดจำหน่าย", sortable: true, dataIndex: "str_date", align:'center' },
			{ header: "เรื่อง", sortable: true, width: 250, dataIndex: "c_name" , id:'G-c_name'},
			{ header: "หน่วยงานเจ้าของสินทรัพย์ ", sortable: true, width: 250, dataIndex: "cost_names"},
		],
					...
					items: [{
						...
						readOnly: true
 			 			...
 			 			columns:[
 								...
 								{header: 'รหัสสินทรัพย์เดิม', sortable: true, dataIndex: 'c_asset_code_old', align: "center", width:180 },
	...
	var GRID_DTL = {
		...
		items: [{
			...
			items: [{				
				...
				items: [{
					title: 'รายการสินทรัพย์ที่ตัดจำหน่าย',
					defaults: { anchor: '100%' },

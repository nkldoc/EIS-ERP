...
if ($_REQUEST["type"] == "dc_creditor_type") {
	...
	$sqlMain = "
		...
		SELECT
			...
			,a.dc_creditor_type_id
		INTO #TemData
		FROM dbo.dc_creditor_type a
		WHERE a.i_enable = 1 AND a.i_delete = 2
			{$con};
		
		SELECT
			a.numrow
			,b.dc_creditor_type_id 
			,b.c_name
		...
		FROM #TemData a
			INNER JOIN dbo.dc_creditor_type b ON a.dc_creditor_type_id = b.dc_creditor_type_id 

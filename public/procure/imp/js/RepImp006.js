Ext.onReady(function() {
  ...
  /* =============================================== */ 
  title_panel = "รายงานนำเข้าใบเบิกแบบพิเศษ (ตั้งหนี้แล้วนอกระบบ)";
  itype = null;
  /* =============================================== */
  ...
  LookReport = function(type) {
    ...
    if (msg == "") {
      ...
      if (c_system== "1") {
        href = "report/Rep_RepImpE006.php";
      } else if  (c_system== "2")   {
        href = "report/Rep_RepImpV006.php";
      } else {
        href = "report/Rep_RepImpALL006.php";
      }
      ...
      resultUrl += "&i_enable=" + Ext.getCmp("i_enable").getValue().inputValue;
            ...
            items: [
              {
                ...
                items: [ 
                  ...
                  },
                  {
                    ...
                    fieldLabel: "วันที่นำเข้าใบเบิกระหว่าง",
                    msgTarget: "under",
                    items: [
                      {
                        xtype: "datefield",
                    ...
                    items: [
                      {
                        xtype: "checkbox",
                        id: "i_show_IRCEnV",
                        boxLabel: "เลขที่นำเข้าใบเบิกพิเศษ (IRCE/IRCV)",
                        inputValue: 1,
                        checked: false
                      } 
                    ]

...
?>
Ext.ITYPE_JV	= false; // นำเข้าค่าใช้จ่าย EPHYS == true, บันทึกบัญชีค่าใช้จ่าย EPHYS == false
</script>		
...
<!-- System ERP :: --> 
<script type="text/javascript" src="js/ImportExpense.js?_dc=<?php echo rand(0,100000); ?>"></script>
</head>
<body>
</body>
</html>
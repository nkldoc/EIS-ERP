...
Ext.urlReport = true ? "../../reports/proPrmRptMonthlyAp" : "../../reports/printr.php?get=true"; //DEBUG
// Ext.urlReport = false ? "../../reports/repSpContractPeriodnotorNew" : "../../reports/printr.php?get=true"; //DEBUG
  // Spring Boot ------------------------------------------------
  
  
    Ext.titleReport = "รายงานตรวจรับ";
        ...
        items: [
          {
            ...
            items: [
              {
                title: "รายงานรายระเอียดตรวจรับในงวด",
                  ...
                  // PermissionEmp(),
                   {
                    ...
                    fieldLabel: "ระหว่างวันที่ตรวจรับ AP",
                    msgTarget: "under",
                    items: [
                    {
                        xtype: "datefield",

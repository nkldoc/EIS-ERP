...
Ext.dc_typ_cost_id = 77; /*04040100 คณะแพทยศาสตร์วชิรพยาบาล*/
...
function winResultBillingItems(rec) {
    ...
    var winResult = new Ext.Window({
        id: "win-resultID",
        title: "แยกรายการลงหน่วยงาน จำนวน/ของ/เงิน/หน่วยงาน 1",
        modal: true,
        plain: true,
        collapsible: true,
        maximizable: true,
...
//    console.log(rec);
    ...
    var winResult = new Ext.Window({
        id: "win-resultID",
        title: "แยกรายการลงหน่วยงาน จำนวน/ของ/เงิน/หน่วยงาน 2",
        modal: true,
        plain: true,
        collapsible: true,
        maximizable: true,
        ...
        items: new Ext.FormPanel({
            ...
            height: Ext.getCmp("contenterCenter").getHeight() - 50,
            labelWidth: 130,
            bodyStyle: "padding:10 10 10 40px;",
            items: [
                {
                    xtype: "hidden",
                    name: "mode",
                    ...
                    xtype: "displayfield",
                    id: "dc_cost_nameID",
                    name: "dc_cost_name", value: Ext.session.cost_name  /*rec.get('i_period')*/,
                    width: 260,
                    fieldLabel: "ส่วนงาน",
                    listeners:{
                        afterrender:function(){ 
                          this.setValue(Ext.getStoreItems(Ext.dc_cost,Ext.dc_typ_cost_id,'c_name'));  
                        }
                    }
                },
                {
                    xtype: "displayfield",
                    id: "c_contract_code2ID",
                    name: "c_contract_code", value: Ext.session.cost_name /*rec.get('i_period')*/,
                    width: 160,
                    fieldLabel: "หน่วยงาน",
                },
                {
                    xtype: "displayfield",
                    id: "c_contract_code3ID",
                    name: "c_contract_code", value: rec.get('c_contract_code') /*rec.get('i_period')*/,
                    width: 160,
                    fieldLabel: "เลขที่ค่าใช้จ่ายโครงการ",
                    ...
                    listeners: {
                        afterrender: function () {
                            this.setValue(Ext.session.bg_year); 
                        },
                        select: function () {
                            this.select_value();
                        },
...
//                                console.log(value);
//                                if(records.get('id')==Ext.selectRow.get('po_expense_id')){
...
//                                Ext.getCmp("dc_expense_budget_type_id").setValue("0");
                    ...
                    listeners: {
                        afterrender: function () {
                            ...
                            callback: function (record, operation, success) {
                                if (success) {
//                                       this.setValue(Ext.selectRow.get('po_expense_id')); 
                                       console.log(record);
//                                       Ext.getCmp('po_expense_id2ID').setValue(Ext.selectRow.get('po_expense_id'));
...
//    alert(Ext.objLine);
    Ext.getCmp('win-frm-summaryID').insert(totalCount, new Ext.form.FieldSet({
        title: 'รายละเอียดการส่งของหน่วยงงาน ' + (Ext.objLine),
        collapsible: true,
        autoHeight: true,
        id: "legendID[" + line + "]",
        ...
        items: [ new Ext.form.ComboBox({
                ...
                submitValue: true,
                readOnly: false,
                id: "po_expense_id2ID[" + line + "]",
                name: "po_expense_id2[" + line + "]", 
                hiddenName: "po_expense_id2[" + line + "]",
                triggerAction: "all",
                allBlank: true,
                forceSelection: true,
                selectOnFocus: true,

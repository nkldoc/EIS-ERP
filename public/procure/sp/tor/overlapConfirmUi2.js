    ...
    return Ext.apply({
        ...
        process: function (menuCode, record) {
            Ext.Ajax.request({
                ...
                params: {
                    mode: "UPDATE_OVERLAP2",
                    menuCode: 'ST0009',
                    tor_status_id: 20, //record.get('tor_status_id'),
                    ...
                    buttons: [
                        {
                            text: "ค้นหา",
                            handler: function () {
                                Ext.storeDtl.setBaseParam("mode", "LIST_OVERLAPCONFIRM");
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        handler: function (e) {
                                            ...
                                            window.open(linkDownload + Ext.selectRow.get('pr_code') + '.pdf?T=Tap_' + Math.floor(Math.random() * 100000),
...
//                    ],
    ...
    Ext.storeDtl = new Ext.data.JsonStore({
        autoDestroy: false,
        autoLoad: true,
        url: "tor/api/mnOverlapConfirm.php",
        baseParams: {
            mode: "LIST_OVERLAPCONFIRM",
            keyData: Ext.keyData,

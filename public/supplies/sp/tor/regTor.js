        ...
        callback: function (recordx, operation, success) {
          if (success) {
            if (Ext.store2.data.length == 0) {
              Ext.getCmp("winMain").items.items[0].items.items[1];
              // .items.items[0].getForm().loadRecord(Ext.selectDefault);
            }
            sumtopbar();
          }
        },
                          ...
                          items: [
                            {
                              ...
                              //                              xtype: "button",
                              //                              fieldLabel: "-",
                              //                              text: "ตรวจสอบเงินตามแผน",
                              //                              handler: function () {
                              //                                alert("เหลือเงินแผน 10,000,000.00 บาท");
                              //                              },
                            },
                          ],
                        },
                            ...
                            beforerender: function () {
                              this.fnGridList = function (a) {
                                ...
                                if (a == 1) {
                                  ...
                                  // storeCreditor.setBaseParam("i_year", Ext.getCmp("i_yearID").getValue());
                                  ...
                                  storeCreditor.setBaseParam("f_total_amt", parseFloat(Ext.getCmp("f_totalID").getValue().replace(/,/g, "") / 1));
                                  storeCreditor.setBaseParam("dc_cost2_id", Ext.getCmp("dc_cost2_idID").getValue());
                                  storeCreditor.setBaseParam("i_yyyy", Ext.getCmp("i_yearID").getValue());
                                  // storeCreditor.setBaseParam("i_year", Ext.getCmp("i_yearID").getValue());
                                  storeCreditor.setBaseParam("case", 4);
                                  storeCreditor.setBaseParam("id", Ext.getCmp("torHdrID").getValue());
                                }
                                var column = [
                                  {

<?php
include("../api/List_RepAccruedIncomeFund_DTL.php");
...
$caption	= "รายงาน รายได้ค้างรับ กองทุนประกันสุขภาพถ้วนหน้า";
...
if (is_array($data_dtl) && count($data_dtl["data"]) > 0) {
	...
	foreach ($data_dtl["data"] as $index => $jObj) {
		...
		$tbody	.= "<td nowrap align='center'>" . $jObj["c_cost_name"] . "</td>";
		...
		$tbody	.= "<td nowrap align='center'>" . $jObj["c_no_charge"] . "</td>";
...
<body>
	...
	<table width=100% class="table_report" border="0" cellspacing="1" cellpadding="0" style="page-break-after: always;">
		<thead valign="top">
			<tr>
				<th nowrap style='vertical-align:middle;'>ลำดับ</th>
				<th nowrap style='vertical-align:middle;'>หน่วยงาน</th>
				<th nowrap style='vertical-align:middle;'>เลขที่ผู้ป่วยใน</th>
				<th nowrap style='vertical-align:middle;'>ชื่อผู้ป่วย</th>
				<th nowrap style='vertical-align:middle;'>จำนวนเงินเรียกเก็บ</th>
				<th nowrap style='vertical-align:middle;'>เลขที่เรียกเก็บ</th>
				<th nowrap style='vertical-align:middle;'>วันที่บันทึกเรียกเก็บ</th>
			</tr>
		</thead>
		<?= $tbody ?>
	</table>

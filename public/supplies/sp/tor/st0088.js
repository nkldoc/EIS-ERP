    ...
    if (Ext.isEmpty(rec))
      ...
      Ext.Msg.show({
        ...
        fn: function (btn, text) {
          if (btn === "yes") alert("You pressed " + btn);
          else null;
        },
      ...
      if (msg == "") {
        ...
        Ext.Ajax.request({
          ...
          params: {
            ...
            i_year:
              Ext.BG_TYPE == 3
                ? Ext.getCmp("i_type_year").getValue().inputValue == 1
                  ? Ext.getCmp("i_year").getValue() - 1
                  : Ext.getCmp("i_year").getValue()
                : Ext.getCmp("i_year").getValue(),

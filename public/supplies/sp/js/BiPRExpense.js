...
//        Ext.getCmp("sp_emp_idID").setValue("0");
  ...
  LookReport = function (type) {
    ...
    // href = type == "./reports/Rep_RepBIPrType.php?_dc=" + Math.floor(Math.random() * 1000000000) ; 
    ...
    window.open("../bi/reports/Rep_RepBIPrType.php?_dc=" + Math.floor(Math.random() * 1000000000));
    // window.focus();
  };

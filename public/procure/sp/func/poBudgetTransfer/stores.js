Ext.store = new Ext.data.JsonStore({
  ...
  baseParams: { type: "po_budget_transfer_hdr", i_read: user_right_read }, // Permission i_read
  root: "data",
  idProperty: "id",
...
let storeDtlRecord = Ext.data.Record.create([{ name: "no" }, { name: "id" }, { name: "po_expense_begin_id" }, { name: "po_expense_end_id" }, { name: "f_total" }, { name: "c_comment" }]);

Ext.storeDtl = new Ext.data.JsonStore({
  autoDestroy: false,
  autoLoad: false,
  url: "api/List_poBudgetTransfer.php",
  baseParams: { type: "po_budget_transfer_dtl" },
  root: "data",
  idProperty: "id",
  totalProperty: "totalCount",

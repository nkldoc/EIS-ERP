 ...
 order by sp_tor_bg_log_id desc) as po_expense_edit_id3,
    ...
    while ($row = $db->Fetch($stmt)) {
        ...
        $i_type_bg = array(0 => 'ออกเลขก่อน', 1 => 'ปกติ', 2 => 'โครงการต่อเนื่อง'
            ...
            , 10 => 'ขอออกเลขในระบบก่อน', 9 => 'จองเงินตรวจรับ', 12 => 'ทำ PR ก่อนปีงบประมาณ'
        );
        $i_is_notor = null;
        ...
        $temp = array(
            ...
            "check_edit_bg" => $row["check_edit_bg"],
            ...
            "i_type_bg" => $i_type_bg[intval($row["i_type_bg"])], //  $i_is_notor[$row["i_is_notor"]]  ,

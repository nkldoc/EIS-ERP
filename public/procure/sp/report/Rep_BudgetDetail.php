					...
					<tr>
						...
						if ($_REQUEST["view_budget"] == 1) {
							if($_REQUEST["view_budget_erp"] == 1){
								echo '<th style="vertical-align:middle; mso-number-format:\@; background:#FCE4D6;" rowspan="1" colspan=10 nowrap><b>งบประมาณตามบัญชีจัดสรร</b></th>';
								} else {
								echo '<th style="vertical-align:middle; mso-number-format:\@; background:#FCE4D6;" rowspan="1" colspan=8 nowrap><b>งบประมาณตามบัญชีจัดสรร</b></th>';
								}
							}
						if ($_REQUEST["view_period"] == 1) {
							if($_REQUEST["view_budget_erp"] == 1){

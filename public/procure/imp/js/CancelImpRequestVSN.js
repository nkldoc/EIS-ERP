Ext.onReady(function () {
  ...
  /* =============================================== */
  if (Ext.I_MENU_CANCEL == "5") title_panel = "ยกเลิกใบเบิกที่ยังไม่บันทึกบัญชี (e-PHIS)";
  else if (Ext.I_MENU_CANCEL == "6") title_panel = "ยกเลิกใบเบิกที่ยังไม่บันทึกบัญชี (Vision Net)";
  /* =============================================== */
  ...
  Ext.store = new Ext.data.JsonStore({
    ...
    autoDestroy: true,
    autoLoad: false,
    url: "api/List_CancelImpRequestVSN.php",
              ...
              items: [
                {
                  ...
                  items: [
					{ fieldLabel: "<b>เลขที่ใบเบิก</b>", style: "color:red; font-weight: bold;", value: arr.data.c_request_desc },
					{ fieldLabel: "<b>เลขที่ตั้งหนี้</b>", style: "color:red; font-weight: bold;", value: arr.data.c_request },
                        ...
                        buttons: [
                          {
                            ...
                            handler: function () {
                              ...
                              Ext.Ajax.request({
                                url: "api/mn_CancelImpRequestVSN.php",
                                method: "POST",
                                params: {
                                  mode: "CANCEL_RQ_NORMAL", 
  ...
  gridMain = new Ext.grid.GridPanel({
    ...
    tbar: [
      {
        xtype: "buttongroup",
        title: "ระบุเงื่อนไขในการค้นหาข้อมูล<br>เฉพาะใบเบิกสถานะ ส่งเบิกสมบูรณ์",
        columns: 1,
    ...
    columns: [
      ...
      { header: "เลขที่ใบเบิก", sortable: true, width: 110, align: "center", dataIndex: "c_request_desc" },
      { header: "เลขที่ตั้งหนี้", sortable: true, width: 120, align: "center", dataIndex: "c_request" },
      { header: "เลขที่นำเข้าใบเบิก Vision Net", sortable: true, width: 200, align: "center", dataIndex: "c_code_request" },
      {
      ...
      { id: "c_acc_item", header: "รายการ", sortable: true, width: 400, dataIndex: "c_acc_item" },
      ...
      { id: "c_cancel_reason", header: "สาเหตุที่ยกเลิกใบเบิก", sortable: true, width: 200, dataIndex: "c_cancel_reason" }

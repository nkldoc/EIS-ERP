...
Ext.urlReport = true ? "../../reports/repBiSpEmpAll" : "../../reports/printr.php?get=true"; //DEBUG
// Ext.urlReport = false ? "../../reports/repSpTorPAuser" : "../../reports/printr.php?get=true"; //DEBUG
  // Spring Boot
  Ext.titleReport = "รายงานสถิตการทำงานฝ่ายพัสดุ";
        ...
        items: [
          {
            ...
            items: [
              {
                title: "รายงานสถิตการทำงานฝ่ายพัสดุ",

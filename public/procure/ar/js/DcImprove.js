...
Ext.QuickTips.init();
	...
	var gridMain = {
		region: 'center',
		title: 'แสดงข้อมูลเหตุผลการขอลดหนี้/ปรับปรุงหนี้',
		xtype: 'grid',
		id:'tabpanel1',
		border: false,
		stripeRows: true,
		...
		tbar: [{	
                ...
                store     : new Ext.data.SimpleStore({
							  ...
							  data: [
								[ 'c_code', "รหัส" ], 
								[ 'c_name', "ชื่อเหตุผลการขอลดหนี้/ปรับปรุงหนี้" ]
							  ]
							})
				,
				valueField: "value",
			...
			,' ', '-', {
				...
				handler : function() {  
					...
					/* { header: "รหัสใบวางบิล/ใบแจ้งหนี้", sortable:true, dataIndex: 'c_ref_doc'}, */
					{ id: 'c_name', header: "รายการ", sortable: true, dataIndex: 'c_name' },
	...
	var panelForm = {
		region: 'center',
		title: 'ข้อมูลเหตุผลการขอลดหนี้/ปรับปรุงหนี้',
		xtype: 'panel',
		id:'tabpanel2',
		border: false,
		disabled: true,
        ...
        items: [
		{
			...
			items: [{
				...
				fieldLabel: 'ชื่อเหตุผลการขอลดหนี้/ปรับปรุงหนี้',
				xtype: 'textfield',
				name: 'c_name',
	        	validator: function(val) {
	        		if (!Ext.isEmpty(val)) {
	        			...
	        			return "กรุณากรอก ชื่อเหตุผลการขอลดหนี้/ปรับปรุงหนี้";
	        		}
	        	},
			}, {
				fieldLabel: 'หมายเหตุ',

...
<body>
        ...
        <!-- <thead>
                ...
                <tr style="font-weight:bold; background-color: #f9f9f9;">
                        <td></td>
                        <td>รวม</td>
                        <td id="sum1" onclick="openDetail('9999999', 'i_product_type1', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum2" onclick="openDetail('9999999', 'i_product_type2', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum3" onclick="openDetail('9999999', 'i_product_type3', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum4" onclick="openDetail('9999999', 'i_product_type4', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum5" onclick="openDetail('9999999', 'i_product_type5', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum6" onclick="openDetail('9999999', 'i_product_type6', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum7" onclick="openDetail('9999999', 'i_product_type7', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum8" onclick="openDetail('9999999', 'i_product_type8', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                </tr> -->
        <!-- </table> -->
        <!-- ------------------------------------------------ กราฟ 2 ---------------------------------------------------------->
        ...
        <table>
                ...
                <tr style="font-weight:bold; background-color: #f9f9f9;">
                        <td></td>
                        <td>รวม</td>
                        <td id="sum1.1" onclick="openDetail('9999999', 'i_product_type1', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum2.1" onclick="openDetail('9999999', 'i_product_type2', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum3.1" onclick="openDetail('9999999', 'i_product_type3', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum4.1" onclick="openDetail('9999999', 'i_product_type4', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum5.1" onclick="openDetail('9999999', 'i_product_type5', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum6.1" onclick="openDetail('9999999', 'i_product_type6', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum7.1" onclick="openDetail('9999999', 'i_product_type7', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                        <td id="sum8.1" onclick="openDetail('9999999', 'i_product_type8', this.innerText,'0','0','0')" style="cursor:pointer; color:blue;"></td>
                </tr>
        </table>
        <!-- ------------------------------------------------ กราฟ 3 ---------------------------------------------------------->
        <!-- <h1 class="table-title">ตารางสรุปข้อมูลสถานะการดำเนินงาน</h1> -->
        ...
        <script>
                var year_th = <?= json_encode($year_th) ?>;
                var year_en = <?= json_encode($year_en) ?>;

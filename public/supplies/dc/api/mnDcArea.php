...
switch ($mode) {
    case "ADD" : 
        $arrParam = array();
        $arrParam[] = $data["c_branch"];
        $arrParam[] = $data["c_name"];
        $arrParam[] = $data["c_tax_value"];
        
        $arrParam[] = $data["c_addr"];
        $arrParam[] = $data["c_tel"];
        $arrParam[] = "สาขาที่".$data["c_branch"];
        
        $arrParam[] = $data["i_branch"];
        ...
        $sql = "insert into {$table} (c_branch, c_name, c_tax_value
                                        , c_addr, c_tel, c_area_show
                                        , i_branch, c_comment, i_enable

                ...
                listeners: {
                    beforerender: function () {
                        ...
                        this.fnGenHtml = function () {
                            let codeStatus = record.get('c_code_status'); // ดึงค่า c_code_status
                            return `
                                <div class="addressbook-preview-panel">
                                    <div><span>รหัส PR :</span> ${record.get('c_code')}</div>
                                    <div><span>เรื่อง :</span> ${record.get('c_name')}</div>
                                    <div><span>รหัสสถานะ :</span> ${codeStatus}</div>
                                    <div style="color:blue;cursor:pointer;" id="linkID">
                                        <span>ไปที่เมนู :</span><span>${codeStatus}</span>
                                    </div>
                                </div>
                            `;
                        };
                    ...
                    afterrender: function () {
                        ...
                        Ext.get('linkID').on("click", function () {
                            navigateToPage(codeStatus); // เรียกใช้ฟังก์ชันที่เราสร้าง
                        });
                    }
                }
            }).show();
